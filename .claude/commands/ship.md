...
`CLAUDE.md` carries the rules and the reasons behind them and does not restate the
...
Report the tag, the Release URL, the gate's numbers, and anything left undone. If a component was not shipped, say which and why. A silent omission reads as "everything went out".
