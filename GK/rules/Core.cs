...
public static class Rules
{
    ...
    // ---- the Beat, spent (Ch. XI: the turn's three Beats, spent as you like) ----
    ...
    /// the chip as "until it is ended by hand", which is true of neither.</summary>
        ...
        string Effect, string Backlash)
    {
        ...
        public string ShapeLine => Shape switch
        {
            ...
            _                     => "the book does not say plainly, so it is your call",
        };
        ...
        {
            WorkEnds.Instant    => "at once, with nothing to carry",
    ...
    public static Working ReadWorking(string name, string kind, int rank, string cost, string text, int workerLevel = 1)
    {
        ...
        // text said who, healing dice are the tell, which beats shrugging.
    ...
    public static Burden ConditionBurden(string name, int value)
    {
        ...
        return (name ?? "").Trim().ToLowerInvariant() switch
        {
            ...
            "off-guard" => new(0, -2, 0, 0, 0, 0, "Off-Guard: cannot properly defend, being unaware, flanked, caught at the first instant, or knocked sprawling. Easier to hit, and easier to hit well.") { OffGuard = true },
            "offguard"  => new(0, -2, 0, 0, 0, 0, "Off-Guard: cannot properly defend, being unaware, flanked, caught at the first instant, or knocked sprawling. Easier to hit, and easier to hit well.") { OffGuard = true },
