...
H = shell(
    ...
    epigraphs=[
        ('"They didn&rsquo;t build the mission over the well. They built the well first and put the\n'
         '    mission on top of it, the way you put a hand on a lid."\n'
         '    <span class="src">— Fray Ignacio Salcedo, San Clavo, undated</span>'),
        ('"A binding isn&rsquo;t a thing you did. It&rsquo;s a thing you&rsquo;re doing. The day you stop is the\n'
...
<section class="page" id="what">
  ...
  <p>It doesn't require either of the others. It is better after both.</p>

  <h2 id="what-you-need">What You Need</h2>
  <p>The Player&rsquo;s Book for the souls, and this. The Keeper&rsquo;s Book Ch. XIII is a real
  help here and still not required; what a Keeper needs from it is on
  ...
  ''' + keeper(
    "<p>Read the ledger entries in Act Two aloud, slowly, in order. They're the module's whole "
    "argument and they're kept short. Everything else here can be improvised; those cannot, "
...
<section class="page" id="truth">
  ...
  is the only reason there is a mission here at all. They didn't destroy it. Fray Ignacio Salcedo,
  ...
  ''' + keeper(
    ...
    "until Act Two. A clock the players can see and can't read is the best pressure this system "
...
<section class="page" id="turn">
  ...
  ''' + quote("It isn't bound. We haven't the means and I won't write that we have. "
              "It's fed, at a rate the country can bear, by men who won't be thanked.",
  ...
  <p>The last eleven leaves are in a second hand, smaller and later, and they're not
  ...
  ''' + keeper(
      ...
      "the posse is reading doesn't use it. Salcedo writes about weights and measures and the "
      "capacity of vessels, in the voice of a man doing arithmetic he intends never to explain, "
      "and the table works out what's being measured about four sentences before he says it "
      "outright.",
  ...
  entry, on the inside of the back board, in April, and it's one line and it's steady:</p>
  ...
  <p>She wasn't confused, not failing, and not afraid. She made a judgement about a
  ...
  wrong. Both of those things are true at once and this module won't tell the table which one
  ...
  <p>The circuit takes eleven days and comes round four times a year. It can't be delegated,
  because it's a portion carried by a person and the thing knows who has been coming. It cannot
  be written down anywhere findable, because a thing widely known is a thing eventually dug up.
  Whoever takes it will do it for the rest of their life, won't be thanked, won't be
  ...
  hammer will know their names because they'll be the one reading the county register.</p>

  <p>Then hand it to whoever puts their hand out.</p>

  ''' + keeper(
      " Don't soften this and don't build a third option behind the Keeper&rsquo;s screen. A "
...
<section class="page" id="hook">
  ...
  <p>The posse is being hired to look at a well. That's all. It should sound like the least
  ...
  ''' + npc("Elías Cardoza, who owns the well",
            ...
            "he buried two of his own eleven days ago and didn't dig deep, because the ground was "
            "wet and he was tired",
            "It's a well. It has been a well for forty years. Tell me what a well can be.") + '''
</section>
'''
...
<section class="page" id="ground">
  ...
  fit on the same drawing as the first because it isn't that kind of distance.</p>
  <ul>
    ...
    <li><strong>The shaft is wet the whole way.</strong> There's no dry descent and no clever
    route. Whatever the posse brings down, it brings down soaked.</li>
    <li><strong>The bottom is wider than the shaft.</strong> That isn't a drawing error. The padres
    didn't dig the bottom.</li>
  </ul>
...
<section class="page" id="act1">
  ...
  ''' + keeper(
    "<p><strong>Plant the socket and move on.</strong> Don't explain it. The posse will see six "
  ...
  <p>The two Cardoza graves are not what is coming. What's coming is the three who went to
  relatives, who are back, and who arrive up the road at dusk on foot, together, walking well.</p>

  ''' + found("The Drowned") + '''

  <p>Full entry under <a href="#dead">What's Coming Up</a>. Three of them. They're wet to the
  waist in a dry country and they've been walking two days.</p>

  ''' + keeper(
    "<p><strong>The engine says the posse wins this</strong>: nine clears in twelve, about "
    "three rounds. It's meant to be won. What it isn't meant to be is free: the fight is in "
...
<section class="page" id="act2">
  ...
  brush, and recently, within the year.</p>
  ...
  <p>Under the fallen roof timbers at the west end, where the rain collects. They've been here
  since the spring and they're what happens when the water gets into people who were already dead.</p>
  ...
  <p>Read these aloud, in order, as they are found. They're the module.</p>
...
<section class="page" id="act3">
  ...
  <p>The shaft opens out. The padres dug a hundred and twenty feet of it and didn't dig the last
  twenty, and the chamber at the bottom is wider than any well and older than any digging.</p>

  ''' + found("The Hunger That Walks") + '''

  <p>Full entry under <a href="#dead">What's Coming Up</a>. One, and two of the Drowned with it,
  ...
  ''' + keeper(
    ...
    "their first year, and the name at the head of 1809 is not Salcedo's. It's the name of the man "
    "they found down here and couldn't save, and could only pin. A posse that read the sacristy "
...
<section class="page" id="cast">
  ...
  ''' + npc("Elías Cardoza",
            ...
            "he buried two of his own in wet ground and didn't dig deep, and he knows he did not",
  ...
  ''' + npc("Rosalía Cardoza, sixteen",
            ...
            "She said she had something to give me and she would tell me at Easter. She was very old. I didn't press her.") + '''

  ''' + npc("Hollis Deakin, who hauls the water",
            "to be paid and not to go back out there",
            "he has seen one of the Drowned on the road at dusk and told nobody, and it's eating him",
            "I hauled water past a man walking with his boots full. Two dollars, and I haven't said that out loud before.") + '''
  ...
  ''' + npc("Fray Ignacio Salcedo, dead sixty years, in his own hand",
            ...
            "The work isn't the nail. The work is the returning.") + '''
...
<section class="page" id="dead">
  ...
  ''' + keeper(
    ...
    "up with the country. The country is still winning, and now that's about tactics rather than "
...
''' + night_costs("What the Water Answers",
  ...
  ''' + keeper(
    ...
    "more than any one creature. Module I couldn't be out-shot and module II could be out-prepared. This "
    "one is arithmetic across four hours: every Blood spent in the dooryard is Blood that is not "
    "in the nave, and every point not in the nave isn't at the bottom of the shaft.</p>"
  ...
  between acts moved the count by one run in twelve. Survive this night carefully, and
  don't charge it.</p>
...
<section class="page" id="after">
  ...
  and it's a job. Forever, and nobody can be told about it. Ask the player
  ...
  ''' + quote("The work isn't the nail. The work is the returning.",
  ...
  Basin, next spring, one or two people drown. It's in the paper at the county seat, two lines,
  under the stock prices.</p>

  <p>If somebody took the hammer, they read those two lines and they know what the names paid
  for. If nobody did, they read them and they don't know, and neither does the table, and the
...
html = finish(
    ...
    curated=[
        ...
        ("The last eleven leaves", "turn-what"),
        ("The column of figures", "turn-column"),
        ("Esperanza&rsquo;s last entry", "turn-esperanza"),
        ("The price, said out loud", "turn-choice"),
        ("The county register", "after-register"),
