...
**Current editions** — Player's Book v2.32 · Keeper's Book v2.17 · Bestiary v2.14 · GritKeeper v1.50.0.

*Latest change:* The Player's Book v2.32 — the Sister and the Engineer. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
