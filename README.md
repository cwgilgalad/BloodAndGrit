...
**Current editions** — Player's Book v2.27 · Keeper's Book v2.13 · Bestiary v2.11 · GritKeeper v1.42.0.

*Latest change:* Player's Book v2.27 · Keeper's Book v2.13 — the country gets a glossary, and the contents page gets the right pages. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
...
|---|---|---|
| **I — The Salt at Coffin Wells** | four souls at 1st level | A banker dug where the padres told him not to, and bought his own life with the town's blood. |
| **II — A Face Not His Own** | 3rd level | Eight people are snowed in at a relay station. Two of them stopped being people days ago. |
| **III — What the Water Answers** | 5th level | The water is going bad from the bottom up, and the mission knows why. |

The files are `module-salt-at-coffin-wells.html`, `module-a-face-not-his-own.html` and
`module-what-the-water-answers.html`, with the maps beside them as `map-*.svg`.
