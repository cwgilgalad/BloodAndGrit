...
**Current editions** — Player's Book v2.29 · Keeper's Book v2.17 · Bestiary v2.14 · GritKeeper v1.49.0.

*Latest change:* GritKeeper v1.49.0 — the keyboard reaches the whole app, and an Origin finally does something. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
