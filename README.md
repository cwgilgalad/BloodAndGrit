...
**Current editions** — Player's Book v2.36 · Keeper's Book v2.19 · Bestiary v2.15 · GritKeeper v1.51.0.

*Latest change:* Player's Book v2.36 · GritKeeper v1.51.0 — answering a working, and eight that reach a fight. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
