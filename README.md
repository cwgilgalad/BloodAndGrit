...
**Current editions** — Player's Book v2.29 · Keeper's Book v2.17 · Bestiary v2.14 · GritKeeper v1.45.0.

*Latest change:* Player's Book v2.29 · Keeper's Book v2.17 · all three Modules · GritKeeper v1.45.0 — the modules turn, the Witch's beast gets its rules, and two new audits ask questions nothing asked before. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
