...
**Current editions** — Player's Book v2.42 · Keeper's Book v2.22 · Bestiary v2.17 · GritKeeper v1.54.0.

*Latest change:* GritKeeper v1.54.0 — the survey grows what you ask it to, and every tree on the map can be picked up. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
