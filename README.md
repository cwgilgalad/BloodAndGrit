...
**Current editions** — Player's Book v2.23 · Keeper's Book v2.10 · Bestiary v2.9 · GritKeeper v1.17.0.

*Latest change:* GritKeeper v1.18.0 — what the posse rides, a right-click on everything, and marker colors that are the Keeper's own. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
