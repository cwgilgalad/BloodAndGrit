...
**Current editions** — Player's Book v2.48 · Keeper's Book v2.32 · Bestiary v2.20 · GritKeeper v1.57.0.

*Latest change:* Module II v1.8, Module III v1.8 — two stat blocks that had not been reprinted since `creatures.json` moved. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
