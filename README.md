...
**Current editions** — Player's Book v2.41 · Keeper's Book v2.22 · Bestiary v2.17 · GritKeeper v1.52.0.

*Latest change:* GritKeeper v1.52.0 — the grids stop repainting the slow way, and the Posse tab can make a soul. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
