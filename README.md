...
**Current editions** — Player's Book v2.47 · Keeper's Book v2.31 · Bestiary v2.19 · GritKeeper v1.56.3.

*Latest change:* Player's Book v2.47, Keeper's Book v2.31, GritKeeper v1.56.3 — the question the table always asks, a step that was never in the list, and a book that got longer when its fonts were slow. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
