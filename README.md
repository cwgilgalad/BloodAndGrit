...
**Current editions** — Player's Book v2.26 · Keeper's Book v2.12 · Bestiary v2.11 · GritKeeper v1.39.0.

*Latest change:* GritKeeper v1.39.0 · Player's Book v2.26 — the round gives the turn back, Appendix B does arithmetic, every working says how long, and the dice wear their own shapes. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
...
`module-the-reckoning-of-the-wells.html`, with the maps beside them as `map-*.svg`.
