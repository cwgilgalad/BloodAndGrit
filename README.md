...
**Current editions** — Player's Book v2.45 · Keeper's Book v2.24 · Bestiary v2.18 · GritKeeper v1.56.0.

*Latest change:* GritKeeper v1.56.0 — eighteen Callings in the app, and the Sister's Miracles finally appear on the reference leaf. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
