...
**Current editions** — Player's Book v2.26 · Keeper's Book v2.12 · Bestiary v2.11 · GritKeeper v1.41.0.

*Latest change:* GritKeeper v1.41.0 — the Encounter tab builds the four fights Ch. IV names. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
