...
*Latest change:* GritKeeper v1.17.0 — creatures fight with their own attacks, cities read right, and three ways to run the table. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
