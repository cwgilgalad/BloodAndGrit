...
hunter — not a chosen one. A knife can kill you. A revolver can
...
night standing, and no Tier III fight in any module was ever won by shooting at it. That is the
point each module then makes.
...
- `audits/verify_rules.py` — the drift guard: parses the built Player's Book and checks its seventeen
  ...
  the app's data, and the rule can never quietly disagree.
