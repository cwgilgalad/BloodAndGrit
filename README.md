...
**Current editions** — Player's Book v2.26 · Keeper's Book v2.12 · Bestiary v2.11 · GritKeeper v1.40.1.

*Latest change:* Modules I & II v1.1 · Module III v1.2 — the night's cost is generated, and something reads the harness at last. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
