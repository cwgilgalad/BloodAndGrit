...
**Current editions** — Player's Book v2.41 · Keeper's Book v2.22 · Bestiary v2.17 · GritKeeper v1.53.0.

*Latest change:* GritKeeper v1.53.0 — fifteen levels, the lore that was queued and never written, and one chapter for both kinds of working. Player's v2.41, Keeper's v2.22, Bestiary v2.17, modules v1.5/v1.5/v1.6. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
...
- `make_pdf.py` — prints all six documents (three books, three modules) to true 8.5×11 US-Letter PDFs.
