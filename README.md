...
**Current editions** — Player's Book v2.28 · Keeper's Book v2.16 · Bestiary v2.14 · GritKeeper v1.44.0.

*Latest change:* Keeper's Book v2.16 · Bestiary v2.14 · GritKeeper v1.44.0 — the budget is repriced off the harness, and a Hexer's Debts are finally counted. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
