...
**Current editions** — Player's Book v2.43 · Keeper's Book v2.23 · Bestiary v2.17 · GritKeeper v1.55.0.

*Latest change:* Keeper's Book v2.23, Player's v2.43 — G3: the Keeper's Book learns that a Returned character exists, and one prose tell that had already shipped. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
