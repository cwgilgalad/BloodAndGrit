...
**Current editions** — Player's Book v2.24 · Keeper's Book v2.11 · Bestiary v2.10 · GritKeeper v1.23.0.

*Latest change:* GritKeeper v1.23.0 — the combat loop becomes one action, and the round keeps itself. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
