...
**Current editions** — Player's Book v2.24 · Keeper's Book v2.11 · Bestiary v2.10 · GritKeeper v1.21.0.

*Latest change:* GritKeeper v1.21.0 — the safe-table rule becomes a thing you can run, and the field says what just happened. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
