...
**Current editions** — Player's Book v2.38 · Keeper's Book v2.20 · Bestiary v2.16 · GritKeeper v1.51.0.

*Latest change:* Player's Book v2.38 · Keeper's Book v2.20 · Bestiary v2.16 — a fault that was not one, and the correction. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
