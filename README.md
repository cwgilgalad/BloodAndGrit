...
**Current editions** — Player's Book v2.29 · Keeper's Book v2.17 · Bestiary v2.14 · GritKeeper v1.46.0.

*Latest change:* GritKeeper v1.46.0 — the app moves to .NET 10, and the move pays for itself. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
