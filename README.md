...
**Current editions** — Player's Book v2.49 · Keeper's Book v2.33 · Bestiary v2.21 · GritKeeper v1.58.0.

*Latest change:* GritKeeper v1.58.0, Player's Book v2.49, Keeper's Book v2.33, Bestiary v2.21: the dark keeps its names. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
