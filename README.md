...
**Current editions** — Player's Book v2.42 · Keeper's Book v2.22 · Bestiary v2.17 · GritKeeper v1.53.0.

*Latest change:* Player's Book v2.42 — the Witch picks her familiar, and the rule stops living in a switch statement. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
