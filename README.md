...
**Current editions** — Player's Book v2.48 · Keeper's Book v2.32 · Bestiary v2.20 · GritKeeper v1.56.4.

*Latest change:* Player's Book v2.48, Keeper's Book v2.32, Bestiary v2.20, GritKeeper v1.56.4 — the em-dash rate, brought down by moving punctuation and stopped where moving it would cost the voice. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
