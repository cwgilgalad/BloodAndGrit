...
**Current editions** — Player's Book v2.28 · Keeper's Book v2.15 · Bestiary v2.13 · GritKeeper v1.43.1.

*Latest change:* Books v2.28 / v2.15 / v2.13 · Modules v1.2 / v1.2 / v1.3 · GritKeeper v1.43.1 — the prose reads clean, the modules print, and the covers were never wearing their own colours. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
