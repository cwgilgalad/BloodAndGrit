...
**Current editions** — Player's Book v2.45 · Keeper's Book v2.24 · Bestiary v2.18 · GritKeeper v1.55.0.

*Latest change:* Player's Book v2.45 — the Medicine Man and the Shaman become one Calling, and six workings put Blood back. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
