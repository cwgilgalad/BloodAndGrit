...
**Current editions** — Player's Book v2.33 · Keeper's Book v2.17 · Bestiary v2.14 · GritKeeper v1.50.0.

*Latest change:* The Player's Book v2.33 — a Perk for every Calling. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
