...
**Current editions** — Player's Book v2.46 · Keeper's Book v2.25 · Bestiary v2.19 · GritKeeper v1.56.1.

*Latest change:* All six books v-bumped, GritKeeper v1.56.1 — one `re.S` sent 49 Contents rows to the wrong page. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
