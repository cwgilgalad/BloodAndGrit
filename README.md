...
**Current editions** — Player's Book v2.25 · Keeper's Book v2.12 · Bestiary v2.11.

*Latest change:* GritKeeper v1.30.0 — a soul you can describe, a glass you can find, a map that fills the screen, and four things that only go wrong in month six. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
