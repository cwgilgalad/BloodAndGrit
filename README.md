...
*Latest change:* Module II v1.6 — the difficulty numbers three releases printed were numbers no engine produced, and now something checks. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
