...
**Current editions** — Player's Book v2.42 · Keeper's Book v2.22 · Bestiary v2.17 · GritKeeper v1.55.0.

*Latest change:* GritKeeper v1.55.0 — G2: Ch. IV's other correction to the budget, and a rule that had been invisible for three releases. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
