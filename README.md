...
**Current editions** — Player's Book v2.25 · Keeper's Book v2.12 · Bestiary v2.11 · GritKeeper v1.37.0.

*Latest change:* The checks moved to `audits/`, and nothing runs on a timer any more. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
