...
**Current editions** — Player's Book v2.26 · Keeper's Book v2.12 · Bestiary v2.11 · GritKeeper v1.40.0.

*Latest change:* GritKeeper v1.40.0 — the Iron Code is run rather than read out. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
