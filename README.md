...
**Current editions** — Player's Book v2.29 · Keeper's Book v2.17 · Bestiary v2.14 · GritKeeper v1.48.0.

*Latest change:* GritKeeper v1.48.0 — the Witch's familiar is a creature now, not three lines of text. See [CHANGELOG.md](CHANGELOG.md) for the full record.
<!-- /AUTO:editions -->
