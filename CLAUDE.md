...
**Current versions: Player's Book v2.43 · Keeper's Book v2.23 · Bestiary v2.17 ·
...
|---|---|---|---|
| The Player's Book | v2.43 | 266 | one inline SVG map (Appendix E) + cover emblem |
| The Keeper's Book (GM guide) | v2.23 | 118 | one inline SVG map (Ch. XIII) + cover emblem |
...
## The Player's Book (v2.43) — structure
...
## The Keeper's Book (v2.23) — structure
...
distinct from the Bestiary-style `id="index"`. The **detailed two-level Contents** is generated by
`nav_tools.py`.
