...
|---|---|---|---|
| v1.46.0 **← current** | `gritkeeper-v1.46.0` | 2026-08-24 | onto .NET 10 |
...
*46 releases across 3 families, generated by `tools/release_index.py` from the GitHub API and from this file's own last version. Regenerate it whenever a version ships.*
