...
|---|---|---|---|
| v1.42.0 **← current** | `gritkeeper-v1.42.0` | 2026-08-20 | the Callings can be played from the Tracker |
...
*36 releases across 3 families, generated by `tools/release_index.py` from the GitHub API and from this file's own last version. Regenerate it whenever a version ships.*
