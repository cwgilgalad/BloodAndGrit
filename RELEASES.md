...
|---|---|---|---|
| v1.56.1 **← current** | `gritkeeper-v1.56.1` | 2026-09-07 | Blood & Grit — GritKeeper v1.56.1 · Books v1.12 · Modules v1.9 |
...
| Version | Tag | Shipped | What it was |
|---|---|---|---|
| v1.7 **← current** | `modules-v1.7` | 2026-08-30 | Modules v1.7 — Module II v1.6: What the Night Costs re-run on the engine that plays it |
...
*103 releases across 7 families, generated by `tools/release_index.py` from the GitHub API and from this file's own last version. Regenerate it whenever a version ships.*
