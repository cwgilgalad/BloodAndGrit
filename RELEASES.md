...
|---|---|---|---|
| v1.52.0 **← current** | `gritkeeper-v1.52.0` | 2026-08-29 | Blood & Grit — GritKeeper v1.52.0 · Books v1.7 · Modules v1.5 |
...
| Version | Tag | Shipped | What it was |
|---|---|---|---|
| v1.7 **← current** | `books-v1.7` | 2026-08-27 | Player's v2.38, Keeper's v2.20, Bestiary v2.16 — every Contents number is the page it lands on |
...
*93 releases across 7 families, generated by `tools/release_index.py` from the GitHub API and from this file's own last version. Regenerate it whenever a version ships.*
