...
|---|---|---|---|
| v1.45.0 **← current** | `gritkeeper-v1.45.0` | 2026-08-23 | the Witch's familiar is a mechanism, not a note to self |
...
*45 releases across 3 families, generated by `tools/release_index.py` from the GitHub API and from this file's own last version. Regenerate it whenever a version ships.*
