...
|---|---|---|---|
| v1.43.0 **← current** | `gritkeeper-v1.43.0` | 2026-08-21 | twenty-five more horrors, and two counts the app was reciting from memory |
...
| Version | Tag | Shipped | What it was |
|---|---|---|---|
| v1.2 **← current** | `books-v1.2` | 2026-08-20 | Blood & Grit — Books v1.2 (Player's Book v2.27) |
...
| Version | Tag | Shipped | What it was |
|---|---|---|---|
| v1.2 **← current** | `modules-v1.2` | 2026-08-17 | Blood & Grit Modules I-III v1.2 - What the Night Costs comes out of the engine |
...
*37 releases across 3 families, generated by `tools/release_index.py` from the GitHub API and from this file's own last version. Regenerate it whenever a version ships.*
