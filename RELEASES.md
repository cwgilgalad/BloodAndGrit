...
|---|---|---|---|
| v1.58.0 **← current** | `gritkeeper-v1.58.0` | 2026-09-23 | Blood & Grit — GritKeeper v1.58.0 · Books v1.15 · Modules v1.12 |
| v1.57.0 | `gritkeeper-v1.57.0` | 2026-09-13 | Blood & Grit — GritKeeper v1.57.0 · Books v1.14 · Modules v1.11 |
| v1.56.4 | `gritkeeper-v1.56.4` | 2026-09-13 | Blood & Grit — GritKeeper v1.56.4 · Books v1.14 · Modules v1.10 |
| v1.56.3 | `gritkeeper-v1.56.3` | 2026-09-12 | Blood & Grit — GritKeeper v1.56.3 · Books v1.13 · Modules v1.10 |
| v1.56.1 | `gritkeeper-v1.56.1` | 2026-09-07 | Blood & Grit — GritKeeper v1.56.1 · Books v1.12 · Modules v1.9 |
| v1.56.0 | `gritkeeper-v1.56.0` | 2026-09-07 | Blood & Grit — GritKeeper v1.56.0 · Books v1.11 · Modules v1.8 |
| v1.55.0 | `gritkeeper-v1.55.0` | 2026-09-02 | Blood & Grit — GritKeeper v1.55.0 · Books v1.10 · Modules v1.7 |
...
| v1.50.0 | `gritkeeper-v1.50.0` | 2026-08-27 | Blood & Grit — GritKeeper v1.50.0 · Books v1.6 · Modules v1.5 |
...
| Version | Tag | Shipped | What it was |
|---|---|---|---|
| v1.15 **← current** | `books-v1.15` | 2026-09-22 | Merge session/2026-09-22-app-readme-counts: the README inside the zip counts from the files too |
| v1.14 | `books-v1.14` | 2026-09-12 | Merge session/2026-09-12-emdash-and-tracker — the em-dash rate down to 9.53, and the two data mirrors brought back into step |
| v1.13 | `books-v1.13` | 2026-09-11 | Merge session/2026-09-11-patron-and-flow — why the dark answers, three things the books got wrong about themselves, and a pagination path that had never run |
| v1.12 | `books-v1.12` | 2026-09-06 | Blood & Grit books v1.12 — Player's v2.46, Keeper's v2.25, Bestiary v2.19; the Contents anchor fix |
| v1.11 | `books-v1.11` | 2026-09-06 | Blood & Grit books v1.11 — Player's v2.45 (the Medicine Man and the Shaman are one Calling), page numbers throughout, navigable PDFs |
| v1.10 | `books-v1.10` | 2026-09-02 | Books v1.10 — Player's v2.44, Keeper's v2.24, Bestiary v2.18: the Territory's history straightened out, and the Patrons given half a page each |
...
| Version | Tag | Shipped | What it was |
|---|---|---|---|
| v1.12 **← current** | `modules-v1.12` | 2026-09-22 | Merge session/2026-09-22-app-readme-counts: the README inside the zip counts from the files too |
| v1.11 | `modules-v1.11` | 2026-09-12 | Modules bundle v1.11 — Module II v1.8, Module III v1.8: stat blocks reprinted from creatures.json |
| v1.10 | `modules-v1.10` | 2026-09-11 | Merge session/2026-09-11-patron-and-flow — why the dark answers, three things the books got wrong about themselves, and a pagination path that had never run |
| v1.9 | `modules-v1.9` | 2026-09-06 | Blood & Grit modules v1.9 — v1.6/v1.7/v1.7; the Contents anchor fix |
| v1.8 | `modules-v1.8` | 2026-09-06 | Blood & Grit modules v1.8 — page numbers throughout and navigable PDFs |
| v1.7 | `modules-v1.7` | 2026-08-30 | Modules v1.7 — Module II v1.6: What the Night Costs re-run on the engine that plays it |
| v1.6 | `modules-v1.6` | 2026-08-30 | Modules v1.6 — the three adventures are one county: Perdition Basin in all three |
| v1.5 | `modules-v1.5` | 2026-08-27 | Blood & Grit — Modules v1.5 — the Contents and the Index are properly clickable |
...
*117 releases across 7 families, generated by `tools/release_index.py` from the GitHub API and from this file's own last version. Regenerate it whenever a version ships.*
