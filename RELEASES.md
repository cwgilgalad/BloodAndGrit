...
|---|---|---|---|
| v1.56.3 **← current** | `gritkeeper-v1.56.3` | 2026-09-12 | Blood & Grit — GritKeeper v1.56.3 · Books v1.13 · Modules v1.10 |
...
| Version | Tag | Shipped | What it was |
|---|---|---|---|
| v1.13 **← current** | `books-v1.13` | 2026-09-11 | Merge session/2026-09-11-patron-and-flow — why the dark answers, three things the books got wrong about themselves, and a pagination path that had never run |
...
*110 releases across 7 families, generated by `tools/release_index.py` from the GitHub API and from this file's own last version. Regenerate it whenever a version ships.*
