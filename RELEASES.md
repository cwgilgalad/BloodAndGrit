...
|---|---|---|---|
| v1.47.0 **← current** | `gritkeeper-v1.47.0` | 2026-08-24 | Undo stops taking things you didn't ask it to |
...
*47 releases across 3 families, generated by `tools/release_index.py` from the GitHub API and from this file's own last version. Regenerate it whenever a version ships.*
