...
|---|---|---|---|
| v1.41.0 **← current** | `gritkeeper-v1.41.0` | 2026-08-17 | the four fights Ch. IV names |
...
| Version | Tag | Shipped | What it was |
|---|---|---|---|
| v1.1 **← current** | `books-v1.1` | 2026-08-16 | Blood & Grit — Books v1.1 (Player's Book v2.26) |
...
*34 releases across 3 families, generated by `tools/release_index.py` from the GitHub API. Regenerate it whenever a version ships.*
