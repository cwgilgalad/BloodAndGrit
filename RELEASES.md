...
|---|---|---|---|
| v1.53.0 **← current** | `gritkeeper-v1.53.0` | 2026-08-30 | Blood & Grit — GritKeeper v1.53.0 · Books v1.8 · Modules v1.6 |
...
| Version | Tag | Shipped | What it was |
|---|---|---|---|
| v1.8 **← current** | `books-v1.8` | 2026-08-30 | Books v1.8 — Player's v2.41, Keeper's v2.22, Bestiary v2.17: fifteen levels, the Powers of the Territory, Signs and Miracles in one chapter |
...
| Version | Tag | Shipped | What it was |
|---|---|---|---|
| v1.6 **← current** | `modules-v1.6` | 2026-08-30 | Modules v1.6 — the three adventures are one county: Perdition Basin in all three |
...
*96 releases across 7 families, generated by `tools/release_index.py` from the GitHub API and from this file's own last version. Regenerate it whenever a version ships.*
