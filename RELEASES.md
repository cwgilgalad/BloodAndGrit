...
|---|---|---|---|
| v1.48.0 **← current** | `gritkeeper-v1.48.0` | 2026-08-24 | the Witch's familiar is a creature now |
...
| Version | Tag | Shipped | What it was |
|---|---|---|---|
| v1.5 **← current** | `books-v1.5` | 2026-08-23 | Blood & Grit — Books v1.5 (Player's Book v2.29, Keeper's Book v2.17 — the household method, and three options nothing could reach) |
...
| Version | Tag | Shipped | What it was |
|---|---|---|---|
| v1.4 **← current** | `modules-v1.4` | 2026-08-23 | Blood & Grit — Modules v1.4 — each adventure gets its turn |
...
*48 releases across 3 families, generated by `tools/release_index.py` from the GitHub API and from this file's own last version. Regenerate it whenever a version ships.*
