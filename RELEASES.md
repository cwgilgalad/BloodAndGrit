...
|---|---|---|---|
| v1.57.0 **← current** | `gritkeeper-v1.57.0` | 2026-09-13 | Blood & Grit — GritKeeper v1.57.0 · Books v1.14 · Modules v1.11 |
...
| Version | Tag | Shipped | What it was |
|---|---|---|---|
| v1.14 **← current** | `books-v1.14` | 2026-09-12 | Merge session/2026-09-12-emdash-and-tracker — the em-dash rate down to 9.53, and the two data mirrors brought back into step |
...
| Version | Tag | Shipped | What it was |
|---|---|---|---|
| v1.11 **← current** | `modules-v1.11` | 2026-09-12 | Modules bundle v1.11 — Module II v1.8, Module III v1.8: stat blocks reprinted from creatures.json |
...
*114 releases across 7 families, generated by `tools/release_index.py` from the GitHub API and from this file's own last version. Regenerate it whenever a version ships.*
