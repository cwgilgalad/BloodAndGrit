...
<section class="page" id="dead">
  ...
  {creature(
    ...
    keeper="The Cold Bride is a haunting you can negotiate with, and that is what makes her interesting. Her binding to one place means a smart party can simply leave &mdash; but she usually sits between them and something they need, so leaving costs them. Her offered hand is a trap dressed as courtesy; let a player take it and feel the January cold climb their arm. The resolution is a question of justice: what was she owed? The truth named, the wedding mimed, the bones of the faithless man laid where she can see them: any of these can lay her to rest. Reward the player who treats her as a wronged woman rather than a monster. She has been waiting a very long time to be heard.")}
...
<section class="page" id="olddark">
  ...
  {creature(
    ...
    keeper="The Thing in the Well is intimate, claustrophobic cosmic horror: a small-scale entry that makes a town's most ordinary necessity into a deathtrap. The well is the town's water and its dependence, which is the cruel hook: they need it, they drink from it, and it's killing them slowly while taking them one by one. The horror builds through investigation: the wrong-tasting water, the people missing from the well, the slow sickness, the realization of what's down the shaft. It can't easily be fought (it's at the bottom of a well, reaching up), so the answer is denial and destruction: stop drawing, fill it with stone and salt or burn it out with oil, dig water elsewhere. The drama is convincing a desperate town to abandon and destroy its only water source on the word that something lives in it. Run the dread of the pale reach up the dark shaft, the lean over the lip, the grab. It's a tighter, smaller-scale piece than the chapter's apex threats &mdash; use it for a focused village-horror scenario about a community poisoned by the thing it depends on, and about the hard cost of giving up something you need because it's been taken from you by the dark. In Perdition Basin any well whose nail has failed can have one in it by the next season (Keeper's Book Ch. XIII).")}
