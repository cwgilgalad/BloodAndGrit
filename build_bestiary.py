...
_css = """
  /* This book's own colour, the Bestiary's verdigris, taken off its cover. It runs the
     page frame, the rules, the labels and the stat blocks; the cover is untouched. */
  :root{ --accent:#4a705c; --accent-d:#3a5a48; }
  /* ---- Bestiary additions ---- */
  ...
  .creature .cr-found .cf-tag{ font-variant:small-caps; letter-spacing:.05em; color:var(--blood-d); font-weight:700; margin-right:.45em; }
...
def creature(stat_html, lore, found, keeper, kn_tag="How to Play It", witness=None):
    ...
    witness_html = (f'<div class="quote">{witness[0]}<span class="src">&mdash; {witness[1]}</span></div>'
                    if witness else "")
    found_html = (f'<p class="cr-found"><span class="cf-tag">Found</span>{found}</p>'
                  if found else "")
...
<section class="page" id="contents">
  ...
  <p class="note">This is the Bestiary: the companion to the Player's Book and the Keeper's Book, and the
  ledger of everything in the country that wants you dead, changed, or worse. It's for the Keeper's eyes. Every
  entry gives the numbers to run a thing and the one hard truth a party must learn to put it down. Reskin freely;
  the country has more shapes than any one book can name. When an entry needs a place to show a thing at work, it uses
  Perdition Basin, the county in the Keeper's Book (Ch. XIII), and the Grounds appendix ends with the basin set out
  place by place.</p>
  <ul class="toc">
...
<section class="page" id="howto">
  ...
  <p class="chapter-sub">How an entry is built, and how to bend it.</p>
  <div class="divider"></div>
  ...
  and that the order isn't alphabetical. It's the order in which a soul out in that country comes to
  meet these things, which is to say, it's a road, and the road runs downhill.</div>
  ...
  <div class="box">
    ...
    <ul>
      ...
      <li><strong>Putting It Down</strong> is the secret: the weakness the party must learn, usually the hard way.</li>
    </ul>
  </div>
  ...
  <div class="box">
    ...
    <ul>
      ...
      Threat-by-Tier table (Keeper's Book, Ch. IV) instead of its own: Defense, attack, Blood, saves, damage,
      and Dread DC all step together. Make a Tier-II haunt menace a 6th-level party, or gentle a Tier-IV horror for
      greener hands.</li>
      <li><strong>The Swarm.</strong> Run many weak things (a host of Risen, a cloud of the dead) as
      ...
      round (the ground itself takes a turn: a cold that bites, a floor that grasps, a dark that gathers, a wall
      that weeps) and let it shrug off the first Break or rout it would suffer. A monster at home is a monster at
      its worst.</li>
      <li><strong>Fledgling / Weakened.</strong> A Tier down, its healing or its dread-regard stripped away, its
      weakness laid bare, for the night the party is <em>meant</em> to win, or the thing they catch before it
      ripens.</li>
    </ul>
  </div>
  <div class="keeper-note"><span class="kn-tag">A caution</span>When you bend the numbers, bend the fiction with them. A thing made a Tier
  tougher should look it (older, hungrier, surer) so the players read the danger before the dice do. A
...
<section class="page" id="dead">
  ...
  <p class="dropcap lead">Burial is a promise the frontier doesn't always keep. These are the dead that came back: 
  some hungry, some grieving, some only obedient to a will that called them up.</p>
  <p class="note"> <strong>Signs of the kind:</strong> ground that won't keep a grave, stock that balks at a certain plot, fresh-turned earth where none was turned, and the dead reported home days after the burying.</p>
  ...
  {creature(
    ...
    lore=[
      "There is nothing clever in the Risen and nothing left of whoever it used to be. The country called it up out of thin ground (a battlefield, a hanging-tree, a pauper's trench dug too shallow in a hard winter) and what climbed out is a body that has forgotten it is supposed to lie down. It does not hate you. It does not know you. It simply comes, slow and certain, with the dumb patience of running water, and it will be coming long after you have run out of reasons to stay.",
    ...
    found="Where the dead were buried wrong or buried angry: mass graves, massacre grounds, potter's fields, the floor of a burned church. They rise at full dark and the first night is always the worst.",
    keeper="The Risen are the party's first taste of the thing, and it's a simple one: the dead out here don't play by living rules. Run a lone one to teach that: let them shoot it, watch it keep walking, and feel the cold of it. Then, the next time, give them six, and a closing door, and a window that won't latch. The dread of the Risen is never one corpse; it's the math of <em>more</em>. Never let a fight against them feel winnable by damage alone: make the players solve the room, the exits, the salt, the fire. A party that learns to think their way out of a Risen swarm is a party ready for worse. In Perdition Basin they're the first thing a broken well sends up, and Coffin Wells is burying its dead twice this summer (Keeper's Book Ch. IX).")}
  ...
  {creature(
    sb("The Boneyard Host", "Tier II &middot; a graveyard, risen at once", 13, 26, "shuffling", "+8", "+2", "+4",
       ...
       "DC 16, 1d6",
       "Find and break the thing that woke them (a Gravecaller, a buried sign, a broken oath) and the host falls still."),
    lore=[
      "When every grave in a yard opens on the same night, you are not fighting the dead; you are fighting the ground itself. The Boneyard Host is the Risen multiplied past counting and bound into one slow, grinding will: a churchyard, a battlefield cemetery, a town's whole century of dead, all standing at once and all turning toward the warm and the living with a single terrible patience.",
      "It moves like a flood finds a valley. There is no front line to hold, no flank to turn: only the press, closing from every quarter, and the dreadful certainty that for every hand you break there are forty behind it. Men have emptied every gun they owned into a Host and changed nothing but the noise."],
    found="Old churchyards, the cemeteries of vanished towns, the burial trenches of a battle or an epidemic. Something always wakes them: a Gravecaller in the dirt, a desecration, a debt the town forgot it owed.",
    keeper="Don't run this as two dozen separate enemies; that way lies a four-hour slog and a bored table. Run the Host as <em>one</em> thing with one Blood pool, one area attack, and a relentless advance that ticks like a clock. The real fight is the question: <em>what woke them, and how do we make it stop?</em> Seed the answer before the Host ever rises: the cracked headstone, the missing reverend, the railroad cut through hallowed ground. Let the players feel the futility of fighting the tide for a round or two, then reward the one who thinks to ask <em>why</em>. The Host is a puzzle wearing a battle's face.")}
  ...
  {creature(
    ...
    lore=[
      "Some men are hanged for what they did. Some are hanged because the town needed a body and they were handy. The Gallows-Hung does not much care which it was: what rose with it was the rage of the rope, the long minute of strangling, the faces of the crowd that watched and did nothing. It comes down off its tree with the noose still around its neck, and it has learned exactly one trade, and means to teach it.",
      "It carries its own rope like a lariat, and it is a better hand with it dead than any living cowboy. It does not want to kill you with a gun or a knife. It wants the beam, the drop, the cinch, and your face going purple while a crowd that isn't there watches and does nothing, just as they did for it."],
    ...
    keeper="The Gallows-Hung is a creature of grim irony, and you should lean into it. It targets the man who pulls a rope, the lawman, the one who recently saw someone hang, anyone whose hands match its memory. Describe the noose seeking necks, the way it drags a grabbed victim toward any high beam in the room; make the players fear the architecture. Mechanically it shrugs off gunfire, and the table learns that <em>some</em> dead want their <em>story</em> set right and don't care what you do to the body. The party that learns its name, its wrong, and the crossroads burial is the party that ends it. Bullets just make it angry.")}
  ...
  {creature(
    ...
    lore=[
      "The river takes more than it gives back, and not all of what it keeps stays still. The Drowned are those the water took (the forded too late, the swept-away, the weighted-down by men who wanted them gone) and the water has made them its own. Bloated, pale, patient, they wait in the green dark under the surface for a shadow to cross, a hand to dip, a horse to wade.",
      "On its own water the Drowned is terribly strong, and tireless, and at home. Pulled onto dry land it is a floundering, helpless ruin, and that's the secret to fighting one, and the danger too, because it knows this as well, and will not be pulled if it can help it."],
    ...
    keeper="The Drowned teaches terrain. In the water, it's a Tier above its numbers; on land, a Tier below. Make the players solve <em>where</em> the fight happens. A clever party lures it to shallows, ropes it, drags it ashore; a careless one wades in after it and learns what drowning feels like from the inside. Use the drowning rules to put a clock on grabbed characters. Nothing focuses a table like a friend being pulled under, two rounds from dead. And remember the gentler ending: a Drowned given proper burial above the flood-line simply sinks back, grateful, and doesn't rise. Not every dead thing wants to hurt you. Some just want to be put to rest where the water can't reach. In Perdition Basin, look for them at the Calvary's fords in a flood year.")}
  ...
  {creature(
    sb("The Weeping Woman", "Tier III &middot; she who lost her children", 17, 40, "fast along water", "+9", "+8", "+11",
       ...
       "DC 16, 1d6",
       "She cannot be killed, only freed: return what she lost, or lay her own drowned child to rest, and she goes into the water for good."),
    lore=[
      "Every river country tells her story, and tells it a little differently, but the grief is always the same. A woman lost her children to the water (by accident, by a faithless man, by her own drowning hand in a madness she has spent death regretting) and she has been walking the banks ever since, weeping, searching, calling for them in a voice that carries a mile on a still night.",
    ...
    found="Along the rivers and irrigation ditches, the mill-races and the mission ponds: any water deep enough to drown a child, anywhere her own loss happened or anywhere grief like hers has stained the bank.",
    keeper="She's a tragedy with teeth, and you should let the tragedy do the work. Play her weeping as a genuine pull, have the soft-hearted character make the Will save to not walk toward the sound, and let them <em>want</em> to comfort her. The horror is that helping her is how she gets you. She can't be killed; a party that tries to gun down a grieving mother and watches their bullets pass through her should feel that wrongness in their stomachs. The way through is mercy and investigation: who was she, what did she lose, where do the bones lie? Lay her child to rest and she goes into the water at peace. This is one to break their hearts a little. The best sessions with her end in a funeral.")}
  ...
  {creature(
    sb("The Cold Bride", "Tier II &middot; jilted at the altar of the grave", 15, 22, "normal", "+7", "+5", "+8",
       ...
       "DC 13, 1d4",
       "Give her the wedding she was denied, the truth she was owed, or the bones of the man who wronged her. Then she rests."),
    lore=[
      "She put on the dress and waited, and he did not come, or he came and did worse. The Cold Bride died at the threshold of a promise broken: jilted at the altar, murdered on her wedding night, left waiting at a window for a man who had already taken another road. The cold that killed her, or the cold that grew in her, never left. Now she waits still, in her grey and rotted finery, and the temperature drops where she walks.",
      "She is bound to the place she was wronged (a chapel, a homestead, a particular cold room) and cannot step past its bounds. But within it, the winter is hers to command, and she offers her hand to every man who enters with the terrible hope that this one, finally, will not leave her at the altar."],
    ...
    keeper="The Cold Bride is a haunting you can negotiate with, and that's what makes her interesting. Her binding to one place means a smart party can simply leave, but she usually sits between them and something they need, so leaving costs them. Her offered hand is a trap dressed as courtesy; let a player take it and feel the January cold climb their arm. The resolution is a question of justice: what was she owed? The truth named, the wedding mimed, the bones of the faithless man laid where she can see them: any of these can lay her to rest. Reward the player who treats her as a wronged woman rather than a monster. She has been waiting a very long time to be heard.")}
  ...
  {creature(
    ...
    lore=[
      "A bad season comes through (cholera, the bloody flux, the spotted fever) and a town buries more than it can grieve, fast and shallow and frightened. The Plague-Dead are what rises from those graves, still burning with the fever that killed them, still carrying it. They are not the worst fighters in this book. They do not need to be. The danger of the Plague-Dead lies in their breath, their blood, the well they have fouled, the wound they leave behind.",
      "They shuffle, slow and feverish, and a child could outrun one. But a town that handles them wrong (that buries them, that loots the clothes off them, that drinks downstream of where they lie) buries itself by the next season."],
    ...
    keeper="The Plague-Dead are a horror of consequence. The fight is easy; surviving it clean is harder. Track the festering wounds, the worsening sickness, the contamination of water and supply. Make the players feel that <em>winning</em> the fight can still doom them if they're careless with the aftermath. This is the entry that teaches a party to burn rather than bury, to salt and quicklime, to never loot the dead. Use them to put a clock on a whole town: the players have until the sickness spreads to act. A grim, slow-burn scenario where the monster is half disease, half corpse, and entirely a test of whether the party does the hard, thankless, correct thing. In Perdition Basin the fever out at the homesteads is sometimes this and sometimes a Nightwalker feeding, and the players won't know which until they dig.")}
  ...
  {creature(
    sb("The Scalp-Taker's Ghost", "Tier III &middot; a debt of old violence", 17, 38, "fast", "+9", "+9", "+10",
       ...
       "<strong>An old wrong.</strong> It rises where a massacre was done and hunts those of the blood that did it, or any who walk its ground at the wrong hour.",
       "DC 16, 1d6",
       "It is laid only by restitution (the wrong named aloud, the dead honored, the ground given back) not by the gun."),
    lore=[
      "The frontier was won with a great deal of blood that the history books have learned to skip past, and the country has not forgotten a drop of it. Where a massacre was done (a camp burned, a column ambushed, a wagon-train butchered, a people driven off a cliff) the wrong can rise as a single avenging shape, taking from the living what was taken from the dead.",
    ...
    found="Massacre grounds: a particular draw, a burned village-site, a stretch of trail where something unforgivable happened. The land remembers even when the maps have been redrawn to forget.",
    keeper="This is the bestiary's hardest entry to run well, and its most rewarding. The Scalp-Taker's Ghost is a reckoning, and the table should feel the weight of real history behind it. Handle it with the gravity it's owed. It can't be solved with violence; a party that tries to out-shoot an avenging massacre only adds to the body count it feeds on. The resolution is restitution: the wrong named aloud and unflinchingly, the dead honored, the ground returned or marked or made right. Use it when your table is ready for a story that asks something of them. The players who lay it to rest will remember that session for a long time, and so will the ones who refuse to.")}
  ...
  {creature(
    ...
    keeper="A perfect early-game morality trap, and a great one-shot. The Mummied Prospector is almost no threat, until the players' own greed wakes him, and then he's a relentless, low-grade curse that follows the gold forever. Make the gold tempting: a proper payday, more than the party has ever seen, sitting right there. Let them take it. Let him rise. Then let them discover that he doesn't stop, doesn't tire, and doesn't want anything but the gold back. The table that puts the gold back learns a frontier truth: some fortunes cost more than they pay. The table that keeps it earns a recurring problem with a pick.")}
  ...
  {creature(
    ...
    lore=[
      "Out in the bad lands, far from any church, there are barrows where a man was buried with his gold because he would not be parted from it: a Spanish captain's vault under a cairn of stones, a trapper's cache walled up in a cave, the last owner of a lost mine sealed in with the silver. Something is still keeping watch inside. The Grave-Wight is that keeper: a withered, cold-handed thing wound around a hoard it has guarded past the death of everyone who ever knew its name, drawing strength from the wealth at its back.",
      "It is strongest in the dark of its barrow, surrounded by its trove, and it heals the cold it deals straight back into itself. Drag it into honest sunlight, or take from it the gold and grave-goods that are the source of its strength, and all its years catch up with it at once."],
    found="Cairns, walled-up caves and old vaults in the deep country, the Spanish diggings, a lost mine with its last owner still in it: any old grave rich enough to be worth the guarding. Far from town, deep in the dark, down where the air is older.",
    keeper="The Grave-Wight is a dungeon boss in the old style, and you should build the dungeon around it. The barrow is its strength (the dark, the close air, the hoard) so the fight turns on <em>changing the conditions</em>: opening the barrow to daylight, scattering the trove, denying it the wealth it feeds on. A party that learns to fight the room rather than the wight will win; one that trades cold grips with it in the dark will be drained dry, because every wound it lands heals it. Use the hoard as both lure and weakness: the gold that drew the players in is the very thing keeping the wight alive. Greed brought them down here. Greed is also the lock on the door.")}
  ...
  {creature(
    ...
    lore=[
      "A house burned, or a church, or a wagon, and a child did not get out. What came back has no malice in it at all: just a small lost thing, frightened and alone and very, very hot, looking for the comfort it was denied at the end. The Ash Child drifts through the burned place where it died, and fires kindle on their own where it passes, and it reaches for any warmth that reaches back.",
      "That is the tragedy of it. Show the Ash Child kindness (speak gently, offer a hand, try to help) and it will follow you, grateful and trusting, and its touch will blister you to the bone, because it does not know its own heat. It cannot help what it does. It only wants not to be alone in the dark."],
    ...
    keeper="The Ash Child is the gentle gut-punch of the chapter, a sibling to the Weeping Woman in grief but smaller and sadder. Run it as something the players will <em>want</em> to save, and let that instinct be the danger: the kind-hearted character who tries to comfort it gets burned, not by malice but by a child who doesn't understand it is on fire. There's no fighting this one in any way that feels good; gunning down a frightened ghost-child is a thing that should sit wrong at the table. The mercy ending is the only right one: find the bones, learn the name, bury it with a kind word. A small, quiet, heartbreaking scenario. Use it when you want the party to remember that not everything in the dark deserved what happened to it.")}
  ...
  {creature(
    sb("The Revenant", "Tier III &middot; risen for one purpose", 17, 44, "normal", "+11", "+6", "+10",
       ...
       "DC 16, 1d6",
       "Let it have its vengeance, or settle the wrong it died over, and it falls and does not rise."),
    lore=[
      "Murder leaves a debt, and some men die hating with enough force to come back and collect it personally. The Revenant rises with one purpose burned into whatever passes for its soul (the man who killed it, the betrayer, the one name it carried into the grave) and it walks toward that purpose through fire, through bullets, through anything and anyone in the way, with the awful patience of a thing that already knows it cannot truly die until the debt is paid.",
    ...
    found="Wherever a murder went unanswered: the spot of a betrayal, the trail a wronged man walked, the town his killer fled to. It rises where it died and walks toward whoever it died hating, however far that is.",
    keeper="The Revenant is a force of moral physics, and the table needs to understand that early: it <em>won't stay dead</em>. Let them destroy it the first night and feel good about it. Then bring it back, whole, the next night, and let the dread set in. The only end for a Revenant is the debt paid; short of that, the body is a coat it puts back on. You <em>resolve</em> one or you live with it. The drama is in the question of its target. If the one it hates is a villain, the party may be tempted to simply step aside and let justice walk; if the target is someone they've come to protect, they have a much harder problem: settle an old murder, or stand between an unkillable thing and the person it was made to destroy. Few monsters force better roleplay. The Revenant doesn't want the party. It wants one man. What they do about that is the whole story.")}
  ...
  {creature(
    ...
    lore=[
      "The blood-drinking dead are an old terror that came west with the settlers and found the thin country much to their liking. The Nightwalker was a person once, and often still wears that person's face and manners and name: the genteel rancher who entertains only after dark, the charming stranger at the boarding house, the respected man whose household has a great many rules about windows and invitations. Underneath, it is a corpse that murders to keep walking.",
      "It is fast, strong, and hard to put down (it knits its wounds shut faster than guns can open them), and its mere regard can freeze a brave soul in place. But it labors under the old laws: it cannot cross a threshold it was not invited past, cannot cross running water, cannot abide the noon sun. The country gives even its worst dead some rules, if you are clever enough to use them."],
    ...
    found="Old houses with the curtains always drawn, played-out estates, the respectable parts of a town with a quiet problem. It keeps a lair (a grave, a cellar, a coffin of home soil) and must return to it before dawn.",
    keeper="The Nightwalker rewards the slow-burn. It's most frightening as a <em>person</em> first (a host, a benefactor, a neighbor whose hospitality has strange conditions) before it is ever a monster. Let the party meet it in daylight as a charming man, then slowly assemble the wrongness: the rules of the house, the missing ranch-hands, the pallor. Mechanically, its self-healing punishes a straight slugging-match; the secret is its laws. A clever party doesn't out-damage a Nightwalker, they out-<em>think</em> it: revoke its invitation, put running water between, trap it on the wrong side of dawn, then do the grim ritual work of staking and burning and salting. Make the laws discoverable through play, and let the climax be a tense daylight raid on the lair while the thing sleeps. This is your gothic centerpiece. Give it a name, a face, and a reason the town hasn't dealt with it. The best Nightwalker is one the players were guests of. In Perdition Basin the padres staked one under the mission ground east of Coffin Wells in 1809, and a ruined banker dug it up for silver that was never there (Keeper's Book Ch. IX).")}
  ...
  {creature(
    sb("The Restless Herd", "Tier II &middot; a stampede that never ended", 14, 30, "very fast", "+9", "+6", "+3",
       ...
       "DC 13, 1d4",
       "Lay the drover to rest, or turn the herd over the same draw that killed them, and the thunder stops."),
    lore=[
      "A drive went wrong in the dark (a lightning-spook, a cut bank, a river in flood) and a thousand head and the men riding them went over or under or down, all at once, in a thunder of terror. They never stopped running. On the bad nights you hear them first: a far-off rumble like weather, then the ground shaking, then the cold shapes of cattle pouring out of the dark with a dead drover riding hard at their head, and nothing alive in their path that stays standing.",
  ...
  {creature(
    sb("The Blood-Thin", "Tier I &middot; the new-made, still ashamed of it", 13, 14, "fast, and then suddenly tired", "+5", "+6", "+1",
       ...
       "<strong>Starving and unschooled.</strong> It has none of the old ones' gifts yet (no mist, no command, no charm) and it has not learned that a threshold can stop it, so it walks in the front door and is surprised by the salt.",
       "DC 13, 1d4",
    ...
    witness=("They kept her a month. Fed her off the hogs and told the neighbors she had the fever. I don't blame them for the month. I blame the second one.",
  ...
  {creature(
    sb("The Grave-Eater", "Tier II &middot; the thing that lives in the boneyard", 15, 24, "fast; digs like a badger", "+8", "+7", "+3",
       ...
       "DC 13, 1d4",
       "Plain lead does it above ground. In a hole it dug, it is worth three of itself, so make it come up, and do not follow it down."),
    lore=[
      ...
      "That is the bargain, and it holds for years at a stretch. Bury your people, leave them where they lie, and the Grave-Eater is a rumor and a set of tracks. Rob a grave, or move a churchyard for a railroad right-of-way, or bed down on the mound because the ground is soft, and the bargain is off, and the thing that has been polite about it for thirty years comes up out of a hole behind you, fast."],
  ...
  {creature(
    sb("The Wasting Kin", "Tier II &middot; the one in the family plot that is not rotting", 14, 22, "slow; it is never in a hurry", "+8", "+4", "+6",
       ...
       "DC 13, 1d4",
       "Open the graves. The one with fresh blood in the heart is the one. Burn that heart, and let the sick of the family breathe the smoke."),
    lore=[
  ...
  {creature(
    sb("The Coffin-Rider", "Tier II &middot; the one that travels", 15, 26, "normal; and never far from the box", "+8", "+6", "+5",
       ...
       "DC 13, 1d4",
       "Find the crate on the waybill. Salt the earth in it or burn it, and the thing has nowhere to be at sunup. Then the sun does the rest of the work for you."),
    lore=[
      "The old ones are bound to their ground and everybody knows it, and that's why the clever ones learned to bring the ground along. A Coffin-Rider ships as freight. A long crate, consigned to a name that turns out to be nobody, moving west by wagon and then by rail, riding in a car with the through freight and the mail. It sleeps the day in a bed of its own graveyard dirt and it works whatever town the crate stops in, and when the town gets restless the crate goes out on the next train.",
      "It is a middling thing in a fight and a devil of a thing to be rid of, because a country with a freight schedule is a country a vampire can live in forever. The one that worked Denver in the spring is the one that worked three towns in Kansas the winter before, and the depot agent has a record of it in his book without knowing what he wrote down. Kill the thing and it is dead. Find the crate first and you did not even need to."],
  ...
  {creature(
    ...
    keeper="This is the Swarm template from Chapter I put to use, and the entry is here to teach it. One Defense, one Blood pool, one attack that catches everyone standing close, no called shots, and it gets weaker as it bleeds instead of dropping bodies. Stage it underground and make the terrain the antagonist. The party's real decisions are about light, chokepoints, and whether anybody is willing to be last in line on the ladder. Seed the count wrong: the survivor said six. Then plant the actual point of the encounter, which is that a brood is evidence. Somebody made these, that somebody is close, and it's older and quieter and has been listening to the shooting. End the session on the sound of something unhurried coming up the drift behind them, and you've set your Old Blood without ever showing it.")}
  ...
  {creature(
    sb("The Old Blood", "Tier IV &middot; the one that holds the paper on the valley", 20, 70, "fast; and it need not hurry", "+15", "+13", "+14",
       ...
       "<strong>It owns the country.</strong> Heals 10 Blood a round out of the sun, and its regard alone gives an order (Will DC 20 or obey it this round). It cannot cross a threshold uninvited, and it holds the notes on half the doors in the county, which is a kind of invitation the old rule never anticipated.",
       "DC 20, 1d10",
    ...
    lore=[
      "It came into the valley with money in the bad year and it has been the best neighbor anybody ever had. It carried the Hollisters through the drought. It bought the mortgage off the bank when the bank got hard about it. It never comes to church and it never comes by day and nobody thinks a thing of either, because it has the manners of a gentleman and a genuine record of decency, and it has been forty years building that record, one careful year at a time.",
      "The old rule still binds it. It cannot come through a door it was not asked through, and it has never once been refused, because the invitation is in the paper. A man who signs a note signs a welcome, and every family in the valley signed one in a year when signing was the only thing between them and the road. The Old Blood does not feed often and it does not feed carelessly: a little, from the healthy, from people who wake tired and grateful and mean to pay their debt. What it wants is not one night. It is the valley, and it has most of it."],
    witness=("I've looked at the note four times now. There's nothing in it a lawyer would blink at. It's the plainest, kindest paper I ever read, and I can't sign it and I can't say why to my wife.",
    ...
    keeper="An apex horror whose real body is the deed book, and the entry is built so force comes last. Run the first sessions as economics: the party notices that everybody's paper leads to one name, that the tired-and-grateful are all debtors, and that the thing has never entered a house it didn't hold a note on. Give them the fight only after they understand what the fight is for, because at Tier IV against most parties it is an execution, and a posse that walks up the drive at midnight has chosen badly. The win they should find is the paper. Burning the deed book is a heist. Getting the county to void the notes is a courtroom. Buying them back is a season of work and a real cost, and any of the three ends the invitation and puts the thing outside in the dark with the sun coming. Let the Mark line do its job (every player who took its money is now part of the problem) and let one of them have taken it for a very good reason.")}
...
<section class="page" id="beasts">
  ...
  <p class="note"> <strong>Signs of the kind:</strong> tracks that change shape between prints, a kill left whole and uneaten, dogs and horses that won't enter their own country, and a wrong silence where the birds should be.</p>
  ...
  {creature(
    ...
    lore=[
      "Somebody wanted somebody dead and went to the kind of person who can arrange it. The Hexed Beast was an ordinary animal (a dog, a wolf, a wildcat, a hog) until a Witch or a Hexer worked a hate into it and pointed it at a name. Now it runs that name down with a single-minded wrongness no natural creature has, faster than it should be, surer than it should be, and it knows its quarry by scent or by the sound of a name spoken aloud.",
    ...
    found="Anywhere its quarry runs; it crosses fences, towns, and territory lines without slowing. Look for its maker nearby: a Witch's cabin, a Hexer's wagon, a cuckolded rancher who paid cash for a curse.",
    keeper="The Hexed Beast is the party's introduction to the rule that runs half this book: <em>kill the body, and the binding brings it back</em>. Let them put it down the first night and feel the satisfaction, then have it come loping out of the dark the next night, whole and patient. The way to beat it is to follow the thread back to the hand that sent it. Use it as a clock and a breadcrumb: every night it returns, it points the party closer to its maker. The Tier band (I&ndash;II) lets you scale it to whatever the table can handle. Drop the brand or the hair-knot somewhere they'll find it; let a tracker or a wise NPC name it as a sending. Then the real adventure begins: not the beast, but the person who wanted blood badly enough to buy it.")}
  ...
  {creature(
    sb("The Pale Wolf", "Tier II &middot; a pack with one mind", 15, 22, "very fast", "+8", "+8", "+3",
       ...
       "<strong>One will.</strong> Run the pack as a single hunter: patient, coordinated, and unafraid; it culls the strays and the wounded first.",
       "DC 13, 1d4",
       "Silver wounds it true; break its nerve by felling the lead wolf, the one with the old eyes."),
    lore=[
      "An honest wolf pack fears men, and rightly. The Pale Wolves do not. Something has burned the fear out of them and bred in its place a cold, shared cunning: ash-white in coat, old-eyed, and moving with a coordination that no natural pack has, as if a single mind were looking out of a dozen sets of eyes. They are wrong in a way you feel before you can name it.",
    ...
    keeper="Run the Pale Wolves as one intelligence in many bodies. They should feel <em>tactical</em> in a way that unnerves the players: pulling back when hurt, concentrating on the isolated, never doing the dumb thing a real animal would do. The dread is the slow realization that they're being <em>hunted by something that thinks</em>. Mechanically, the lead wolf is the linchpin: fell the old-eyed one and the shared nerve breaks, and the rest become ordinary frightened animals. Make that lead wolf identifiable (bigger, scarred, hanging back to direct) so a sharp-eyed player can pick it out and solve the fight with one good shot. Silver bites them true, which is a useful early lesson that the right tool matters more than the most lead.")}
  ...
  {creature(
    ...
    lore=[
      "A cougar killed wrong (shot and left to die slow, trapped and starved, poisoned by a rancher's bait) can come back as the Ghost Cat, and it brings its grudge with it. It haunts the trail where it died, a pale shape glimpsed at the edge of vision and never twice in the same place, leaving no track in the dust and making no cry until it is already on you.",
      "It guards the bones of its old kills and its own bleached skeleton in the rocks with a jealous, patient fury. Riders who use that trail begin to go missing, taken from the saddle so softly that the horse comes home alone and the rest of the party rides on a while before they notice the empty place in the line."],
    found="A particular stretch of trail, pass, or canyon where a cougar died badly, usually a route the party has reason to use more than once. Its kill-cache and its own bones lie hidden in the rocks above.",
    keeper="The Ghost Cat is about the dread of the unseen. It leaves no tracks, makes no sound, and is never seen full: play it as glimpses, wrongness, the horse that spooks at nothing, the rider who isn't there anymore. Lean on the surprise mechanics: when it strikes from hiding, it hits hard and grabs, and the table should feel the terror of a friend simply <em>gone</em>, dragged off into the rocks. It can't be hunted like a normal animal because you can't find it. The solution is to find what anchors it (its kill-cache, its own bones in the high rocks) and salt and burn them. This rewards investigation over marksmanship: a party that tracks the disappearances back to the source ends it; a party that just keeps riding the trail keeps losing people.")}
  ...
  {creature(
    sb("The Hidebehind", "Tier III &middot; the thing at your back", 17, 38, "fast", "+9", "+11", "+8",
       ...
       "DC 16, 1d6",
       "Force it into the open (firelight in a ring, a mirror, two who watch each other's backs) and it can be shot like anything else."),
    lore=[
      "The lumber camps of the deep woods tell of it, and they do not tell it laughing. The Hidebehind is the thing you never quite see; it keeps a tree-trunk, a shadow, the body of your own companion always between itself and your eyes, so that no matter how fast you turn, it has already slipped behind the next thing. You feel it at your back. You hear it move. You never face it.",
    ...
    found="The deep timber, the old-growth forest, the logging camps and the trails through dense cover, anywhere there are enough trunks and shadows for it to keep something always between you and it. It hates open ground.",
    keeper="The Hidebehind is a puzzle dressed as terror, and the puzzle is its whole charm. Mechanically, it always has cover and you can't harm what you can't face, so a party that just tries to shoot it loses, every time. The solution is to <em>take away its hiding</em>: a ring of firelight with no shadow to hold, a mirror that shows what's behind, two people standing back-to-back watching each other's blind side, an open meadow with nowhere to slip to. Make the players work out that the fight is about geometry and light. The dread comes from the build-up: the missing straggler, the feeling of being watched, the thing always one turn behind your eyes. When they finally corner it in the open and it stands revealed, let the reveal land: it was solvable all along, if they could just make it stop hiding. A great creature for a party that's learned to think.")}
  ...
  {creature(
    ...
    lore=[
      "It nests in the high broken country off the ridge, and it hunts the way a hawk hunts a mouse: from far above, unseen against the dark sky, a sudden rush of wings and a screech that sends every horse for a mile into a panic, and then it is climbing again with a calf or a steer or a man clutched in its talons, gone before the echo dies.",
  ...
  {creature(
    sb("The Thunderbird", "Tier IV &middot; the storm that has eyes", 20, 70, "fly very fast", "+15", "+13", "+9",
       ...
       "<strong>Brings the weather.</strong> The storm rides with it; it is old, proud, and not always hostile: an offering and a wide berth have turned it before.",
       "DC 20, 1d10",
       "It is not meant to be killed by men. Drive it off with respect, with fire, or with the high ground, and pray it judges you not worth the trouble."),
    lore=[
      "It is older than the territory and older than the men who named it, and the storm is its shadow on the land. Where the Thunderbird flies, the weather flies with it. The sky goes green-black, the thunder rolls in its wingbeats, the lightning answers its eye. It is vast beyond reckoning, proud, and it does not think of men the way a hawk does not think of insects.",
    ...
    witness=("&ldquo;The storm had eyes. I won't be talked out of it. It looked at the herd, and it chose.&rdquo;", "Eb Tuttle, trapper"),
    ...
    keeper="The Thunderbird is one of the book's lessons that <em>not everything is yours to kill</em>. Its numbers are punishing, and meant to be: a stand-up fight is a losing proposition, and the table should sense that. Run it with grandeur and ancient indifference: it's weather with intent, and it holds no grudge. The right resolution is almost never combat; it's respect, offering, retreat, reading the signs and giving the old thing its road. Use it to humble a party that has gotten used to winning, or as a force of nature woven through a larger story: the storm that guards a mountain pass, the omen that precedes a reckoning. If the players must drive it off, make it cost them, and make the victory feel like surviving a hurricane rather than slaying a monster. Some things you don't defeat. You endure them, and you're grateful they let you.")}
  ...
  {creature(
    sb("The Horned Serpent", "Tier III &middot; the thing in the deep water", 17, 46, "swim very fast", "+11", "+8", "+7",
       ...
       "DC 16, 1d6",
       "The horn is the heart of it: strike there, or break it off, and the serpent's strength goes out of it."),
    lore=[
      "In the deep water (the lake-bottom, the still river-bend, the flooded sink that never seems to drain) something old and patient waits. The Horned Serpent is vast, scaled, and crowned with a single great horn, and it lies in the dark below for days or weeks until something comes to drink, and then the water erupts and the coils close and whatever it was is gone under without a cry.",
      "The horn is the prize and the danger both. Old tales say it cures any poison, wards any curse, brings luck or rain or sight beyond sight, and the men who go after it mostly become part of the reason the next man believes the legend. The horn is also the serpent's heart and strength; break it off, and the great coils go slack."],
    found="Deep, still water: a lake, a flooded quarry, a river's deepest bend, a spring-fed sink. It claims one body of water and rules it utterly; the locals know not to swim there and not to say why too loudly.",
    keeper="The Horned Serpent is a terrain monster and a temptation. On its own water it is overwhelming (vast, patient, constricting, able to swallow the small whole) so the fight comes down to denying it the water or striking its one weakness. The horn is the elegant solution and the bait: it's the source of its strength (break it and the serpent weakens) and a coveted treasure that drew the party in. Let the legend of the horn's powers pull greedy hands toward deep water; let the cost of reaching it be steep. Stage the fight so the party must lure it to the shallows, pin it, or get someone dangerously close to strike or break the horn. A good water-monster set-piece, and a reminder that the most valuable thing in the country is usually attached to the most dangerous thing in the country.")}
  ...
  {creature(
    ...
    lore=[
      ...
      "At the heart of the cloud is the thing that calls them: a carrion-spirit, a cursed corpse, a black appetite that wears the flock like a coat. Scatter the birds and they re-gather; the only way to end it is to find the cold center and burn it."],
    found="Over battlefields, killing-grounds, and the wake of disaster, anywhere death has been plentiful and the carrion-thing at the cloud's heart was born or drawn. It follows slaughter the way buzzards follow a dying steer.",
    keeper="The Carrion Cloud is a fight against an area. Run it as a single swarming hazard (one Blood pool, one area attack that catches everyone caught in it, blinding and smothering) and let the players feel the panic of being inside a storm of beaks with nothing solid to shoot. Fire and smoke and loud iron scatter it temporarily, buying room to think, but it always re-gathers. The real win is finding the carrion-thing at its center: the cursed corpse, the spirit, the black heart that calls the birds. Burn that, and the cloud disperses into ordinary frightened crows. This one teaches the swarm with a heart (sibling to the Gravecaller): some swarms have a source, and the source is what you fight.")}
  ...
  {creature(
    sb("The Bewitched Grizzly", "Tier III &middot; a mountain under a hex", 17, 48, "fast", "+11", "+5", "+4",
       ...
       "DC 16, 1d6",
       "Cut the charm from its hide (a knot of hair, a brand, a stitched sign) and it is only a bear again, and dying."),
    lore=[
      "A grizzly is danger enough on its own terms. Take one and work a charm into its hide (a brand burned in, a sign stitched under the fur, a knot of hair and bone bound to its hide) and you have a mountain of muscle and tooth that does not tire, does not flee, does not feel the wounds that should have felled it three shots ago. It is ridden by a borrowed rage, and it keeps coming long after a natural bear would have broken off and gone to die.",
      "Whoever hexed it had a reason (a feud, a grudge, a witch's spite) and the bear is the instrument. Underneath the charm it is still only a bear, confused and in pain and made cruel against its nature. End the charm and you give it back its death."],
    ...
    keeper="The Bewitched Grizzly is the Hexed Beast scaled up to a wall of fury, and it teaches the same lesson harder: <em>damage isn't the answer, the charm is</em>. Let the party empty their guns into it and watch it shrug off wounds that should drop a bull. The secret is the charm worked into its hide (a brand, a stitched sign, a hair-knot) and cutting it free turns the unkillable monster back into a dying bear. This forces a different kind of fight: someone has to get close enough to find and cut the charm while the rest hold the line, which is terrifying against something this strong. Seed the charm visually (a glimpse of the brand, fur that's been tampered with) so an observant player can deduce the trick. And remember the pathos: it's a victim too, and ending the charm is a mercy as much as a kill.")}
  ...
  {creature(
    ...
    lore=[
      "The hogs out of the bad bottoms are not right, and have not been for a long time. Something in the sour ground down there got into the stock that went feral, and what came back up is a sounder of razorbacks that will eat anything (bone, iron, the carrion dead, the living) with a relentless, grinding hunger that clears a homestead down to the foundations.",
    ...
    keeper="The Razorback Shoat is a swarm of the mundane gone wrong: a whole sounder, a tide of armored, anything-eating hogs that comes at a homestead in numbers. Run it as a defense scenario: the family, the pens, the night coming, the prints in the mud. The fight is about position and fire; they fear flame, and a true shot to the shoulder drops one mid-charge, but a dozen low fast targets in the dark will hurt anybody. Use them to bloody a party that's gotten cocky, or as the opening threat that brings the players to a place with a deeper problem (what soured the bottoms?). A good honest meat-grinder of an encounter that rewards barricades, choke points, and not letting the sounder surround you.")}
  ...
  {creature(
    ...
    lore=[
      "Low to the ground, plated like a snapping turtle, horned and spined and foul of temper, the Hodag is the swamp's own bad mood given a body. It wallows in the wet country and wants only to be left alone, but it defines 'left alone' generously, and a logging crew or a homestead that crowds its range will find out exactly how lavishly a thing this armored can kill when it's put out.",
      "Its plates turn light shot and its spined back punishes anything that closes to grapple, but it is built wrong for speed: short, brittle legs under all that armor. On open ground, away from its wallow, it is a slow fortress that can be toppled. In the muck it called home, it is another matter."],
  ...
  {creature(
    ...
    keeper="The Pale Crawler inverts the usual rules: it hunts by sound and is helpless against silence and light. This makes encounters with it tense and tactical in a wonderful way: the party that blunders in loud and dark feeds it; the party that learns to move slow and silent, that brings bright light to stagger it, that sets up an ambush in the quiet, wins. Run the soundscape: make the players nervous about every dropped tool and loud word, reward whispered planning and careful movement. Bright light is the great equalizer: a lantern unhooded at the right moment staggers it and turns the tables. Use it in any underground scenario to make the dark itself the enemy, and to teach the party that sometimes survival comes down to discipline and quiet. A lantern, a held breath, and a steady hand beat a fast gun down there.")}

  {creature(
    sb("The Devil's Coyote", "Tier I &middot; the false guide on the trail", 14, 12, "very fast", "+4", "+8", "+5",
       "snapping bite +4 (1d6+2); leads travelers astray with false sign and called voices",
       "<strong>Never where it seems.</strong> More nuisance than killer until it has you lost, alone, and far from the fire, which is the whole game.",
       "DC 10, 1",
       "It cannot cross a line of salt or a running rope of prayer; hold your ground, and it loses interest by dawn."),
    lore=[
      "The teamsters say the Devil kept a coyote to run his errands on the roads, and that when he lost interest in the Territories it stayed on and kept at the work. Whatever it is, it still finds leading men astray richly amusing. The Devil's Coyote is rarely a killer outright; it is a mischief, a will-o'-wisp with fur, a thing that throws false trail-sign and calls in voices you know and leads you in circles until you are lost, alone, and a long way from the fire and the friends who could help you. <em>That</em> is the game. The bite, if it comes to that, is almost an afterthought.",
    ...
    keeper="The Devil's Coyote is a low-stakes, high-flavor creature that turns navigation and confidence into the battlefield. It barely fights. The danger is being led astray, separated, and worn down until you're somewhere much worse. Run it as creeping wrongness: the trail that doesn't match the map, the voice calling a player's name from the dark, the campfire that should be due east now somehow behind them. The wards are folk-simple and should feel earned: a line of salt, a rope of prayer, holding your ground until dawn breaks its game. Use it to teach the party to distrust easy paths and called voices, to stick together, to hold position when lost rather than chasing. It's a great unsettling opener before a bigger threat, or a recurring nuisance that makes the country itself feel alive and faintly malicious. Don't let it kill anyone outright. Let it strand them somewhere that something else can.")}
  ...
  {creature(
    ...
    lore=[
      "A horse was flayed alive (by a cruel man, a vicious punishment, a ritual that wanted the hide for something) and the wrong of it was great enough to bring the animal back. The Skinned Stallion gallops the night range, a raw and terrible shape, red and glistening and tireless, running down whatever crosses its path and trampling it under hooves that never slow.",
      "It is not malicious so much as agonized, a pain given motion, and it cannot stop. The look of it alone is a Dread Check. Somewhere its stolen hide hangs (on a barn wall, a drying-rack, in the lodge of whoever took it) and until that hide is found and burned, the stallion runs and the country it runs is not safe after dark."],
    found="The open range and the night trails near where it was flayed. Its stolen hide hangs somewhere within that country: a barn, a trophy wall, a ritualist's lodge; find the hide and you find the key.",
    keeper="The Skinned Stallion is a tragedy, and it resolves through investigation. Fighting the thing directly is grim and largely futile. It's tireless and runs down whatever flees. The answer is to find its flayed hide, wherever the cruel hand that took it hung it, and burn it. This turns the encounter into a hunt for a story: who flayed a horse, and why, and where's the hide now? The cruelty at the root gives you a villain and a mystery. Play the stallion's appearances as horror set-pieces (the raw red shape thundering out of the dark, the Dread of just seeing it) while the real work is tracking the wrong back to its source. When the party burns the hide and the stallion finally folds and lies still, let it feel like a release. Cruelty made it; mercy ends it.")}
  ...
  {creature(
    ...
    lore=[
      "It is a wolverine-thing grown wrong, all appetite and spite, and it has decided your party is a moving larder. The Glutton follows for days (never quite seen, always at the edge of camp) raiding the stores, fouling what it cannot carry off, killing more than it eats out of pure malice, and growing bolder with every night as the party grows hungrier, more tired, and more desperate.",
    ...
    found="The wilderness trails, the long crossings between supply, the deep country where a party carries everything it needs. It attaches itself to travelers and follows them as far as the food lasts: theirs, then them.",
    keeper="The Glutton is a creature of attrition and dread-by-erosion, best run over several nights rather than one fight. It's a logistics nightmare with claws: it doesn't beat the party in a battle, it beats them by ruining their supplies, spooking their horses, and wearing them down until they're weak enough to take. Run the slow grind: each morning, something's gone or fouled; each night, it's a little bolder. The players will come to <em>hate</em> it, and they should. The resolution is to stop reacting and start hunting: deny it the stores it's after, set a trap, corner it, because cornered and denied, it fights stupid and dies easy. A small relentless enemy can be deadlier than a big one if you let it set the terms. In Perdition Basin it follows the drives up from the south to the cattle pens at Calvary Crossing.")}
  ...
  {creature(
    ...
    lore=[
      "Somewhere out in the rocks a rattlesnake kept growing, long past the size God meant for it, until it was long as a fence-line and thick as a man's thigh, with a rattle like dry bones in a bucket and a venom that no remedy the frontier carries can answer. The Rattlewyrm is heard before it is seen; that dry, buzzing warning from the rocks above the trail is itself enough to set a brave man's nerve to fraying.",
    ...
    found="Rocky badlands, canyon country, and the broken sun-warmed ground where rattlesnakes thrive, grown to monstrous size. It dens in the deep rocks and ranges out to hunt the warm hours and the cool nights.",
    keeper="The Rattlewyrm weaponizes the most American of fears and makes it monstrous. The rattle is the centerpiece; that dry sound from the rocks is a Dread Check on its own, and you should use it to make the players tense before the thing ever strikes. It fights as a hit-and-run ambusher: strikes from cover, injects a venom nothing can cure, and vanishes back into the rock. The Drained-and-slowed venom turns a bitten character into a liability, ratcheting the pressure. The key in the entry is plain: don't get bitten, and smoke it from its den to fight it on your terms rather than its. Reward the party that locates the den, blocks the bolt-holes, and forces it into the open with smoke, and that respects the venom enough to keep someone back with a remedy that probably won't work. A great creature for canyon country and a hard lesson in why the locals walk careful in the rocks.")}
  {creature(
    sb("The Black Dog", "Tier II &middot; the one that walks ahead of a death", 15, 22, "very fast; never quite where the eye left it", "+8", "+8", "+6",
       ...
       "DC 13, 1d4",
       "You do not put down an omen. Find whose death it walks for and what earned it, and settle that: salt across the road, a name said over it, or a silver piece thrown down will each buy one more night."),
    lore=[
    ...
    witness=("Third night I sat up with the shotgun and the dog sat in the road and we looked at each other till light. Pa went off the barn roof at ten the next morning. The dog wasn't there for me at all.",
    ...
    keeper="Use the Black Dog as a clock the party can see and can't read. Three appearances, three nights, and then somebody dies, and the entire scenario is the scramble to work out who and why while the party argues about whether the dog is even real, because it only ever shows itself to one of them at a time. That single-witness rule is the engine; run it hard, and let the player who keeps seeing it feel the table doubting them. Make the fight available and unsatisfying. Silver or a blessing will hurt it, and hurting it changes nothing, and a party that spends the second night hunting the dog has spent a night they needed for the real work. The real work is a debt, a killing nobody was punished for, a promise broken at a graveside. Settle that and the third night passes quiet. This is a fine creature to hang over a whole town for a season, and a fine one to bring back the moment the players start feeling safe.")}
  ...
  {creature(
    sb("The Moon-Cursed", "Tier III &middot; the wolf-shape, three nights a month", 17, 42, "very fast; runs down a horse over open ground", "+11", "+11", "+5",
       ...
       "DC 16, 1d6",
       "Silver or fire, and fast, because everything else knits shut while you watch. The kinder answer is to find the man in daylight, and to have decided what you mean to do before you knock."),
    lore=[
    ...
    keeper="A hunt where the finding is the game. The party can chase the wolf all they like and won't catch it; it's faster than they are, it heals what they do to it, and it knows the country. What catches it is the calendar: three nights a month, a day's ride, the same range every time, so a party that maps the kills and reads a farmer's almanac has the man's name by the second month. Then the entry turns and asks the real question, which is what they do with a decent neighbor who has been begging somebody to find him out. Play the man honestly. He knows. He has been chaining himself in the root cellar and it hasn't been enough, and he will tell them where the silver is kept. Give the table a genuine choice among the killing, the chain, and the long search for a cure, and don't make any of the three easy. And if a player took a bite, do not walk that Fort DC 16 back afterward. Write it on next month's session.")}
  ...
  {creature(
    sb("The Loup-Garou", "Tier III &middot; the bayou strain, and it is counting days", 17, 40, "fast; swims the black water without a sound", "+11", "+9", "+8",
       ...
       "<strong>A hundred and one days.</strong> The curse runs its term and then passes to whoever it last drew blood from, and this one knows the count, and is choosing. It will not cross a sill lined with coarse salt, and it cannot leave off counting a spilled measure of anything.",
       "DC 16, 1d6",
    ...
    witness=("Eighty-one days. I have it marked on the doorpost where my wife can't see it. He come by Thursday and looked at me through the window a while and went off, and I haven't slept since.",
    ...
    keeper="Run this one as a countdown with names on it. The party comes into a parish where several people are marking days on a wall and not saying why, and every one of them is on a list, and one of them is going to be handed the thing on a date everybody can work out. That gives the table a deadline, a slate of NPCs worth caring about, and a wonderfully ugly temptation, because the fastest way to save four people is to let the fifth take it. Don't soften that. The breaking is a set-piece: get blood out of the creature and put its christened name to it in the same moment, which means somebody has to have gone and found out who it used to be. The year-and-a-day silence is where the horror lives afterward. The party wins, and then has to keep the win secret from everybody they would want to tell, including each other. And note the salt and the counting; a spilled sack of rice on a doorstep is an honest and very old answer to a night at the window.")}
  ...
  {creature(
    sb("The Moon's Own", "Tier IV &middot; the one that never went back", 20, 72, "very fast; tireless; it does not sleep any more", "+15", "+14", "+8",
       ...
       "DC 20, 1d10",
       "Silver, fire, and more guns than you brought. Break the thing at the head of the pack and every one of the others wakes up a person again, which is the entire argument for going."),
    lore=[
    ...
    keeper="An apex hunt, and the party should arrive knowing they can't brawl with it. Set the price of admission in preparation: silver enough to matter, fire they can carry, a place of their own choosing, and somebody who knows the ridge. Let them spend a session getting those and let each one cost something. In the fight itself, the pack is the puzzle. The moon-sick are Tier II and there are several, and every one of them can be dropped or spared, and the party will have to decide mid-fight whether to spend the rounds. Hold the reveal for the moment it matters: a young one caught in a lantern beam with a face somebody recognizes. Then honor the promise: put down the Moon's Own and the rest come out of it human, naked, freezing, and utterly wrecked, and the party has to get them home. That aftermath is the payoff, and it's worth more than the fight was.")}
...
<section class="page" id="men">
  ...
  <p class="dropcap lead">Bullets work on these, mostly, which is its own kind of horror, because so often the
  ...
  {creature(
    sb("Road Agents", "Tier I&ndash;II &middot; men, and only men", "14 (15 cover)", "13 (boss 24)", "normal", "+4", "+5", "+2 (boss +5)",
       ...
       "<strong>Mortal.</strong> They break (morale) when bloodied or leaderless: the only foes in this book who do. Use them to teach that bullets work, before the night teaches what doesn't.",
       "none, until something takes the gang from behind",
       "Lead, leverage, or a worse monster; a routed gang scatters and is done."),
    lore=[
      "Before the country teaches the party what they cannot kill, it ought to remind them of what they can. Road Agents are exactly what they appear: men with guns and bad intentions, holding up the stage, the bank, the lone rider, working the lonely stretches where the law is a day's ride away. They are dangerous the ordinary way (a bullet in the dark, a shotgun at close range) and they die the ordinary way too.",
    ...
    keeper="Road Agents are your control group, and you should use them as one. Run a gang of them <em>before</em> the first real horror so the table internalizes the normal rules of a fight: cover matters, morale breaks, a downed leader routs the rest, bullets simply work. Then, when the dead get up and keep walking, the contrast lands like a slap: <em>oh, this isn't that kind of thing.</em> They're also useful mid-campaign as a palate cleanser, a reminder that ordinary human danger is still danger, and as a setup: a gang of Road Agents that's gone quiet, or that's fleeing something, points the party toward a worse problem behind them. Let them be beatable. That's their whole job: to make the unbeatable things feel as wrong as they should.")}
  ...
  {creature(
    sb("The Skin-Walker", "Tier III &middot; the thing that wears men", 17, 38, "fast in any shape", "+9", "+11", "+6",
       ...
       "<strong>Another's skin.</strong> Wears the face and manner of any it has killed; one thing is always wrong: a shadow, a reflection, an animal's terror, the eyes by firelight.",
    ...
    found="In the heart of a community, wearing someone's face: a homestead, a small town, a trail party, a fort. It hunts the isolated to take their shape, then walks back in among people as one of them.",
    keeper="The Skin-Walker is the book's great paranoia engine, and it works best when the players don't know they're in a Skin-Walker scenario yet. It's a social-horror puzzle: someone the party knows and trusts is already dead and replaced, and the game is figuring out <em>who</em> before it takes another. Seed the wrongness carefully: a reflection that's a beat slow, animals that panic, a beloved NPC who suddenly doesn't know a thing they should. Reward the player who catches the one wrong detail. The tells in the entry (true reflection, line of ash and bone, silver or blessed bullets) give the party tools to test the suspect and to strike past the borrowed skin. The horror is the trust it exploits, and the gut-punch is the moment they realize how long it's been wearing a friend. Use sparingly and devastatingly. In Perdition Basin one has settled in at Saltlick Station, drawn by the relay's failing well (Keeper's Book Ch. X).")}
  ...
  {creature(
    sb("The Cursed Man", "Tier II &middot; the slow turning", "13 (rising)", 26, "normal, then fast", "+8", "+4", "+3",
       ...
       "<strong>Turning.</strong> Run it as a clock, not a fight. A person the party may know, sickening into something else over hours; each stage stronger and less himself.",
       "DC 13 rising to 20 as he is lost",
       "Early, the curse can be drawn or prayed out; late, only a bullet, and the party must choose the moment."),
    lore=[
      "He was bitten, or cursed, or he touched a thing he should not have, and now something is growing in him that will not be stopped. The Cursed Man is a person (often one the party knows, sometimes one of their own) in the slow, terrible process of becoming something else. It happens over hours or days, not all at once: the fever, the strange appetites, the strength that surprises everyone including him, the moments of lucid horror as he feels himself slipping.",
      "There is a window, early, when the curse can still be drawn out (prayed away, cut free, broken at its root) and the man saved. The window closes. Past a certain point there is only the thing he's becoming, and the only kindness left is a bullet, and the party has to decide, with the clock running and a friend's eyes pleading, exactly when that moment has come."],
    found="Anywhere a curse can take root: after an encounter with another monster, a touched relic, a witch's spite. Most often it's a companion or a sympathetic NPC, which is the whole tragedy of it.",
    keeper="The Cursed Man is a clock and a moral knife, not a monster to be fought. Run it as a countdown with stages: each hour he's stronger, stranger, less himself, the DC rising as the person fades. The drama is entirely in the <em>choice</em>: there's an early window to save him (a cure, a prayer, a ritual the party must scramble to find or perform) and a late point where only a bullet remains, and the party has to decide when hope runs out. Make them <em>like</em> him first; make the turning visible and pitiable; let him have lucid moments where he begs them to do what's necessary, or begs them not to. This is one of the heaviest things you can put at a table, especially if the cursed man is a player character. Don't rush the clock. Let them feel every tick, and let the decision cost them.")}
  ...
  {creature(
    sb("Dark Cultist &amp; the Hollow Prophet", "Tier II (flock) / III (prophet)", "14 / 16", "18 / 42", "normal", "+4 / +5", "+4 / +6", "+6 / +11",
       ...
       "prophet DC 16, 1d6",
       "The flock breaks if the prophet falls; the prophet has bargained his death away. Find and break the token that holds it.",
       mark="A soul that heeds the Word willingly, or takes the prophet's bargain, gains +1 Mark."),
    lore=[
      "Out where the churches are far apart and the nights are long, a charismatic man with the wrong book and the right voice can gather a congregation that should have known better. The Hollow Prophet was a person once: a preacher, a prospector, a stranger who came to town with a light in his eye. Then he gave himself over, and what fills him now speaks through him. His flock are ordinary folk: neighbors, farmers, a sheriff's own deputy, hollowed out one sermon at a time until they fear nothing, doubt nothing, and will die smiling for him.",
      "He has bargained his own death away and keeps it somewhere safe (a token, a buried thing, a heart kept in a box) so that bullets pass through him like he's already a ghost. His Word is a weapon: a sermon that turns a brave soul's own hands against itself, that makes the faithful unkillable in spirit if not in body. The flock breaks only when he falls, and he falls only when the thing that holds his death is found and broken."],
    found="An isolated congregation: a remote chapel, a mining camp, a town the railroad forgot. The flock looks normal at first; the wrongness is in what they all believe, and what they've all agreed not to see.",
    keeper="This dual entry is a whole scenario in a box: a cult, its leader, and the bargain that protects him. Run the flock as the immediate threat (fearless, numerous, armed with farm tools and old rifles) and the prophet as the puzzle behind them. His sermon (the Will-save Frightened effect) makes a frontal assault costly and can turn party members against each other or freeze them mid-fight. Killing his body does nothing; the win is finding the token that holds his bargained-away death. Build the investigation: where does he keep it, who knows, what will the flock do to protect it? The Mark warning matters: a player tempted by the Word, or by the prophet's own offer, courts corruption. Use the flock to show how ordinary people get hollowed out, and the prophet to show what's doing the hollowing. The best version makes the party realize, too late, how many 'normal' townsfolk were already his.")}
  ...
  {creature(
    ...
    lore=[
      "She might have been born to it or come to it desperate; she might be the cackling crone of the stories or a respectable widow three farms over whom no one suspects. The Witch works the Craft: the hexing touch, the Evil Eye that withers a man's strength, the lingering curse that follows a victim home and ruins his luck, his health, his marriage, his crops. She is patient and she is subtle and she does not forget a slight.",
      "Her power runs through her familiar (the cat, the crow, the toad, the strange tame thing that's always near her) and while it lives, her strength is doubled and she feels what it feels. Kill the familiar and you halve the Witch. The old protections hold against her: cold iron foils her workings, her true name spoken aloud binds her, and somewhere she keeps a heart-charm that holds her life, which is the surest way to end her for good."],
    found="On the edge of a community: the last farm on the road, the cabin in the woods, a respectable house in town hiding a cellar. Wherever she can work unwatched and be near the people she means to curse or aid.",
    keeper="The Witch is a recurring antagonist more than a single fight, and she rewards being played long. She works through hexes and curses that land days before the party ever sees her (the homestead's bad luck, the wasting illness, the cursed rival) so she's often the answer to a mystery rather than a creature in a clearing. When it does come to confrontation, the structure is elegant: cold iron foils her, her true name binds her, her familiar doubles her (so killing it is the tactical key), and her heart-charm is the true kill-switch. Let the party assemble these through investigation. She's also a tempter. The Mark warning means a desperate party might bargain with her, and that's a story in itself. Play her as intelligent, proud, and long-memoried; she should feel like a person with reasons. The best Witch is one the party dealt with once and now has to deal with again, angrier.")}
  ...
  {creature(
    ...
    lore=[
      "The Hexer is what the Witch's power looks like in a smaller, sadder, more dangerous man. He has no Craft of his own; he buys it, all of it, on credit, from something that keeps a very exact account. Every curse he throws, every charm he works, the dark does for him, and the bill comes due in his own slow ruin: his health, his years, his soul, paid out a piece at a time until there's nothing left but a marked and frightened man with a bag of borrowed tricks.",
    ...
    found="Drifting through towns and camps, selling small curses and luck-charms, settling scores for cash. He's often a hireling: the cheap muscle a richer villain buys to do the supernatural dirty work.",
    keeper="The Hexer is a pathetic, dangerous middle-man, useful as a recurring low-tier antagonist and as a window into how ordinary greed and desperation feed the dark. He's weak when disarmed (his power is all in his charms and his bag of tricks, and salt unworks his signs) so the tactical answer is to strip him of his tools, after which he's just a frightened marked man. The drama is in his ruin: he's visibly paying for his power, rotting from the inside, and a perceptive party might pity him even as they stop him. Use him as a hired gun for a bigger villain, a cautionary tale about the cost of bargains, or a desperate man the party could possibly save if they're inclined to mercy. The Mark warning cuts both ways: he's a tempter too, offering quick curses for a price, and a party member who buys from him starts down his road.")}
  ...
  {creature(
    ...
    keeper="The Hanging Judge is a courtroom drama with a noose, and the way to beat him is to play the trial. His numbers make a straight brawl punishing, and morally he believes he's righteous, so you can't just shoot your way out of his jurisdiction. The keys are in the entry: win a true verdict against him (prove the wrong he died concealing, the innocent man he knowingly hanged) or destroy the instruments of his false court (break the gallows, burn the bench). Build the scenario as an investigation into his old cases: who did he hang wrongly, where's the evidence, what's the truth he's been holding court to avoid? Then stage a confrontation where the party turns his own ritual against him and puts <em>him</em> on trial. It's a set-piece for a party that likes to think, and a sharp comment on frontier justice. Let them win by being right, not just by being armed.")}
  ...
  {creature(
    ...
    lore=[
      "He started honest enough, as these things go: a body-snatcher selling the freshly dead to the medical colleges back east, ugly work but a living. Somewhere along the way he learned that the dead he handled so casually could be made to sit up, and to serve, and the Resurrectionist crossed from grave-robber to something worse. Now he keeps a stable of stitched and reassembled corpses, and a ledger naming every grave he's emptied, and he raises his dead to shield him while he works.",
      "His ledger is the heart of him (a precise and damning account of every body he's stolen, sold, and bound) and it's also the binding that holds his stitched servants together. Burn the book and the dead fall to pieces, and the Resurrectionist is revealed for what he is under all his borrowed protection: a soft, frightened man with a bone-saw, who bleeds like anyone."],
    found="Near graveyards and the towns that feed them: a cellar workshop, an abandoned mortuary, a shack at the edge of the boneyard. Follow the disturbed graves and the missing dead.",
    keeper="The Resurrectionist is a grisly mystery with a clean mechanical hook: his ledger binds his servants, so burning the book ends the fight and strips him of his shield. Run the lead-up as an investigation (graves disturbed, the recent dead gone missing, a town uneasy about its boneyard) and let the party trace it to his workshop. The ledger is both clue and kill-switch: it names his crimes (useful for the law, and for understanding the scope) and it holds his stitched dead together. Make the players work out that the book is the target. He's a coward at heart, dangerous only behind his wall of corpses, so once the dead are down he folds fast. Use him to explore the frontier's casual relationship with the dead, the ugliness of the body trade, and the line a desperate or greedy man crosses when he stops seeing corpses as people. A good mid-tier villain with a satisfying, decisive weakness.")}
  ...
  {creature(
    ...
    lore=[
      "The winters out here can starve a man down to a choice no man should ever face, and some men make the wrong one. The Wendigo-Touched ate what he must not (in a snowbound cabin, a stranded wagon, a played-out mining camp where the food ran out before the snow did) and the eating started something in him that won't stop. He is half-turned: still mostly a man, but cold now, fast, and gripped by a hunger that grows with every kill and points always in one direction.",
      "He is what the Wendigo proper grows from. Catch him now, in this half-state, and he can still be stopped with fire and iron, and a bullet is a mercy as much as a defense, because the thing he's becoming by spring is something this book has a much worse entry for. Let him go, let him feed, and you'll meet the finished article in the deep snow, and wish you'd ended it while it still had a human face."],
    ...
    keeper="The Wendigo-Touched is the seed of the Wendigo (see The Wild &amp; the Weather), and running them as a connected pair across a campaign is deeply effective. He's a tragedy in progress: a man who made an unforgivable choice under unbearable pressure and is now turning into a monster because of it. The mechanical lesson is mercy-as-wisdom: ending him now is both easier and kinder than facing what he becomes. Play the horror of the half-state: the cold, the growing hunger, the man still partly aware of what he's doing. The Mark warning is a dark hook: a party that unknowingly shares his 'meal' (the starvation-camp food) risks the same corruption. Use him to explore the frontier's worst desperation, and as a ticking clock: deal with him before spring, or meet the Wendigo. Few creatures better capture this book's theme that the worst monsters were once just people the country pushed too far.")}
  ...
  {creature(
    ...
    lore=[
      "He came to town with a traveling show, perhaps, or a patent-medicine wagon, or simply a fine coat and a way of looking at you that made you want to agree. The Mesmerist owns people with a word and a gesture: turns a man's own hands against his friends, walks a thrall off a roof with a smile, sits safe in the corner while the people he's bent do his killing for him. He rarely lifts a hand himself; he doesn't need to, when he can borrow yours.",
      "The bend takes hold through the eyes and the voice, so a man who can't see him or hear him can't be taken. Break his line of sight, blind him, get close before he speaks, and the thralls he was riding come back to themselves all at once, and remember what he made them do, and turn on him with a fury he can't talk his way out of."],
    found="Wherever there are crowds to work and marks to bend: a boomtown, a traveling show, a respectable parlor where he's the charming guest. He hides behind influence and other people's hands.",
    keeper="The Mesmerist makes the party's greatest strength, each other, into the threat, which is unsettling in exactly the right way. Mechanically he's a glass cannon who fights through other people: his thralls (which may include party members) do the dangerous work while he stays safe. The counters are clear and tactical: break his line of sight, blind him, or close and silence him before he can speak. Run the dread of watching a friend's eyes go flat and their gun come up. Be careful and generous with player agency: telegraph the save, let players fight the bend, and make the freed-thrall turnaround satisfying when his control breaks. He's a great social-infiltration villain who hides behind influence, and a fight that's won by disrupting him rather than out-damaging him. The lesson: against some enemies, the move is to take away their tool, not trade blows, and their tool might be your own people.")}
  ...
  {creature(
    sb("The Bruja", "Tier III &middot; the owl-witch of the night roads", 17, 40, "fly fast by night", "+9", "+10", "+11",
       ...
       "DC 16, 1d6",
       "Salt, prayer, and the sign against the eye ground her; named in her true form, by daylight, she cannot fly, or flee.",
       mark="Seeking her favor is +1 Mark."),
    lore=[
      "She flies the night roads as a great owl, vast and silent, and lands as a woman where no one is watching. The Bruja is an old terror of the borderlands: a witch who preys on travelers caught out after dark and, worst of all, on the newborn, slipping into a house where a baby has just come and taking what she came for. She knows when she is spoken of, so the people who fear her speak of her carefully, and never by the open window.",
      "The wards against her are old and specific: salt, prayer, the sign made against the evil eye. They ground her, break her flight, pin her to her woman's shape. And there is a deeper truth: named in her true form, in daylight, she cannot take wing, cannot flee, cannot become the owl and vanish into the dark. Catch her as what she is, when the sun is up, and she's trapped on the ground with the rest of us."],
    ...
    keeper="The Bruja blends folk-horror specificity with a satisfying mechanical structure. By night, on the wing, she's an elusive aerial predator, hard to pin, preying on the vulnerable. The wards (salt, prayer, the sign against the eye) are the locals' defense and the party's tools: they ground her, strip her flight, force her human shape. The deeper key is identity and daylight: learn who she really is, name her true form, catch her by day, and she can't escape into the owl. Build the scenario around her dual life: she's a woman in the community by day, the owl-terror by night, and unmasking her is the heart of it. The preying-on-newborns angle is dark; use it to give the threat real stakes and the community real fear. The Mark warning notes she can also be sought out as a power-broker, which makes her a tempter as well as a terror. Play her as cunning, old, and aware. She knows when she's hunted.")}
  ...
  {creature(
    sb("The Deathless Gun", "Tier III &middot; the man who can't be killed wrong", 18, 40, "normal", "+9", "+11", "+6",
       ...
       "<strong>The terms.</strong> A gunfighter who bargained away his death; he cannot be killed by ambush, poison, or numbers, only by being outdrawn fair and alone.",
    ...
    keeper="The Deathless Gun is the book's great showdown, and its whole point is that the party <em>can't cheat</em>. Every clever trick they've learned (ambush, numbers, poison, dynamite) fails against his terms, and you should let them try and fail once so the rule lands. The only path is the one he's mastered: a fair, open, one-on-one draw. This forces the dramatic question: <em>who</em> faces him, and are they fast enough? Build to it: let his reputation precede him, let the party watch him survive something that should have killed him, let the dread of the inevitable showdown build. Make the duel itself a real moment: the empty street, the held breath, the single exchange. It's a rare creature that turns the genre's central iconography (the quick-draw duel) into the only viable tactic. Reward the gunslinger character's whole build with this. And if they win, let it be earned, and close.")}
  ...
  {creature(
    sb("The Possessed", "Tier II &middot; a soul with a rider", "12 (host)", 22, "normal", "+5", "+6", "+9",
       ...
       "DC 16, 1d6",
       "Drive the rider out (a true exorcism, a holy ground, the thing's name) without killing the host. Kill the body and the rider only finds another."),
    lore=[
      "Something got inside (through a broken ward, a foolish invitation, a moment of weakness or grief) and now there are two things in one skin. The Possessed is an innocent person ridden by a rider that wears them like a coat: speaking in a borrowed, wrong voice, working the host's body to a strength it never had, doing harm with hands that, underneath, are still the hands of someone the party may be trying desperately to save.",
      "That's the cruelty of it. Every wound you deal the monster, you deal to the host. Kill the body and you've murdered an innocent and accomplished nothing: the rider simply steps out and finds another skin. The only true answer is to drive the rider out and leave the host alive: a real exorcism, holy ground, the thing's true name spoken to cast it loose."],
    found="Anywhere a door was left open: a house where a ward broke, a person who dabbled and lost, a survivor of another haunting. The host is usually someone with a connection to the party or the community, to make the stakes personal.",
    keeper="The Possessed is a fight you win by <em>not</em> fighting, and that inversion is its whole design. The host is innocent and every point of damage hurts them, so the party that treats it like a normal combat ends up killing the person they came to save and accomplishing nothing: the rider just relocates. The real work is the exorcism: discover the rider's nature and name, find holy ground or a true rite, and cast it out while keeping the host alive and restrained. Build it as a race against the rider's escalation and a puzzle of how to subdue without killing. The wrong voice, the borrowed strength, the flashes of the trapped host pleading. Lean into all of it. It pairs beautifully with the Possession rules in the Keeper's Book. Use it when you want the party to feel the weight of a life in their hands that they can't simply shoot their way out of protecting. The kill is easy. The <em>save</em> is the adventure.")}
  ...
  {creature(
    ...
    lore=[
      "Hunger and worse meals turned him from a man into something that scuttles: a ghoul, a corpse-eater, a thing that haunts the boneyards and the battlefields and the fresh graves, feeding on the dead and, when it's bold enough, the sleeping. The Bonepicker is filthy, fast, and diseased, and its bite carries the sickness of everything it's eaten. But it is, above all, a coward.",
      "It is brave only among the helpless (the dead, the sick, the sleeping) and gutless against anything armed and awake and willing to come at it. Light terrifies it. A loud, advancing line sends it scuttling for the dark. The danger is letting it reach that dark, where it's at home and the odds turn; run it down in the open, in the light, and it dies as miserably as it lived."],
    found="Graveyards, battlefields, plague-pits, the edges of any place with fresh dead to feed on. It dens somewhere dark and close (a crypt, a mine, a cellar) and ventures out to feed by night.",
    keeper="The Bonepicker is a low-tier creature that teaches courage and aggression as tactics. It's a coward (bold only among the helpless, gutless against the armed and waking) so the counterintuitive lesson is that <em>advancing</em> beats defending. A party that holds light, keeps a loud advancing line, and refuses to let it reach the dark will rout it easily; a party that hangs back or gets separated in the shadows lets it work. Use it to bloody green characters, to populate a graveyard or battlefield scenario with low-grade dread, or as a scavenger pointing toward bigger death (where there are Bonepickers, there are a lot of fresh dead. Why?). The bite-sickness adds a lingering cost to sloppiness. It's also a grim character study: a man reduced to this by famine, a reminder of how thin the line is out here between person and predator. Easy to kill, easy to underestimate, and a good way to make the dark between the gravestones feel dangerous.")}
  ...
  {creature(
    ...
    lore=[
      "A whole town looked at the wrong thing for too long, and now they are of one mind, and the mind is not theirs. The Flock of the Open Eye are ordinary folk (the storekeeper, the schoolmarm, the children) hollowed out and joined together by an idol they carry and worship, a thing that looked back when they looked at it. They press in close, unafraid, smiling, armed with whatever a town has to hand: farm tools, old guns, kitchen knives.",
      "They do not break. They do not bargain. They do not stop. You cannot reason with a crowd that shares one will and feels no fear, and the wrongness of all those familiar smiling faces moving together is its own kind of Dread. But they are still people, underneath, trapped in there, and the idol at the heart of the flock is the binding. Take it, break it, and the people who are still people fall down weeping, suddenly themselves, suddenly aware of what they've become."],
    found="An entire isolated settlement (a valley town, a mining camp, a religious commune) that found or was given the idol and looked too long. The whole place is the flock; outsiders who stay too long join it.",
    keeper="The Flock of the Open Eye is a town-sized horror and a moral hard place. The 'monster' is an entire community of innocent people, hollowed and bound, and they're still <em>people</em> underneath, so mowing them down is killing victims. The structure pushes the party toward the right answer: the idol is the binding, and destroying it frees everyone still salvageable. But getting to the idol means moving through a town that won't stop coming, without slaughtering the very people they're trying to save. Build the dread of the smiling, fearless crowd; the familiar faces; the children. Make the party feel the wrongness and the weight of restraint. The Mark warning is a real danger: a player who looks at the idol the way the flock does starts to join them. It's one of the book's strongest statements of its central theme: the horror here wears no fangs and no claws; it wears the faces of good ordinary people, turned into something that no longer breaks or bargains or stops. Solve the idol, save the town. Fail, and the flock just grows by however many the party brought.")}
  ...
  {creature(
    sb("The Tallyman", "Tier III &middot; he who collects the dark's debts", 16, 36, "normal; unhurried", "+9", "+7", "+12",
       ...
       "DC 16, 1d6",
       "Pay the debt, trick him into a worse one, or strike his name from the ledger he carries: the gun does nothing.",
       mark="Any dealing that puts your name in his book is +1 Mark or more."),
    lore=[
      "Every bargain with the dark has terms, and someone has to collect. The Tallyman is that someone: an unhurried, patient figure in a dark coat with a ledger under his arm, who comes at the appointed hour for the debt that was promised. He does not threaten and he does not hurry, because he does not need to. Once your name is in his book he cannot be refused, outrun, locked out, or shot; he simply arrives, at the time agreed, and collects.",
      "His reckoning ignores armor and never misses one who owes. The gun does nothing; you cannot kill a debt. The only ways past him are the ways of any creditor: pay what's owed, trick him into accepting a worse bargain, or get your name struck from the ledger he carries. And the surest way never to face him is the simplest: never put your name in his book at all, however good the deal sounds at the time."],
    found="He comes to wherever the debtor is, at the hour the bargain named. There's no lair to raid and no territory to leave; he is summoned by the debt itself, and he always knows where you are.",
    keeper="The Tallyman is consequence made flesh, and he's best used as the back half of a bargain a player or NPC made earlier. He can't be fought (the gun does nothing, he can't be outrun or barred) so the whole drama is in the three real options: pay the debt (and what does that cost?), trick him into a worse bargain (a battle of wits and contracts), or strike the name from his ledger (steal or destroy the book, which he guards as his whole purpose). Build the dread of the appointed hour approaching with no way to simply fight free. He's the perfect enforcement mechanism for the book's bargain economy: when someone deals with the Witch, the Hexer, or the Old Dark itself, the Tallyman is who comes to collect, and knowing he's out there should make every tempting bargain feel heavier. The Mark warning underlines it: getting into his book is itself corruption. Use him to teach that on this frontier, the dark always keeps its accounts, and it always, eventually, sends someone to settle them. In Perdition Basin the banker's bargain at Coffin Wells (Keeper's Book Ch. IX) is the kind of paper he comes to collect on.")}
  {creature(
    ...
    lore=[
      "Somebody survived a bad night. That's all, and it's the beginning of most of the wolf stories in this book. He came out of it with a gash that closed in three days and no fever at all, and he has spent every day since being privately certain about what is going to happen, and being right. The first week he is only tired. The second he starts hearing conversations two rooms off. By the third he has stopped eating with the family, and by the fourth he has bought a chain and told nobody what for.",
      "Almost everything about the entry is the man. He is a person the party can talk to, ride with, like, and hire, and it doesn't change the date. Played straight he gives a table its most useful thing: a horror that is happening to somebody rather than at them. Handled well, he is the reason the party goes looking for a cure. Handled badly, he is a Moon-Sick by the next full moon and the party knew him."],
    witness=("He asked me to hold onto his rifle and not give it back till the month was out, however he asked for it, whatever he said. Then he shook my hand. I've never had a worse thing asked of me by a friend.",
  ...
  {creature(
    sb("The Moon-Sick", "Tier II &middot; the one who does not know yet", 15, 24, "fast", "+9", "+7", "+3",
       ...
       "<strong>He wakes with a story he believes.</strong> Changes without warning and keeps none of it: comes to in a field, bloodied, with an account of the night that hangs together and is entirely invented. Closes 3 Blood a round from anything that is not silver or fire.",
       "DC 13, 1d4",
       "Silver and fire in the moment; there is no talking to it in the shape. By daylight the work is harder: prove it to him, with something he cannot argue with, and be somewhere he cannot reach when he finally believes you."),
    lore=[
      "The Bitten knows. The Moon-Sick does not, and that's the difference, and the horror. He is a working man with a run of strange mornings: mud on boots he swears he never put on, a shirt he burned and cannot say why, three hours out of a Tuesday that he has filled in with something reasonable because the mind will always fill it in with something reasonable. He is not lying to the party. He passes every test of an honest man because he is one.",
      "So he helps with the hunt. He rides out with the posse, takes a turn on watch, tracks with them, and is honestly sick about the stock and the Kelso girl, and one of the nights he is out on watch is one of the nights. A party that has worked out that there is a wolf-thing in the district and has not worked out that it is the fellow holding their horses has arranged, without knowing it, exactly the ambush the thing would have arranged for itself."],
    ...
    keeper="This is a social-horror creature and the fight is nearly beside the point, so build the scenario as a mystery with the answer sitting at the table. Seed it fair. He's missing on the right nights and there's always a reason, his account of a night is a little too tidy, the dogs have gone strange with him, and he flinched at a coin somebody set down. Play the accounts as sincere, because they are. The turn that makes the entry sing is that the party usually works it out and then has to prove it to him, and he will fight that with everything a decent man has; he will be hurt, then angry, then frightened, and the moment he believes them is worse than the moment they believe it. Silver on the skin in front of witnesses is the classic proof and it's cruel and it works. If the table wants the merciful road, he's a Bitten who ran out of time, so the same cures apply and now with a man who will hold still for them.")}
  ...
  {creature(
    sb("The Day-Man", "Tier II &middot; the living hand that keeps the ledgers", 15, 26, "normal", "+8", "+6", "+2",
       ...
       "Lead, like any man, and it costs you the thing he knows. Take him alive and his master hears about it inside the hour, so decide first whether you want him or the day you would spend on him."),
    lore=[
    ...
    witness=("Mr. Prine has kept the Bledsoe books nineteen years and never been short a cent. I would trust him with my daughter's inheritance. That isn't a figure of speech; I have.",
    ...
    keeper="The Day-Man is the reason a vampire arc has a middle. Without him the party's investigation runs straight at the monster; with him it runs at a helpful, respectable, entirely human obstacle who's three moves ahead because he has been reading their mail. Give him competence and give him charm, and let him be actually useful to them once or twice, early. His stat block is a formality (he's Tier II because a cornered man with a shotgun is dangerous and for no other reason) and the fight, if it happens, should feel like exactly what it is, which is shooting a bookkeeper. What you want is the interrogation, and the entry gives it a hard edge: he won't give up where the box is, and every hour they hold him is an hour his master is awake and informed. Play him as a man who made a bargain and has spent years making his peace with it. The best version of the scene is the one where he tries to recruit them, sincerely, with figures.")}
  ...
  {creature(
    sb("The Stitched Man", "Tier III &middot; what a surgeon made of a hard winter", 16, 46, "slow; and it does not stop", "+13", "+4", "+7",
       ...
       "DC 16, 1d6",
       "Take it apart, which is precisely as much work as it sounds, or burn it, which is quicker. It obeys the surgeon's voice and nothing else: including, if he can be made to say it, an order to stop."),
    lore=[
      ...
      "It is not cruel. It is not even unwilling. Left alone it splits wood and carries water and stands out in the weather because nothing about the weather bothers it, and the horror of the thing is entirely in the accounting; that it is somebody's brother from the shoulder down and somebody else's from there up, and that it will now and then say a name in a voice that came with the throat. What it does when the surgeon dies is the question the whole entry is built around, and the answer is that it keeps working, and waits, and after a long while begins to go looking for him."],
    witness=("It carried my husband in out of the drift and set him by the stove and stood in the door dripping. I thanked it. It said &lsquo;Ellen&rsquo; and I don't know an Ellen and neither does my husband.",
             "Mrs. J. Teague, at the Grange"),
    found="A remote surgery, a wintering camp, a lumber outfit with one hand that never comes to the fire. Later (years later, when the doctor is under the snow somewhere) walking a road, looking.",
    keeper="Run it as a tragedy with enormous shoulders. It should mean no harm for most of a scenario: it works, it hauls, it does what it is told, and the party's problem is moral rather than tactical until somebody gives it a bad order or somebody it won't hear tries to stop it. Save the fight for when the party has decided it has to happen, and then make it awful in the right way. The thing does not fight back so much as continue, absorbing everything, and the Reflex save of +4 means they can hit it all night and it means nothing. The names are your best tool. Have it say one that a player recognizes, once, under its breath, and let the table sit with it. Two endings are worth building toward: find the surgeon alive and get him to call it off, which turns the scenario into a manhunt for the actual monster; or find his grave, which is where it has been going the whole time, and let it lie down there. Neither of those is a fight, and both of them are better than one.")}
...
<section class="page" id="spirits">
  ...
  mentioning the rifle. That wasn't an oversight. From this chapter forward the catalogue concerns what
  is left when the body is subtracted (the grief, the grudge, the place itself gone wrong) 
  ...
  <p class="dropcap lead">You can't always shoot a haunting. These are answered with salt and truth and the right words
  said over the right ground, and they punish a party that reaches for the gun first.</p>
  <p class="note"> <strong>Signs of the kind:</strong> a cold with no draft to carry it, a sound with no mouth to make it, a latch that won't hold, and one room always colder than the next.</p>
  ...
  {creature(
    ...
    found="A particular spot (a corner of a room, a bend in the road, a single grave in a field) where someone died small and was forgotten. It doesn't move; it waits to be noticed.",
    keeper="The Cold Spot is your gentlest haunting and your best teaching tool for the chapter's central rule: <em>you don't shoot a ghost, you answer it</em>. It can't really hurt the party (yet), so it's a safe place to let them learn that salt, names, burial, and truth are the tools here, and lead does nothing. Use it as an omen and a breadcrumb: a small unrest that points to a buried wrong, a hint of a larger haunting nearby, a test of whether the party will take the trouble to do the small kind thing. Reward them when they do: a few minutes of investigation and a proper burial lays it, and maybe earns them a clue or a grateful local. And seed the warning: mention that a Cold Spot ignored can grow into something worse, so the party that brushes it off may find it waiting, stronger, later. It's the haunting equivalent of the Risen: small, simple, and setting up everything that comes after.")}
  ...
  {creature(
    sb("The Throwing Spirit", "Tier II &middot; the poltergeist", "&mdash;", 24, "fixed to a place or person", "+8", "+6", "+8",
       ...
       "DC 13, 1d4",
       "It quiets only when its grief is named and answered: the wrong righted, the truth spoken, the person it haunts set free."),
    lore=[
      "It throws things. That's the first sign and the lasting impression: iron and stone and crockery hurled across a room by no hand, doors slammed hard enough to crack the frame, a sleeping soul dragged from bed by the ankles. The Throwing Spirit is grief or rage that has found hands without a body, and it is tied either to a place where something terrible was held in, or to a living person, often a child, often someone in the grip of an emotion too big to hold.",
    ...
    found="A house with a history, or a person with a wound. An unquiet room where something was suppressed, or near a living soul (often young) in the grip of unbearable grief, rage, or fear.",
    keeper="The Throwing Spirit teaches the chapter's lesson with more force than the Cold Spot: it's actively dangerous, it can't be struck, and the only way to stop it is to solve the grief. Run the chaos (objects flying, doors slamming, the genuine danger of hurled iron) and let the party's first instinct (shoot it) fail completely so the rule lands. The investigation is the real work: is it tied to the place or to a person? What's the grief, the wrong, the unspoken truth? Often the most affecting version anchors it to a living person, frequently a child or a grieving soul, whose pain is doing the throwing without their knowing, which makes 'solving' it an act of compassion. Pair it with a family drama, a buried secret, a person who needs to be heard. The party wins by understanding, and the best resolutions feel like healing a wound.")}

  {creature(
    sb("The Crossroads Man", "Tier IV &middot; the bargain in the dark", 19, 64, "as he pleases", "+13", "+13", "+16",
       "no need of hands. He deals; but crossed, the road itself turns on you (2d8+6)",
       ...
       "DC 20, 1d10",
       "You do not beat him with force. Refuse the deal, or bind him to terms he did not foresee, and never speak your true name.",
       mark="Any bargain struck is +1 Mark at the very least, and the start of a long road down."),
    lore=[
      "Come to a crossroads at midnight with a need too big to fill honestly, and he'll be there, though you came alone, and the road was empty a moment ago. The Crossroads Man is patient, courteous, and terribly accommodating. He offers exactly what you want most: the fast gun, the cure for the dying child, the gold, the love, the second chance. The price is always something you think you can spare, and it never is.",
      "He has no need of hands and rarely shows force, because he doesn't have to. Refusing him is perfectly safe, and dealing with him is the only danger. But cross him, break a bargain, or try to cheat the terms, and the road itself turns on you. The only ways past him are to walk away from the deal, or to be cleverer than he is and bind him to terms he didn't see coming. And whatever you do, you never, ever tell him your true name."],
  ...
  {creature(
    ...
    lore=[
      "A shadow can come loose. Through a curse, a near-death, a bargain, a moment where a soul and its shadow were pulled apart and didn't quite go back together, and then the shadow has its own ideas. The Shadow That Lags moves flat along the floor and walls, fast and silent, mimicking its owner's movements a beat too late, and it wants one of two things: to rejoin the person it fell from, or to replace them.",
      "It strengthens in the dark and cowers from bright, sourceless light. The trick to pinning it is light from several sides at once, so that it can cast no edge and has nowhere to lie flat, and then it can be reunited with its owner (if the owner still lives and wants it back) or banished with flame. A person whose shadow is loose and hunting them is in slow, terrible danger, because what the shadow replaces, no one notices is gone."],
    found="Attached, at a distance, to the person it came loose from, following them through their days a beat behind, growing bolder in the dark. The owner may not even know their shadow has its own intentions yet.",
    keeper="The Shadow That Lags is an eerie, intimate haunting that turns light and dark into the mechanical battlefield. It's strong in shadow and helpless in sourceless, multi-directional light, so the tactical puzzle is to pin it with crossed lights until it can't cast an edge, then resolve it (reunite or banish). Run the creep of it: the shadow that moves wrong, the owner who feels watched by their own outline, the dread of a thing that wants to <em>replace</em> someone. The replacement angle is the real horror: if it succeeds, who's to say the person you're talking to is still casting their own shadow? Use it for an unsettling personal haunting, ideally targeting an NPC the party cares about or even a player character. The light-based solution rewards clever staging (lanterns at angles, a ring of fire, mirrors throwing light) over brute force, in keeping with the chapter's rule that a haunting is solved by learning how it works.")}
  ...
  {creature(
    sb("The House That Hungers", "Tier IV &middot; a place gone carnivorous", 18, 75, "fixed (it is the building)", "+15", "+6", "+13",
       ...
       "DC 20, 1d10",
       "Find the wrong at its foundation (the body in the wall, the deed in blood) and burn or cleanse it; until then the house cannot be fought, only survived and fled."),
    lore=[
      "Some houses are haunted. This one <em>is</em> the haunting. The House That Hungers has no ghost rattling around in its empty rooms. The building itself has gone carnivorous, a place that lures travelers in out of the storm with warm windows and open doors and then closes around them. The doors lead where they didn't before. The stairs go down when they should go up. Hallways stretch, rooms multiply, and the party that sheltered here finds itself separated, lost, and slowly digested by a thing the size of a house.",
      "You cannot fight a building with a gun. The walls take the bullets and the house barely notices. It can only be survived, fled, or unmade, and unmaking it means finding the wrong at its foundation, the thing that made it hungry: the body bricked up in the wall, the deed signed in blood, the murder in the cellar. Burn or cleanse that, and the house is just a house again, or just ash."],
    found="On a lonely road, offering shelter from the storm or the dark. A fine old house where there shouldn't be one, lights warm in the windows, the door unlatched. It looks like exactly what a cold, tired party wants to find.",
    keeper="The House That Hungers is a whole dungeon that's also the monster, and the design is built around denying the party a target to shoot. The building rearranges to separate and trap them, so run it as a survival-horror crawl: split the party, disorient them, make the architecture itself the threat (doors that vanish, stairs that betray, rooms that weren't there). The lesson lands hard: there's nothing to fight, only a puzzle to solve and a maze to survive. The win condition is finding the foundational wrong (the body in the wall, the bloody deed, the buried murder) and destroying it, which means exploring the very thing trying to digest them. Build the house's history into its rooms so investigation and survival are the same act. The classic haunted-house scenario, weaponized: the players don't clear the house, they <em>diagnose</em> it, all while it tries to eat them. Pair it with a storm outside so leaving isn't easy, and let the warm inviting windows at the start make the trap that much crueler.")}
  ...
  {creature(
    ...
    lore=[
      "Someone made dolls, and made them too well, and put something into them: grief, spite, the small souls of children who died. The dolls woke. The Dollmaker's Children are painted, jointed, doll-sized things that move only when no one is watching. Under a steady eye they are perfectly, innocently still. The instant that eye blinks or turns away, they rush (needles and little knives, a swarm of small spiteful hands) and freeze again before anyone can be sure they moved at all.",
      "What's horrible about them is the watching. You cannot look at all of them at once. You cannot blink in unison. And you must never, ever count them wrong, because if there are more of them than you thought, one is already behind you, and it has all the time it needs the moment you look away."],
    found="A nursery, a toy-shop, the workshop or home of the dollmaker who made them. They cluster where children were (or where children were lost) and they spread, doll by doll, through the houses of a town.",
    keeper="The Dollmaker's Children turn <em>attention</em> into a resource the party has to manage, which makes for uniquely tense play. They only move when unobserved, so the table is forced to think about who's watching what, who's turning their back, what happens when the lantern swings away. Run the dread of glimpsed movement, the doll that's closer than it was, the miscount. Mechanically they're fragile and fire ends them, but the catch is you have to keep eyes on them until the flames actually take, and they're a swarm, so you can't watch them all. Stage it in a confined, doll-filled space (a nursery, a workshop) where there are always more than the party can cover. The 'never count them wrong' line is a perfect way to plant dread: have the count come out different twice. It's a set-piece for a tense, claustrophobic scene, and a creature that punishes panic and rewards discipline, teamwork, and a cool head. Pair with the tragedy of <em>why</em> the dolls woke for emotional weight.")}
  ...
  {creature(
    ...
    lore=[
      "It lives behind the silver, in the world that mirrors show and still water holds, and it has been watching you through every reflective surface you've ever passed. The Mirror-Dweller reaches through the glass (a cold arm out of a mirror, a hand from the surface of a well) to seize a soul and drag it through to the other side. And what it pulls in, it replaces: it climbs out wearing your face, your reflection made flesh, and walks away into your life while you scream from behind the silver where no one can hear.",
      "It can only act where there's a reflection to hold it. A room with every mirror broken or covered, every basin emptied, every window dark, is a room it cannot enter. Somewhere there's the mirror it calls home, the one it came through first. Shatter that, and you cut it off from this side for good."],
    found="Anywhere there are mirrors and still water: a house full of looking-glasses, a town's barber-shop and parlors, a still pond. It has a home mirror it favors and spreads its reach through every reflection nearby.",
    keeper="The Mirror-Dweller makes every reflective surface a door, which makes every glass in the house a thing to watch. The party learns to fear mirrors, dark windows, still water, the polished surface of a gun, anywhere it can reach through or wear a stolen face back at them. The defensive rule is concrete and tactical: break or cover every reflection and it can't enter; a reflection-free room is a safe room. The win is finding and shattering its home mirror. The replacement horror gives it teeth beyond combat: if it takes someone, an impostor wearing their face is now loose, which can fuel a whole paranoid scenario (which of us is real?). Run the dread of the reflection that moves wrong, the face in the glass that smiles when you don't. It rewards a party that thinks about their environment and covers their mirrors, and punishes the one that walks past a looking-glass without a second thought. A gothic, claustrophobic favorite, and a great pairing with the Skin-Walker for a campaign about impostors and stolen identities.")}
  ...
  {creature(
    ...
    found="The old gallows-ground (a hanging-tree, a courthouse square, a prison yard) where an unjust execution was carried out. The structure or the spot replays the death; the bones of the wronged are usually nearby.",
    keeper="The Hangman's Echo is a haunting-as-recording, and the danger is that it conscripts the living into its replay. The Will-save mechanic (a character drawn to act out the hanging, climbing toward the noose against their will) is chilling and forces the party to save each other from a death that's trying to use them as a prop. Run the loop's eeriness: the spectral crowd, the repeated sentence, the rope that finds throats. It can't be fought (no body, just a recording with a grip), so the win is breaking the loop by answering the original injustice: right the false verdict (investigation), destroy the gallows-beam (action), or bury the wronged bones with honor (mercy). Build the historical wrong into the scenario so the party has to uncover what really happened on this ground. It pairs naturally with the Hanging Judge (the law that did the wrong) and the Gallows-Hung (the man who came back angry) for a whole campaign about frontier injustice and the dead it leaves. A strong, thematic haunting that turns the party's own bodies into the stakes.")}
  ...
  {creature(
    ...
    lore=[
      "You hear it first as a tune on the night wind, a whistle from somewhere out in the dark, almost familiar, almost beckoning. The Whistler is never seen, only heard, and its tune is a lure that walks the lost and the lonely off the safe trail and into the bog, off the cliff, into the deep water, into whatever waits in the dark it leads you to. The old hands know the rule: the closer it sounds, the farther away it truly is, and the farther it sounds, the closer it has crept.",
    ...
    keeper="The Whistler is an auditory haunting that preys on isolation and curiosity, and it runs almost entirely on dread and discipline. It targets only the lost and alone, so the meta-lesson is <em>stay together, stay on the trail, don't wander</em>, and the moment the party splits up or someone strays toward the sound, it has them. Run the sound design: the tune on the wind, the wrongness of near-sounding-far, the temptation to follow or to answer. The Will save is the hook: a character compelled to walk off toward the whistle, into the bog or off the cliff, while the others try to hold them back. The defenses are folk-discipline: stop your ears, hold the rope and the group, build the fire, never answer. Use it to make a night journey tense, to punish a party that fragments, and to reward one that keeps its head and its formation. The 'never whistle back' rule is a perfect bit of folklore to establish early and then test. Let a player be tempted to answer, and let the table feel the dread when someone does.")}

  {creature(
    sb("The Lantern-Light", "Tier I &middot; the false light over the marsh", "&mdash;", 10, "drifts", "+5", "+9", "+6",
       "no attack of its own: it leads you to the drowning-pool, the cliff, the quicksand",
    ...
    found="Over marshes, bogs, moors, and the bad ground near cliffs and quicksand, anywhere there's a lethal hazard for it to lead the lost toward. It appears to travelers caught out in the dark, cold, and frightened.",
    keeper="The Lantern-Light is the gentlest hazard in the chapter and a pure test of discipline over instinct. It can't attack. Its entire threat is the temptation to follow, and it leads only those willing to be led toward the real killer (the bog, the cliff, the quicksand). The 'fight' is psychological: the party is cold, lost, frightened, and here's hope, just ahead. Do they chase it? Run the pull of it, especially after the party's had a hard night and wants nothing more than to find shelter. The counter is simply refusing to follow, trusting known safe-conduct (the rope, the fire, the trail) over the seductive false light. It pairs naturally with the Whistler (another lure that preys on the lost) and works beautifully as a complication during a night journey or an escape. Use it to teach the party to distrust easy salvation in the dark, and to make a simple act (staying put, holding the line) into the heroic choice. A small creature with a sharp moral: out here, the warmest-looking light is often the one that wants you dead.")}

  {creature(
    sb("The Weeping Walls", "Tier II &middot; the house that bleeds", "&mdash;", 26, "fixed", "+8", "+4", "+9",
       "the room turns on you: binding, smothering, weeping blood from the plaster (2d6+3)",
    ...
    lore=[
      "A murder was done in this house and never answered (the killer never caught, the body never found, the truth never spoken) and the house has been holding it ever since. The Weeping Walls show the crime to everyone who enters: blood seeps from the plaster, the rooms turn cold and close, the air thickens until it smothers, and the house itself binds and crushes those who try to leave before they understand what it needs them to know.",
      "It is not malicious so much as insistent. It has a truth it cannot let go of, a body it cannot bury, a wrong it cannot stop reliving. The blood on the walls is the house pointing, over and over, at what was done here. Find the body (in the wall, down the well, under the floor) give it proper burial, speak the truth of the killing aloud, and the house finally, gratefully, stops weeping."],
    found="A house, room, or building where a murder was committed and concealed: the body still hidden on the premises, the crime unsolved and unspoken. The blood and cold mark the spot the house wants found.",
    keeper="The Weeping Walls is a murder mystery the building itself is begging the party to solve. The haunting's manifestations (bleeding plaster, smothering air, rooms that bind and crush) are both the danger and the clue: the house is showing the party the crime and pointing at the hidden body. It can't be fought (it's the building), only answered, and the answer is investigation plus mercy: find the concealed corpse, bury it properly, speak the truth of what was done. Run it as a haunted-house whodunit where the environment is evidence: the blood flows heaviest where the body lies, the cold deepens near the truth. The party progresses by reading the house's grief, not by surviving waves of combat. It pairs with the Cold Spot (small unanswered death) and the House That Hungers (a place gone fully wrong) on a spectrum of how badly a building can be marked by what happened in it. A satisfying, investigation-forward haunting where solving the cold case <em>is</em> the exorcism, and the house's relief when the truth is finally spoken is its own reward.")}

  {creature(
    sb("The Mourner", "Tier II &middot; the wail before a death", "&mdash;", 20, "drifts; unbidden", "+7", "+6", "+10",
       "no attack. Her keening names the one marked to die (Will DC 14 or Frightened 2)",
    ...
    lore=[
      "She comes before a death, not after, and she comes to mourn it in advance. The Mourner is a keening, drifting figure (a woman in grey, a veiled shape, a wail on the wind) who appears unbidden to announce that someone is marked to die. She does not kill. She has never killed. She is the country's grief arriving early, naming the one whose time has come, and to hear her wail your own name is to know you have very little time left to set your affairs in order.",
      "You cannot fight her, because she is not the threat; she is the warning. You cannot flee her, because she has already found you. All you can do is heed her, and act. The deaths she calls are not always certain; the swift, the brave, and the lucky have sometimes cheated the reckoning she announces, but only by moving at once, and only by understanding that her wail is not a curse but a final, sorrowful kindness."],
    found="She appears wherever death is coming, to whoever is marked: a homestead before a tragedy, a trail before an ambush, a sickroom before the end. She is drawn by approaching death, not bound to a place.",
  ...
  {creature(
    ...
    lore=[
      "There is a stretch of road outside most towns of any age where somebody will be waiting after dark. She is young, she is dressed for weather that has not come, and she asks for a ride the way anyone asks, and there is not one thing wrong with her until the gate. Riders who have carried her say she talked about ordinary things (the crop, a brother in Missouri) and that they only understood afterward that they had been doing all the talking.",
  ...
  {creature(
    ...
    lore=[
      "The Cornish brought them over with the pumps and the pasties and the deep-shaft trade, and every camp that ever hired a Cousin Jack has them now. They are small, they are heard far more than seen, and what they mostly do is knock: three raps in the rock ahead of a face that is about to go, a tapping that walks a man back up the drift a minute before the timbers speak. Half the West's mining camps have a story about a shift that came up early because of a knocking and stood on the collar listening to the level fall in.",
    ...
    witness=("Superintendent from the East called it superstition and made us work the crusts up out of the drift. Fourteen dead in the eight-hundred that October. He's back East.",
             "recorded in a union hall, Butte"),
    found="Deep workings and old workings: the levels below the water, the sealed stopes, any drift where men have died and the camp still runs. Heard on the graveyard shift more than any other.",
    keeper="This is a superb creature for a mine scenario because it's a mechanic disguised as a ghost. Run it as information: the party is underground, the knocking starts ahead of them, and they have to decide in the moment whether it's a warning or a lie. Make it a warning the first two times. Then have somebody in the party be rude (whistle, scoff, kick the offering aside) and let the third knocking come from the wrong direction. That's the entry, and it will have the table policing each other's manners for the rest of the session, which is what you want. Its numbers are small because what hurts a party here is the rock. Use it as a gate on any Chapter VII horror that lives underground, because a party in good standing with the knockers gets warned about the deep dark and a party in bad standing does not.")}

  {creature(
    sb("The Answering Voice", "Tier II &middot; the poltergeist that learned to talk", "&mdash;", 22, "fixed to the house", "+8", "+6", "+9",
       "no hands of its own. It calls, in a voice from the next room (Will DC 14 or go and see); the stair it wanted you on +6 (1d8+3 in the fall)",
       "<strong>It has your people by heart.</strong> Calls in the voice of whichever of you is furthest away, from the one room nobody has checked. It gets a single word wrong every time (a name shortened that never gets shortened, a turn of phrase not quite theirs) and that word is the entire warning.",
       "DC 13, 1d4",
       "Answer nothing until every soul is counted and standing in the same room, then keep them there. It goes quiet when somebody says out loud and plainly what it is, which means saying that the voice calling from the kitchen is not their mother."),
    lore=[
    ...
    found="An old house with a long tenancy and a hard history: the kind that has been sold three times cheap. It works after dark, and it works hardest on the first night a new family sleeps there.",
    keeper="Run this at the table as a discipline problem, and make the rule explicit early so breaking it is a choice. Nobody answers a call from another room. Then spend the session tempting them: the voice is frightened, or hurt, or has found something, and it's coming from the one direction the party hasn't cleared. The single wrong word is the fair-play clue, so plant it every time and let sharp players catch it: a mother who suddenly says &ldquo;Will&rdquo; when she has called him William for forty years. Don't give it hands. The stair, the well, and the dark do all its work, and keeping it bodiless keeps the party from solving it with a gun. The naming is the answer, and it costs something real to say: somebody at that table has to stand in a dark hall and tell a voice that sounds exactly like their mother that it's not, in front of the rest of them, and mean it. Play the silence afterward.")}
  ...
  {creature(
    sb("The Boo Hag", "Tier II &middot; the one that rides you sleeping", 14, 20, "very fast, and only between midnight and the first light", "+7", "+9", "+8",
       ...
       "<strong>She rides, and then she wears.</strong> Comes skinless in the small hours and settles on the sleeping to take the wind out of them. Ridden three nights running, a soul stays ridden, and she puts on the skin and goes about their business in it, and she must be out of it again before the sun.",
       "DC 13, 1d4",
       "Find the skin she left hanging and work salt and pepper into it. She cannot get back in before daylight, and daylight settles it. A broom laid across the sill or a sieve hung by the bed will hold her off entire; she must count every straw and every hole before she can come in, and she cannot stop herself once she starts."),
    lore=[
    ...
    keeper="Two halves and they play completely differently. The first half is a siege of the night: somebody in the party or the household is waking up wrecked, the count is running, and the remedies are folk practice and they work, so a party that asks the right old woman the right question gets a broom and a sieve and a fighting chance. Run the paralysis honestly and let it be frightening (the character is awake, aware, and can't move or shout) and never let it happen to the same player two sessions running. The second half is the impostor, and it's a different game entirely: she's wearing somebody, everybody can see her, and nobody can prove anything. Seed the routine tells rather than sinister ones, because the sinister version is a Skin-Walker and this isn't that. Keep the remedy where the tradition put it, in salt and pepper and the skin she has to get back into, so the solution is a hunt for a hanging thing in an outbuilding rather than a fight. Treat the tradition with respect at the table; it belongs to living families, and it's better horror played straight than played exotic.")}
  ...
  {creature(
    sb("The Plat-Eye", "Tier II &middot; the shape on the causeway that keeps growing", 15, 22, "as fast as it needs to be, and no faster", "+8", "+7", "+6",
       "it lays nothing on you, it swells, and comes on (Will DC 14 each round it closes or Frightened 1); the ground it herds you onto +6 (1d8+3, the ditch, the cut, the water)",
    ...
    keeper="A pure nerve encounter, and the rules of it are simple enough to state out loud at the table: it can't hurt you, and it will kill you. Run the growth in beats and make the players describe what they do each time (dog, calf, horse, and then the thing that fills the road) with a Will save between each. The whole encounter is whether anybody breaks, and the terrain does the damage when somebody does. Put it somewhere with real consequence on both sides, which is what a levee is for, and put a horse under them, because a horse gets a vote. It makes a superb complication rather than a scenario: the party is carrying somebody bleeding, or riding to stop a hanging, and this is between them and the town, and standing still costs them the very thing they can't spare. The remedies are worth handing out through an NPC beforehand so a prepared party feels clever. Sulphur in the road, and a firm rule about the eye.")}

  {creature(
    sb("The Tintype", "Tier II &middot; the memorial plate that keeps sitting", "&mdash;", 18, "fixed to the plate", "+6", "&mdash;", "+10",
       "no hands. A face that appears beside the sitter has about a week (Fort DC 14 each night or lose 1d4 Blood that does not come back); the glass, broken wrong, cuts +6 (1d8+3)",
       "<strong>The dead sit for it again.</strong> A memorial plate in which the sitter's eyes are open on Tuesday and shut on Friday. Whoever is photographed after it, or looks at it too long, turns up in the emulsion standing at the dead one's shoulder: a little further forward each time it is looked at.",
       "DC 13, 1d4",
  ...
  {creature(
    sb("The Field-Hand", "Tier II &middot; the scarecrow that works the rows at night", 15, 24, "still by day; quick down a furrow", "+8", "+6", "+4",
       ...
       "<strong>Perfectly still under any eye.</strong> Something was put into the straw: a hard man's coat, a hard man's grudge, or the hard man. The crop it tends comes in better than the neighbors' every year, in every weather, and the family has learned not to ask about it out loud.",
       "DC 13, 1d4",
       "Fire, and the field with it if the year has gone far enough to matter. Take the coat off it first and find out whose it was; you will want the name for the burying."),
    lore=[
    ...
    keeper="The trick with a scarecrow is the stillness, so use the same discipline the Dollmaker's Children use: it never moves while somebody is looking, and it's always closer when they look again. Play the daylight half as a farm mystery, because the interesting horror here is the family. They know. They've known for nine years, and they have children who are fed because of it, and they'll lie smoothly and be ashamed of it and be doing it anyway. Let the party work out the bargain before they work out the monster. The coat is the key to the whole entry: pull it off and there's a name in the lining or a face somebody in town remembers, and the resolution is a burial and a fire and a family with a hard winter ahead of them. Give the party the choice of leaving it standing, and make the argument for leaving it a real one. That's a better ending than the fight, and the fight is only a scarecrow with a hay-knife.")}

  {creature(
    sb("The Fetch", "Tier III &middot; yourself, a street ahead", 17, 36, "as fast as you walk", "+9", "+9", "+11",
       "it will not fight you. It takes your place (each day it is seen doing your business, Will DC 16 or lose 1d6 Blood and a piece of your standing in the world); cornered, your own hands +9 (2d6+4)",
       "<strong>Nobody it meets doubts it.</strong> Your coat, your walk, your voice, your signature. It runs your errands, keeps your appointments, and is a little better liked than you are. Seen by you, it means a year at the outside, unless you can get ahead of it and be somewhere it has already been.",
       "DC 16, 1d6",
       "It cannot be in two places, and that is the only handle on it. Get it and yourself into one room in front of people who know you, and it comes apart, which means finding out where you are going to be tomorrow before it does."),
    lore=[
      ...
      "It is not a mimic and it is not wearing anything. It is you, done again, and it does not appear to bear you the least ill will; it simply gets on with your life while yours gets harder to hold. Each day it is out there being you, you lose a little of the thing that makes people take you for yourself, and the world, quite reasonably, prefers the other one. Old folk will tell you the fetch means a year. What they generally leave out is what kind of year. Nobody dies of the thing itself. They die of standing in a room at the end of it with nothing left to prove who they are with."],
    witness=("I've got my own name written down here forty times to look at. He signed the note better than I do. The bank took his.",
             "found among the effects of a man in Aurora"),
    found="Your own street, your own trade, your own people: a little ahead of you, or in the town you left last week. It is never anywhere you can send somebody to check.",
    keeper="This is a horror to run against one player, so pick the one whose character has the most standing to lose and warn nobody. Start with hearsay, and keep it entirely benign for two sessions: waves, thanks, an errand done. Then start charging. Every day costs Blood and costs credit (the storekeeper is cool, the sheriff has a version of events he prefers, an ally hesitates) and the mechanical loss is nothing beside the social one, so make sure the rest of the party is present for the erosion. It's enormously important that the other players get a scene where they aren't certain which one they're talking to; run one meeting where they can't tell, and be scrupulously fair about the clues. The ending is an ambush the party has to lay on the future, which means they have to find out what the fetch has scheduled. A ledger, an invitation, an appointment book. Then everybody stands in one room and it comes apart, and the character is left with a year they were promised and can't un-hear.")}

  {creature(
    sb("The Fiddler at the Dance", "Tier III &middot; the tune that will not end", 16, 38, "he does not leave the platform", "+9", "+11", "+12",
       "he lays no hand on anybody. The reel does it (Will DC 16 or dance; a dancer takes 1d6 a round, cannot stop, and cannot be spoken to); the floor, when it finally gives +9 (2d6+4)",
       ...
       mark="Taking the fiddle when he offers it (and he will offer, to the best player in the room) is +1 Mark, and the next barn is yours to play."),
    lore=[
    ...
    keeper="A set-piece, and one of the best in this chapter, because it puts a whole community on the floor and hands the party a rescue rather than a fight. Establish the dance as a good time first (let the players enjoy an evening, dance with somebody, meet the district) and give the turn to the old woman at the wall who has stopped talking. Then run it as a clock. Every round costs the dancers, the party can pull people off the floor one at a time at real cost, and the three ways to end it are all in the room: the fiddle, a better player, and the caller. That last one is the best of them, because it means finding the caller in the crowd and getting him to do his job with his own feet going, and it turns the win into something the community does rather than something the party does to it. Save the offer for the end. If somebody at your table plays, he will hold the fiddle out to them, politely, in front of everyone.")}

  {creature(
    sb("The Wake", "Tier III &middot; the same funeral, every night", "&mdash;", 40, "fixed to the house; it begins at dusk", "+11", "&mdash;", "+13",
       "no violence in them at all. They are perfectly civil (each hour, Will DC 16 or take the chair offered, and a soul who sits does not get up); the door, tried early +9 (2d6+4)",
       "<strong>They are pleased you came.</strong> Lamps lit, coffin open, neighbors in their good coats, the food laid out, and every one of them thirty years in the ground. They will offer you a chair and they mean it kindly, and the kindness is the whole of the trap.",
       "DC 16, 1d6",
       "Somebody in that house was never buried. Find whoever it is (the child in the wall, the stranger under the porch, the one the family could not admit to) put them properly in the ground, and the lamps go out and stay out."),
    lore=[
      ...
      "They keep having it because it never finished. Something about that funeral was not completed (a body that never came, a grave that was never dug, a name the family would not say over the hole) and the evening resets at dusk and runs again, and it has been picking up strays off the road for thirty years. The ones who sat down are in there. They are in the good coats too, now, and they are as pleasant as the rest, and they will urge you very warmly to take the weight off."],
    witness=("There was a man in there I knew from the freight office who went missing in eighty-eight, and he shook my hand and asked after my mother and offered me his chair, and I haven't slept right since.",
    ...
    keeper="Run this as hospitality horror and keep the pressure entirely social. Nothing attacks. Everybody is warm, the food is good, the party is tired, and every hour somebody offers a chair with real kindness, and the save is against courtesy rather than fear, which is far harder for players to fail gracefully and far more interesting when they do. Let them notice at their own pace: the same conversation coming round again, a clock that hasn't moved, the coats forty years out of fashion, somebody in the room they last saw on a missing notice. The investigation is right there in the house, because the wake is for somebody and the party can walk up and look in the coffin. What they need is the one who was never put in the ground, and that's a search through the place while being politely offered food. If a player sits, don't take them out of the scene: let them stay conversational, comfortable, and reluctant to get up, and let their friends have to argue them out of a chair. The burial ends it. Do the burying at dawn.")}
  ...
  {creature(
    ...
    lore=[
      ...
      "You hear it a long way off, because there is nothing else out there. Whistle first, then the working of it, then the headlamp coming up the straight, and it is a full train (engine, tender, baggage, three coaches with the lamps lit and people at the windows) running on nothing at all. It stops where the halts used to be. It stands there a decent interval with the door open and a conductor on the step looking down the platform, and then it goes on. Everybody in the district knows to be off the grade by eleven. Everybody in the district also knows the names of four or five people who were not."],
    witness=("The conductor was patient with me. He said there was room and he said it twice and he held the door, and the thing I can't get past is that I wanted to. It was cold and I was a long way from anywhere and there were lamps.",
             "a surveyor, who walked home instead"),
    found="An abandoned grade, a pulled-up branch line, the roadbed of a company that failed, and the platforms of the halts along it, which are usually the only structures left standing for miles.",
    keeper="The whole encounter is the offer, so build to it. Put the party on the grade at night for a good reason (it's the only straight road, it's the fast way, the weather has come in) and give them a long approach with the whistle in it. When it stops, the conductor is courteous and the coaches are warm and lit and it's very cold outside, and that's the scene. Nobody has to make a save to want it. If someone boards, don't resolve it in a round: they're on it, it pulls out, and the party has a session to get them off before the wreck it is running toward, which is the only place it will stop again. That gives you a chase along a roadbed with no train on it and a deadline made of a timetable. The ending is a dig. Find where the line went into the cut in seventy-nine, find what the company covered over rather than recover, and bury it, and the timetable finally runs out. A good long arc, and it pairs well with a railroad company that would rather the party did not.")}
...
<section class="page" id="wild">
  ...
  <p class="dropcap lead">Some horrors have no body to bury because they're the land, the cold, the fire, the hunger of
  empty places. You don't kill these so much as outlast them, turn them, or give them what they came for.</p>
  <p class="note"> <strong>Signs of the kind:</strong> weather that comes too fast or won't move on, a heat or a cold the season doesn't own, water that recedes as you near it, and a stillness with no birds in it.</p>
  ...
  {creature(
    ...
    found="The deep-winter country (the snowbound mountains, the frozen north, the high passes) especially where starvation or cannibalism has happened. The blizzard that rides with it can bring its season anywhere.",
    keeper="The Wendigo is the apex of this book's cold-and-hunger horror and the payoff of the Wendigo-Touched and the Hunger That Walks. Run all three across a campaign and let the dread compound. Its numbers are brutal and the cold is unbeatable, so the fight is about fire and the frozen heart: cold can't touch it, only flame, and the kill is to cut out and burn its heart of ice. The call is its signature terror: any party member who's eaten the dead or starved past reason (and the frontier creates such people) hears it nightly, and must save or walk out into the storm. This turns survival itself into the threat and can turn a party member into a liability or a casualty. Run the blizzard as part of the monster: the storm is its body and its cover. The Mark warning makes the hunger a moral abyss: answer it willingly and you're marked forever, and noticed. Use the Wendigo when you want winter itself to become a predator, and when the party's past choices (who did they leave to starve? who ate what to survive?) come back wearing antlers and calling their names.")}
  ...
  {creature(
    sb("The Hunger That Walks", "Tier III &middot; a wendigo new-made", 17, 42, "very fast", "+11", "+9", "+6",
       ...
       "<strong>Not yet whole.</strong> A man lately turned, still half himself, still nameable, and for a little while yet, still possible to save.",
       "DC 16, 1d6",
       "Fire and iron put it down; faster, a true name and a held warmth may yet call the man back from it, once.",
       mark="As the Wendigo."),
    lore=[
      "Between the man and the monster there is a window, and the Hunger That Walks lives in it. This is a wendigo new-made: a soul lately turned, the cold not yet finished with him, still half the person he was and still answering, for a little while, to the name he was given at birth. He is fast and frost-clawed and the cold deepens around him, but he is not yet the towering thing of the deep storm. He is a man losing the fight, and not quite lost.",
      "And because he is not yet whole, he can still (for a little while, and only once) be called back. Fire and iron will put him down like any of the cold things. But a true name spoken with love, a warmth held out and not withdrawn, may yet reach the man still drowning inside the hunger and pull him back to himself. The window is narrow. It closes fast. But it is there, and a party that knows it is there has a choice the deep-winter Wendigo never offers."],
    found="The edges of the deep-winter country, near where a man was lost to starvation or the cold: a recently-stricken camp, cabin, or pass. He often still haunts the place and people he knew in life.",
    keeper="The Hunger That Walks is the Wendigo's tragedy made personal and salvageable, and it gives the party a wrenching choice the full Wendigo denies them. Mechanically it's a lesser cold-thing, killable with fire and iron, but the entry offers a second path: a true name and held warmth can call the man back, <em>once</em>. This is the emotional core. If the new-made wendigo is someone the party knew (and it should be, when possible), the question becomes: do you put him down, safe and certain, or do you risk reaching the man still inside, knowing the window is closing and failure means the cold gets you too? Run the half-state with pathos (flashes of the person, the name, the memory) alongside the genuine danger. It pairs directly with the Wendigo-Touched (the human stage) and the Wendigo (the lost end), letting you run a three-act tragedy of a single soul. Don't make the rescue easy or guaranteed; make it a real gamble with a real cost. The party that saves him earns one of the campaign's great victories. The party that fails, or chooses the bullet, earns one of its great sorrows. Either way, they'll remember it.")}
  ...
  {creature(
    ...
    keeper="The Dust Devil is a hazard-creature that makes the party fight the environment. There's nothing to shoot (it's a spinning column with no center), so the entire encounter is about finding shelter: stone to get behind, ground to get below, a still place that breaks its spin. Run it as a scramble across exposed ground toward cover, with the flaying grit and blinding and breath-stealing raising the pressure each round they're caught in the open. It's a great way to make a desert crossing dangerous and to reward terrain awareness and quick thinking over firepower. Use it as a complication during a chase or a journey, or as the desert's warning shot before a bigger threat. Some of this country's monsters can't be beaten at all, and you survive them by knowing where to hide. Pair it with the Thirst and the Singing Sand for a desert that's actively, patiently trying to kill anyone crossing it.")}
  ...
  {creature(
    sb("The Red Wind", "Tier III &middot; the prairie-fire that hunts", 16, 40, "very fast; spreads", "+11", "+9", "+3",
       ...
       "<strong>It chooses.</strong> A wildfire with a malice in it, turning against the wind to take the fleeing and spare the still, or the reverse, to herd them.",
       "DC 16, 1d6",
       "A backfire, a wide break, or a river robs it of ground; find and quench the cursed thing at its origin: a brand, a body, a burned wrong."),
    lore=[
      "A prairie fire is terror enough when it's only fire. The Red Wind is worse, because it chooses. It turns against the wind when it should die down, leaps firebreaks and gullies that no honest fire could cross, and it picks: running down the man who flees and sparing the one who stands still, or the reverse, herding a fleeing party toward the cliff or the box canyon where it means to finish them. There is a malice in it, a will, a hunger that uses flame the way other things use teeth.",
      "It was born of a wrong (a brand thrown in spite, a body burned, a curse worked into the dry grass) and that origin is its heart. The ordinary fire-fighting tricks buy time: a backfire, a wide break, the far side of a river. But the Red Wind keeps coming until the cursed thing at its source is found and quenched, and only then does it become, at last, just a fire, that ordinary means can finally put out."],
  ...
  {creature(
    ...
    keeper="The White Death turns a winter night into a siege, and the siege is the encounter. It can't be meaningfully attacked, it's the storm, so the party's task is to <em>hold a fire through the night</em>. Run it as a survival scenario: the cold bleeding the unsheltered each round, the storm trying to smother the flames, the desperate work of keeping the fire fed and big enough while the White Death claws at it. This makes fuel, shelter, and endurance into the mechanics that matter. The dread is the relentlessness: the cold that gets in everywhere, the fire that keeps guttering, the long hours till dawn. It pairs with the Wendigo as the chapter's two faces of killing cold (the hunger that walks vs. the cold that besieges). Use it to make a winter crossing deadly, to put the party's resource management and teamwork under real pressure, and to teach that against some forces the only victory is to outlast them. A great bottle-episode threat: one night, one fire, one storm with a face, and dawn a very long way off.")}

  {creature(
    sb("The Thirst", "Tier II &middot; the water that isn't there", "&mdash;", 26, "drifts ahead, always ahead", "+9", "+7", "+8",
       "no blow. It shows you water and drinks you dry as you chase it (Fort DC 14/day, Drained and worse)",
    ...
    keeper="The Thirst is a psychological hazard that weaponizes hope and the body's own desperation. It can't attack; it lures, showing the party the water they're dying for and leading them away from the real thing. The 'fight' is the agonizing discipline of refusing to chase visible water, trusting navigation over the eyes, walking away from salvation. Run it during a desert crossing when the party is really low on water, so the temptation is real and the stakes are survival. The Fort save each day (Drained and worse) represents the body failing as it chases the mirage. It pairs with the Lantern-Light (another lure that preys on the lost and desperate) and the Dust Devil and Singing Sand as the desert's arsenal. Use it to make water itself a story element: to turn a crossing into a test of nerve and trust, where the party's enemy is their own thirst and the false hope the desert dangles. Out here, the thing you want most can be the thing that kills you, and sometimes surviving means turning your back on it and walking the hard line you know. In Perdition Basin it waits in the Badlands past the South well, where the river dies in the sand.")}
  ...
  {creature(
    ...
    lore=[
      "The river was here first, and it remembers. When men dam it, divert it, build their town in its old floodplain and forget to ask its leave, the Flood-Serpent rises: the spirit of the river itself, come to take back the valley. Its body is the flood: a wall of water that sweeps away fences and barns and bridges, that drowns whole bottoms overnight, that rises faster than anything living can outrun and means to put the valley back under water where it belongs.",
      "You cannot fight a flood. Bullets vanish into it; there's nothing to strike but the rising water itself. But the river can be answered, because the river has a grievance: an offering left at the old ford, a dam broken to let it run its true course, the bones it wants returned to the water it took them from. Give the river what it came for, and the Flood-Serpent subsides into a river again, and the valley drains, and the survivors rebuild; this time, perhaps, asking leave."],
    ...
    keeper="The Flood-Serpent is a disaster with a grievance, and it runs as a race against a rising flood rather than a battle. Its body is the water (unfightable, unstoppable by force) so the party's task is twofold: survive the flood (evacuate, reach high ground, save who they can) and answer the river's grievance (the offering at the old ford, the dam to break, the bones to return). Build the scenario around discovering <em>why</em> the river has risen: what did the town do, what does the river want, what wrong needs righting? Run the flood as a mounting environmental threat (the water rising, the bottoms drowning, the desperate rescues) while the party works out the cause. It pairs with the Horned Serpent (a thing <em>in</em> the water) as the chapter's water-horrors, and with the Drought-Bringer as the land's revenge for how it's been used. Use it to make a flood epic and meaningful, to put the party in the role of disaster-responders and investigators at once, and to comment on what settlement takes from the country without asking. Give the river its due, and it becomes a river again. Ignore it, and it takes the valley.")}
  ...
  {creature(
    sb("The Stone Giant", "Tier IV &middot; the mountain that stirs", 21, 78, "slow; unstoppable", "+16", "+8", "+10",
       ...
       "DC 20, 1d10",
       "You do not fell it; you flee it, lead it astray, or lull it back to its long sleep. Do not wake it again."),
    lore=[
      "There are mountains that are not only mountains. The Stone Giant is a thing of the high rock, old beyond the reckoning of men, that sleeps for ages as a ridge or a crag or a tor. A mine driven too deep, a charge set wrong, a greed that dug where it should have left the rock alone, and the mountain stirs, and stands, and steps, and the ground shakes with every footfall. It is slow. It is also utterly unstoppable, and nothing the frontier owns will so much as scar it.",
      "You do not fell a mountain. The whole question, once it's roused, is how to survive it and how to put it back to sleep: to flee it, to lead it astray over ground that doesn't matter, to lull it back into the long dreamless rest it was woken from. And then, the hard part, the part men never seem to learn: to leave it alone, and never, ever wake it again."],
    found="The high mountains and ancient rock, where it sleeps disguised as the landscape itself. It wakes only when disturbed: by deep mining, by disrupted ground, by some greed or folly that won't let the old rock lie.",
    keeper="The Stone Giant is the book's lesson that some things are too old and too vast to fight, only to survive and to let lie. Its numbers and unstoppability make combat a non-starter (you can't fell a mountain), so the encounter is about flight, misdirection, and the deeper goal of lulling it back to sleep. Run it slow and apocalyptic: each step shakes the ground, each granite fist flattens what it hits, and the party's cleverness (leading it astray, finding what will quiet it) matters far more than their guns. The framing is pointed; it was woken by greed or folly (a mine driven too deep, ground disrupted), which ties it to the cost of how men use the country. Build the scenario around what woke it and what will quiet it, and let the resolution be restoration and restraint rather than victory. It pairs thematically with the Thunderbird (another ancient thing not meant to be killed) as the chapter's reminders of the party's smallness. Use it to humble, to awe, and to teach that the oldest monster is the country itself, and the wisest course is sometimes to put a thing back to sleep and walk away without a sound.")}

  {creature(
    sb("The Drought-Bringer", "Tier III &middot; the curse on the land", "&mdash;", 40, "fixed to the country it withers", "+11", "+5", "+11",
       "no blow. The land dies around it, wells fail, stock falls, and folk turn on each other (Will saves vs. despair)",
       ...
       "DC 16, 1d6",
       "Lift the curse at its root (the broken oath, the poisoned well, the wronged dead) and the rain returns; the gun is useless against a dry sky."),
    lore=[
      "Where it settles, the rain forgets the way. The Drought-Bringer is a curse on the land made manifest: not a thing you can see crossing a field, but a withering that spreads from a poisoned center, drying the wells, killing the stock, cracking the ground, and turning neighbor against neighbor as the country starves and the despair sets in. It feeds on that slow ruin, on the strife and the dying hope, growing stronger the longer the land suffers.",
      "There is no shooting a dry sky. The Drought-Bringer has no body to fight. It has a curse to lift, and the curse has a root: a broken oath, a poisoned well, a wronged dead that was never answered, some wrong done to the land or on it that festered into this withering. Find that root and set it right (honor the oath, cleanse the well, lay the wronged to rest) and the rain remembers the way, and the country comes back to life, and the despair lifts like a fever breaking."],
    found="A region withering under unnatural drought, spreading from the cursed root-cause: a poisoned well, a betrayal, an unavenged death tied to the land. The whole afflicted country is its body.",
    keeper="The Drought-Bringer is a slow apocalypse and a mystery, and it makes the entire afflicted region the 'monster.' There's nothing to fight (the gun is useless against a dry sky) so the encounter is pure investigation and restoration: find the root of the curse (the broken oath, the poisoned well, the wronged dead) and set it right. Run the creeping ruin as the pressure: the failing wells, the dying stock, the community fraying as despair takes hold (the Will saves vs. despair can affect the party too, and certainly the NPCs around them). This is a scenario about a whole region in crisis and the party as the ones who diagnose and heal it. Build the history into the land (what wrong was done here, who did it, what was promised or poisoned or buried) so the cure is a piece of detective work and moral reckoning. It pairs with the Flood-Serpent as the land's two revenges (too little water, too much) and with the Scalp-Taker's Ghost as the country remembering an old wrong. Use it to slow the campaign down into something somber and humane, where heroism means restoring a dying land rather than killing a monster, and where the rain returning is the most satisfying victory the party can earn.")}
  ...
  {creature(
    ...
    lore=[
      "At dusk the dunes begin to hum: a low, droning, almost musical sound that rises off the sand as the heat leaves it, and that gets into a tired traveler's bones and tells him, gently, that this would be a fine place to lie down and rest. The Singing Sand is the desert's lullaby and its grave both. Those who heed the song and bed down on the singing dunes sink as they sleep, the sand shifting and swallowing, so that by morning there's nothing left but smooth dune and a hump that the next wind erases.",
...
<section class="page" id="olddark">
  ...
  <div class="divider"></div>
  {quote("Don't read the part that comes after this. I'm leaving it in only so you'll know I was warned, and went on.", "sealed testimony, Calvary Wells")}
  <div class="narr">Here the field-book runs out of field. What follows was never a man, was never a
  beast, and was never made by the country: the country only holds the door. The compiler offers
  no advice for this chapter, because there's none to offer: there's only the knowing, and the price
  ...
  <p class="dropcap lead">These are the deep things: the Old Dark and its reaching hands, the wrong that comes from
  outside the world. You rarely kill them. You close the door, and you hope it stays closed.</p>
  <p class="note"> <strong>Signs of the kind:</strong> angles that won't add up, dreams shared between strangers, a word everyone has lately begun to use that no one taught them, and a wrongness the eye keeps sliding off of.</p>

  {creature(
    sb("Servant of the Deep Dark", "Tier IV&ndash;V &middot; the Old Dark's reaching hand", 21, 90, "it is nearer than it was", "+15", "+13", "+19",
       ...
       "You do not kill it; you close the door: break the rite, cleanse the ground, end the bargain that thinned the veil.",
       mark="Any plea or working aimed at it or at the Old Dark behind it is +1 Mark at least."),
    lore=[
      "It is a hand reaching through from somewhere that is not anywhere, the local instrument of the Old Dark, the vast and patient thing that waits beyond the veil and now and then puts a piece of itself through. The Servant of the Deep Dark does not belong here, and the world knows it: the geometry of the thing is wrong, its limbs reach from angles that aren't there, and it is never quite where the eye says it is, so that lead and steel close around it like water around a stone and find nothing to break.",
      "To glimpse it is bad. To behold it fully, to let the eye actually resolve what it's looking at, is to risk the mind coming apart. And it is always nearer than it was, drawn through by some rite, some bargain, some thinning of the veil that a fool or a desperate man performed. You do not kill a reaching hand. You close the door it reached through, and you pray the rest of the thing doesn't notice the door is gone."],
    found="Wherever the veil has been thinned: a site of dark ritual, a place where a bargain was struck, ground that's been soaked in the wrong kind of attention. It manifests near the rite or the bargain that called it.",
    keeper="The Servant of the Deep Dark introduces the chapter's iron rule: <em>you shut these out; nothing here dies</em>. Its wrongness is mechanical (weapons close like water around it, it's nearer than it was, beholding it fully courts an Affliction) so a party that tries to win by damage will fail and lose their minds trying. The win is to close the door: find and break the rite, cleanse the ground, end the bargain that thinned the veil. This makes the encounter an investigation under terrible pressure: what opened this door, and how do we shut it, before the hand pulls more of itself through? Run the dread of the wrong geometry and the thing that won't stay where it's looked at. The Mark warning is central to the whole chapter: any attempt to plead with or work upon it or the Old Dark behind it corrupts. Use it to establish that the party has crossed into territory where their guns are nearly useless and their wits, nerve, and restraint are all that stand between them and something that was never meant to be here. It's the gateway to the deep dark, and it should feel like a door closing behind them. In Perdition Basin it's what the thing under the water sends to a pulled nail, and what stands at the Mission spring if the master nail goes (Keeper's Book Ch. XIII).")}

  {creature(
    sb("The Whisperer's Mouth", "Tier III &middot; a vessel for the Old Dark's words", 16, 38, "normal", "+9", "+7", "+13",
       "no blow. It speaks (Will DC 16 each round heard or take 1d6 and lose the thread of your own mind)",
       ...
       "DC 16, 1d6",
       "Silence it (deafen yourself, gag or end the vessel) and do not, whatever it promises, listen for the rest.",
       mark="Heeding what it says is +1 Mark."),
    lore=[
      "Something out beyond the veil has things it wants said, and it needs a mouth to say them. The Whisperer's Mouth is a person, or what's left of one, hollowed out and made into a vessel for a voice from outside. It does nothing but talk. It raises no hand, makes no attack. And it is one of the most dangerous things in this book, because the words it speaks are <em>true</em>, and that truth is the harm of them: secrets that unmake you to know, answers to questions you should never have asked, the outlines of things the mind is not built to hold.",
      "Hear it long enough and you lose the thread of your own mind, unspooling as the true and terrible words wind into you. The only defense is silence (stop your ears, gag the vessel, end it if you must) and the discipline never to listen for the rest, no matter what it promises to tell you, no matter how badly you want to know."],
    found="Wherever the Old Dark wants a message delivered. The vessel may be a captured person, a corpse, a cultist who volunteered, set in a place it means to influence. It speaks to whoever comes within earshot.",
    keeper="The Whisperer's Mouth weaponizes knowledge and curiosity, and it's a fight the party wins by <em>refusing to engage</em>. It has no attack but speech, and the speech is true, and that's why it's deadly. The mechanical pressure is the per-round Will save for anyone who keeps listening, eroding their mind. The defenses are about silence and discipline: deafen yourself, gag or destroy the vessel, and crucially, don't listen for more even though it offers true and tantalizing answers. The horror is the temptation; it knows things, real things, things the party desperately wants to know (about the plot, about their pasts, about the dark itself), and listening is how it kills you. The Mark warning is sharp: heeding what it says corrupts. Run the agonizing pull of forbidden truth, and reward the player who has the discipline to clap their hands over their ears and cut the vessel's throat rather than hear one more sentence. It's a test of a party's restraint and a pure distillation of cosmic horror's central idea: some knowledge costs you the mind that holds it.")}
  ...
  {creature(
    sb("The Star-Spawn", "Tier V &middot; the thing that fell", 23, 110, "crawls; flies wrong", "+19", "+15", "+19",
       ...
       "It cannot truly be killed by the living: bury it again under stone and salt, flood the crater, or seal the place and never speak of it."),
    lore=[
      "It came down with the falling star, and the crater is the first thing it made. The Star-Spawn is a thing from the cold between the stars, fallen to earth and broken loose, and the country around its landing is already wrong: the plants growing in colors that have no names, the animals changed, the water gone strange, the very ground beginning to reshape itself to suit a thing that was never meant to touch this world. It crawls and it flies in ways that flight should not work, and its gaze alone can boil a man's mind in his skull.",
      "You cannot kill it, not really, not with anything the living own. It is too far from the rules that govern dying things. All you can do is put it back (bury it again under stone and salt, flood the crater it made, seal the place and walk away and never speak of it again) and hope that what you've sealed stays sealed, and that the land it's already changed can someday be changed back."],
    found="At the crater where it fell: a blast-site, a scar on the land, a valley gone wrong. The corruption spreads outward from there; the longer it's loose, the larger the changed country grows.",
    keeper="The Star-Spawn is full cosmic horror: a Tier V thing that can't be killed, only contained, and that's already remaking the world around it. Its numbers are overwhelming and the mind-boiling gaze makes even approaching it deadly, so frame the encounter entirely around containment: bury it under stone and salt, flood its crater, seal the place. The spreading corruption is the clock: the changed land grows, the wrongness deepens, the window to seal it closes. Run the alien landscape as dread in itself: the wrong colors, the changed animals, the strange water, the country becoming something else. The party's victory is small and grim, not slaying it but burying it again and walking away, which is the genre's whole point. It pairs with the Eye Between Stars and the Wound in the World as the chapter's apex cosmic threats. Use it when you want to confront the party with something far beyond them, where the heroic act is sealing a door rather than winning a fight, and where the best possible outcome is that the thing goes back to sleep and the land slowly forgets. There's no clean victory here. There's only containment, and the hope it holds.")}
  ...
  {creature(
    ...
    lore=[
      "It drifts into town like a fog with a shape inside it, pale and cold and draining the color from everything it passes, and it has come to deliver a message: that this place has been noticed, that its end is coming, that the Old Dark has turned its attention here and will arrive within the season. The Pallid Herald is an announcement made flesh, and its very message is a curse: to hear it in full is to be marked, to be part of the ending it foretells.",
      "Driving it off is easy enough and accomplishes nothing; it is only the messenger, and killing the messenger does not unsend the message. Its master's eye is already on the town, and the Herald's coming means the clock has already started. The only real answer is to find out <em>why</em>: what did this place do, what drew the deep dark's attention, what bargain or rite or buried wrong invited the worse thing the Herald announces, and undo it before the season turns."],
    found="A town or settlement that has drawn the Old Dark's attention: usually through a rite, a bargain, a buried wrong, or simple bad luck. The Herald arrives first; the worse thing follows within the season.",
    keeper="The Pallid Herald is a harbinger and a deadline, and its purpose is to start a clock. When it arrives and delivers its message, you've told the party that something far worse is coming and given them a season to prevent it. Driving off the Herald itself is a trap. It's just the messenger, and its master's attention is already fixed. The real work is investigation: <em>why</em> has the deep dark noticed this place, and how do you make it stop noticing? Build the scenario around uncovering and undoing the cause (the rite performed, the bargain struck, the wrong buried) before the worse thing arrives. The Mark warning, hearing the full message corrupts, means even receiving the warning has a cost. Run the Herald's coming as creeping dread: the color draining from the world, the cold, the sense of a countdown beginning. It's a scenario-opener that hands the party a mystery, a deadline, and high stakes all at once, and it sets up a back-half confrontation with whatever the Herald announced. Use it to make the party feel time pressing on them, and to frame a whole adventure as a race to un-draw the eye of something vast before it finishes turning toward them.")}
  ...
  {creature(
    ...
    lore=[
      "They were a congregation once (a church, a commune, a tent-revival full of the faithful) and they found a relic, or were given one, and they could not stop touching it. One by one they melded to it and to each other, flesh fusing to flesh around the thing at the center, until the whole congregation became a single crawling mass of a hundred hands and mouths, dragging itself across the country and pulling in every soul it can reach to add to itself.",
      "It is slow but it is tireless, and it grows with each person it takes. The hands reach and grab and draw you in toward the heaving center, and if they pull you in, you become another part of it. But the relic at its heart is the binding that holds the whole mass together (take it, break it, burn it) and the mass comes apart at last into what it always was underneath: a great many poor dead people, finally released, finally still."],
    found="Wherever a congregation found the wrong relic and could not let go: an isolated church, a religious commune, a revival camp. The mass crawls slowly outward from there, growing as it takes in more souls.",
    keeper="The Crawling Congregation is a swarm-with-a-heart (kin to the Gravecaller and the Carrion Cloud) given a tragic, cosmic-horror frame. The mass grows with every soul it takes, so it's a clock and a threat at once: the longer it's loose, the bigger it gets. The win is the relic at its center: take, break, or burn it, and the whole thing falls apart into its component dead. So the encounter is about reaching the heart through the grabbing, drawing mass without being pulled in and added to it. The pathos is heavy: it's made of fused, melded people, victims all, and freeing them (by destroying the relic) is a mercy as much as a victory. Run the dread of the crawling mass of hands and mouths, the horror of a grabbed character being drawn in toward fusion, the recognition of familiar faces in the heaving whole. The Mark warning, touching the relic corrupts, makes the kill-switch itself dangerous, so the party must find a way to break it without succumbing to it. Use it for body-horror with a moral core, and to show what blind devotion to the wrong thing does to ordinary faithful people.")}

  {creature(
    sb("The Wound in the World", "Tier V &middot; a place where the veil tore", "&mdash;", 110, "fixed; it is a hole in everything", "+19", "+19", "+19",
       "reality fails near it: flesh, distance, and time come apart (3d8+8, no save to halve within it)",
       "<strong>Not a creature.</strong> A tear where something pushed through; things crawl out of it, and it widens while it is open.",
       "DC 25, 1d10 + Affliction",
       "Sew it shut: undo the rite that tore it, restore what was sacrificed, or close it with a willing life given right. Nothing less will hold.",
       mark="Working near it, or feeding it, is +1 Mark or more."),
    lore=[
      "It is not a creature at all. It is a hole: a tear in the fabric of the world where something pushed through from the other side and left the veil ripped open behind it. Near the Wound in the World, reality simply fails: flesh comes apart, distance stops meaning anything, time runs wrong or stops or doubles back. Things crawl out of it, drawn or birthed or vomited from whatever is on the far side, and the tear widens the longer it stays open, the hole in everything growing toward the day it can't be closed at all.",
      "You cannot fight a hole. You can only sew it shut, and that costs. Undo the rite that tore it open. Restore what was sacrificed to make it. Or close it the old, terrible way: with a willing life, given right, in full knowledge of what it buys. Nothing less will hold the wound closed, and the longer the party waits, the higher the price climbs, and the more of the far side bleeds through into here."],
    found="At the site of a catastrophic rite or sacrifice: a place where a bargain went too far and tore reality open. It's fixed in place but its effects spread outward as it widens; things from beyond emerge around it.",
    keeper="The Wound in the World is the chapter's purest containment scenario: there's no monster to shoot here. There's a tear in the world, and the entire encounter is about closing it before it widens past closing. Its 'attack' is reality failing in its vicinity (no save to halve, within it), making proximity itself lethal, while things crawl out of it as ongoing threats. The win is sewing it shut, and the options carry escalating moral weight: undo the rite (investigation), restore what was sacrificed (a quest), or close it with a willing life given right (the terrible last resort). That final option is one of the heaviest choices the book offers: a sacrifice play, ideally one a party member might volunteer for. Run the widening as a relentless clock and the bleed-through as mounting chaos. The Mark warning notes that working near it or feeding it corrupts, so even the act of closing it is fraught. Use it as a campaign climax, a point-of-no-return crisis where the stakes are the world bleeding into something else and the cost of saving it may be one of their own. It's cosmic horror at its most demanding: nothing to kill, and a catastrophe to contain, and a price that someone has to pay.")}
  ...
  {creature(
    sb("The Faceless Rider", "Tier IV &middot; it rides ahead of ruin", 20, 68, "very fast; always just ahead", "+15", "+15", "+13",
       ...
       "<strong>The outrider of catastrophe.</strong> Where it passes, disaster follows: flood, fire, plague, war; it cannot be stopped, only outrun and warned-of.",
       "DC 20, 1d10",
       "You cannot kill the warning. Outrace it to carry word ahead, or turn aside the ruin it heralds before it arrives."),
    lore=[
      "It rides ahead of the ruin, faceless under its hat, always just ahead on the road no matter how fast you ride, and where it passes, disaster comes behind it: the flood, the fire, the plague, the war, the catastrophe that's already coming and cannot now be stopped. The Faceless Rider is the outrider of ruin, and to see it on the road ahead of you is to know that something terrible is bearing down on wherever it's headed.",
      "You cannot kill it. It is not the disaster, only its herald, and it cuts down the stragglers and the messengers who fall behind: the ones who might have carried warning, the ones who might have outrun the ruin to alert the town ahead. The only thing to be done is to beat it: outrace it to carry word ahead of the catastrophe, or find a way to turn aside the ruin it heralds before the Rider's road runs out and the disaster arrives."],
  ...
  {creature(
    ...
    lore=[
      "Something came up through the deep water-table and into the town well, and now the town has been drinking from its lair without knowing it. The Thing in the Well lives down the dark shaft, in the cold water at the bottom, and it reaches up: a long pale arm out of the black, grasping for whoever leans too far over the lip to draw the morning water, dragging them down into the deep where it lives. The water tastes wrong, lately. People have started to go missing at the well.",
      "It fouls the water it lives in, so the town that drinks from it sickens slowly even as it loses people one by one. You cannot easily fight a thing at the bottom of a well-shaft. The answer is to stop drawing from it (fill the well with stone and salt, or pour in oil and burn it out, and dig the town's water somewhere else) and to do it before the thing in the dark decides to come up the shaft on its own."],
    ...
    keeper="The Thing in the Well is intimate, claustrophobic cosmic horror: a small-scale entry that makes a town's most ordinary necessity into a deathtrap. The well is the town's water and its dependence, which is the cruel hook: they need it, they drink from it, and it's killing them slowly while taking them one by one. The horror builds through investigation: the wrong-tasting water, the people missing from the well, the slow sickness, the realization of what's down the shaft. It can't easily be fought (it's at the bottom of a well, reaching up), so the answer is denial and destruction: stop drawing, fill it with stone and salt or burn it out with oil, dig water elsewhere. The drama is convincing a desperate town to abandon and destroy its only water source on the word that something lives in it. Run the dread of the pale reach up the dark shaft, the lean over the lip, the grab. It's a tighter, smaller-scale piece than the chapter's apex threats. Use it for a focused village-horror scenario about a community poisoned by the thing it depends on, and about the hard cost of giving up something you need because it's been taken from you by the dark. In Perdition Basin any well whose nail has failed can have one in it by the next season (Keeper's Book Ch. XIII).")}
  ...
  {creature(
    sb("The Sermon Made Flesh", "Tier IV &middot; a doctrine given a body", 20, 70, "normal", "+13", "+9", "+16",
       ...
       "DC 20, 1d10",
       "Unmake the idea (prove the lie at its center, break its hold on the faithful) and the flesh has nothing left to hold it together.",
       mark="Speaking its creed aloud, even to refute it, risks +1 Mark."),
    lore=[
      "A belief can grow so dark, and be believed so hard by so many, that it stops being merely an idea and takes on a body of its own. The Sermon Made Flesh is a doctrine incarnate: a creed walking around in a shape, preaching itself, its Word a weapon that converts the very people it strikes, folding the slain into its growing choir. What walks is the belief itself, given hands and a voice and a terrible momentum.",
      "You cannot kill an idea by shooting the body it wears: the belief just finds new flesh, new mouths, new believers. The only way to end it is to unmake the idea itself: prove the lie at its center, break its hold on the faithful, show the doctrine to be the falsehood it is. Do that, and the flesh has nothing left to hold it together, and the Sermon Made Flesh comes apart for want of anyone left to believe it."],
    found="Wherever a dark doctrine has taken deep root: a corrupted church, a fanatical movement, a town that gave itself over to a terrible creed. It manifests where belief in it is strongest and preaches to spread.",
    keeper="The Sermon Made Flesh is a war of ideas dressed as a monster, and it can't be won with bullets. Its Word converts those it strikes (and the slain become its choir), so a straight fight only feeds it: every casualty joins the other side. The win is unmaking the <em>idea</em>: prove the lie at the doctrine's center, break its hold on the faithful, expose the falsehood that gives it power. So the encounter is really a battle for belief: an investigation into the creed's lie, a confrontation that's argued and proven as much as fought, a effort to deconvert the faithful out from under it. The Mark warning is sharp: even speaking its creed aloud to refute it risks corruption, so the party must fight the idea without being infected by it. Run the dread of a belief that walks and preaches and grows, of friends or townsfolk converting mid-fight. Use it to explore fanaticism, dangerous ideas, and the way a creed can outlive any believer. It pairs with the Flock of the Open Eye and the Hollow Prophet as the book's studies of belief weaponized. The lesson: some enemies are ideas, and you beat an idea by proving it false, not by killing the mouth that speaks it.")}
  ...
  {creature(
    sb("The Devourer's Tongue", "Tier IV &middot; one reaching part of a greater hunger", 20, 66, "lashes from below", "+15", "+11", "+10",
       ...
       "DC 20, 1d10",
       "Sever the tongue to escape, but the thing itself cannot be killed from here: leave, seal the place, and do not dig."),
    lore=[
      "What lashes up out of the ground to seize a man and draw him down into a throat no one can see is not the monster. It is the monster's <em>tongue</em>: a single reaching part of something vast and buried and patient, so large that the tongue is all of it the world will ever see, the rest of it sleeping down in the deep dark beneath, listening through the part it sends up to taste the surface. You are not fighting the Devourer. You are fighting one small reaching piece of it, and the piece is enough.",
      "You can sever the tongue. That buys escape, that ends the immediate danger, but the tongue grows back, and the thing it belongs to cannot be killed from up here, not with anything men own, because most of it is somewhere you cannot reach and do not want to. The only wisdom is to take the warning the tongue gives, leave the place, seal it behind you, and never, ever dig down toward the rest of it."],
    found="Above the buried body of something vast and old: a particular patch of ground, a cave, a sinkhole, a dig that went too deep. The tongue lashes up from there; the rest of it is below, and best left there.",
    keeper="The Devourer's Tongue is built on implied scale. The party fights an appendage and is meant to understand, with dread, that it's only a piece of something far larger and still sleeping below. The tongue can be severed (which buys escape) but regrows, and the thing itself can't be killed from the surface, so the only victory is restraint: take the warning, leave, seal the place, don't dig toward the rest. The heroic act here is knowing that some things are too big to fight, and that the smart move is to wall them off and walk away. Run the dread of the reaching tongue and the slowly dawning horror of how large the thing it belongs to must be: the ground that shifts, the sense of something vast listening from below. Resist any urge to let the party 'win' by digging down to the source; the source is unkillable and the descent is suicide. Use it to teach the chapter's hardest lesson (that wisdom sometimes means leaving the monster alive and sealed rather than dying to prove you could face it) and to seed a vast, sleeping threat the campaign need never fully reveal. The best Devourer is the one the party walks away from, looking back over their shoulders.")}

  {creature(
    sb("The Cold Deep's Child", "Tier III &middot; spawn of what sleeps below the water", 16, 42, "swim fast; crawls", "+11", "+9", "+9",
       ...
       "DC 16, 1d6",
       "Salt and fire end the child; but kill it away from deep water, lest its keening bring the rest, or the parent."),
    lore=[
      "Beneath the deep water (the great lake, the drowned valley, the cold sea-mouth where the river meets something older) something vast and drowned lies sleeping, and it has children. The men who fish that water call it a god. The Cold Deep's Child is one of the lesser spawn: barbed and pale and wrong, swimming fast and crawling onto land to hunt, dangerous enough alone. But it keens. And the keening calls its kin up out of the water, more and more of them, until a single child becomes a drowning tide of them, and if the keening goes on long enough, it may call something far worse than kin.",
    ...
    found="The shores of deep water that hides something vast and sleeping: a great lake, a drowned valley, a cold inlet. The children come ashore to hunt; the parent stays below, and must stay below.",
    keeper="The Cold Deep's Child is a swarm-caller with a sleeping piece of the Old Dark behind it, and the tactical heart is the keening: kill it near deep water and it summons its kin (and risks waking the parent), so the party must learn to draw it away from the water before finishing it. Where you kill it matters as much as that you kill it. Individually they're manageable (salt and fire), but the calling can escalate a single encounter into a drowning tide, and the implied parent below gives the whole thing a Lovecraftian floor of dread. Run the escalation as a threat the party can prevent by thinking: lure it inland, isolate it, end it where the deep can't hear. Let a party that fights one carelessly at the water's edge face the consequence of the keening bringing more. The sleeping parent should stay a dread implication, never fully seen: the reason you don't want the keening to go on. It pairs with the Devourer's Tongue as the chapter's 'this is only a piece of something vast' threats, this one in water. Use it for coastal or deep-lake horror, and to teach that against the deep dark, <em>where</em> and <em>how</em> you fight can be the difference between a skirmish and an awakening.")}
  ...
  {creature(
    sb("The Long Trail's End", "Tier IV &middot; the collector of the living", 20, 68, "always one day ahead", "+15", "+13", "+15",
       ...
       "DC 20, 1d10",
       "Honor the debt that bound it (bury its own forgotten dead, or send on the soul it could not) and it returns to its proper road."),
    lore=[
      "It was meant to be a kindness once: a guide for the dead, a shepherd to walk the newly-passed gently down the long trail to wherever the dead are meant to go. But a bargain was broken, a debt left unpaid, a soul it was supposed to carry was somehow lost, and the Long Trail's End went wrong. Now it gathers the <em>living</em> before their time, one soul to a town, laying a cold hand on the shoulder of the next to be taken and walking always one day ahead on the road, patient and certain, collecting what was never owed.",
      "It cannot be fought to a standstill; it ignores armor, it's always just ahead, it does not tire or relent. But it can be set right, because underneath the wrongness it is still, in its ruined way, dutiful. Honor the debt that bound it (bury its own forgotten dead, find and send on the lost soul it could not carry, pay the price the broken bargain left unpaid) and the collector of the living remembers its proper office, lets the living go, and returns at last to the road of the dead where it belongs."],
    ...
    keeper="The Long Trail's End is a psychopomp gone wrong, a death-guide that's started taking the living, and it's beaten by setting right the old wrong that broke it. It can't be fought to a stop (always ahead, ignores armor, relentless), so the encounter is a pursuit-and-investigation: trail it through the towns it's harvesting, work out the broken bargain or unpaid debt that twisted it (its own forgotten dead left unburied, a soul it failed to carry), and honor that debt to restore it to its proper road. The structure is a mystery with a ticking cost: one soul per town, marked by the cold hand, until the party uncovers and pays what's owed. Run the dread of the inexorable collector, the cold hand on the shoulder marking the next to die, the sense of a thing that won't stop until it's set right. It pairs with the Mourner and the Faceless Rider as the book's death-heralds, but this one does the taking itself. Use it for a somber, investigative scenario about an old kindness corrupted, where the party saves lives by healing the wound that made death's shepherd cruel, and lets it go home.")}
  ...
  {creature(
    sb("The Eye Between Stars", "Tier V &middot; the apex; the thing that watches back", "&mdash;", 120, "it does not move; it regards", "+19", "+19", "+23",
       "to be seen by it is the harm: merely beheld, hold against the DC-25 truth or be unmade in mind",
       ...
       "Close the sky (end the rite, the alignment, the open door that let its gaze fall here) and pray it forgets the small bright thing it saw.",
       mark="To seek its gaze, or speak to it, is +2 Mark and the beginning of the end of you."),
    lore=[
      "It is the oldest thing this book knows, older than the country, older than the dark, and it does only one thing: it looks. Somewhere in the night sky it opens (a regard, an attention, an eye between the stars) and it notices you, and the noticing is what harms you. To be seen by the Eye Between Stars is to be held against a truth too vast for the mind to survive, to feel a gaze fall on you from a distance and an age that makes all the living world a small bright mote, and to come apart inside under the weight of being <em>regarded</em> by it.",
      "Nothing the living own can touch it. It is too far, too vast, too old, and it does not move and does not reach; it only watches, and being watched is enough. The only thing to be done is to close the sky: end the rite, break the alignment, shut the door that drew its gaze down to this small world in the first place, and then to pray, with everything left in you, that the eye between the stars forgets the small bright thing it briefly saw, before it decides to look a little closer."],
    found="It opens in the night sky over wherever a rite, alignment, or open door has drawn its attention. It is everywhere and nowhere: a gaze from beyond the stars, falling on one small place that did something to be noticed.",
    keeper="The Eye Between Stars is the apex of the entire bestiary: the thing that can't be fought, reached, or harmed in any way, that does nothing but <em>look</em>, and whose look is annihilating. There's no combat here in any normal sense: being under its regard inflicts an Affliction each scene, and the party's only goal is to close the sky (end the rite, break the alignment, shut the door that drew its gaze) and then hope it forgets them. This is cosmic horror in its purest, most absolute form: the party are motes, the Eye is incomprehensibly vast and old and indifferent, and survival means going unnoticed. Run it as a desperate race to shut the door under a sky that's looking back, with the dread mounting each scene the gaze remains. The Mark warning is the book's most dire: to seek its gaze or speak to it is +2 Mark and 'the beginning of the end of you.' Save it for a campaign's ultimate crisis, the thing behind the things, the final door that must be closed. There's no killing it. There's only closing the sky and praying. Use it to end a campaign on the genre's truest note: humanity's whole brave struggle reduced to hoping that something vast looks away in time, and that it forgets the small bright thing it saw.")}
</section>
</section>
"""
...
<section class="page" id="index">
  ...
  <div class="divider"></div>
  {quote("I've arranged them by danger, as a man arranges his debts, smallest first, so as to keep his nerve.", "from the field-books of N. Ashby")}
  ...
  <table class="lvl">
    ...
    <tbody>
      ...
      <tr><td><strong>V</strong> <span class="sub">(~10th lvl &amp; beyond)</span></td><td>The Star-Spawn, The Wound in the World, The Unmade, The Eye Between Stars, and the Servant of the Deep Dark, at its worst</td></tr>
    </tbody>
  </table>
  <div class="divider"></div>
...
<section class="page" id="apex">
  ...
  {quote("I've met one. I won't be meeting another, and I would take it kindly if you didn't ask me which.",
  ...
  <p>Run one of these across a season. Don't run two. A table that meets two apex things learns that the world is
  full of them, and the world is not, and that's most of why the first one worked.</p>
  ...
  {creature(
    sb("The Parcel", "Tier VI &middot; a boundary being assembled", "&mdash;", 160, "fixed; it is the ground", "+23", "+14", "+23",
       ...
       "DC 28, 1d10, and only once a bound closes",
    ...
    keeper="This is the book&rsquo;s argument that paperwork is worse than teeth, and it runs at the speed of a land dispute. There's no monster and there shouldn't be one for a long while: the players find a deed, then a second, then a clerk who has processed eleven of these and is uneasy about it. The pressure is that every closing makes the next easier and the players can watch the map fill. Give them the win in a courthouse or a records fire and let them feel how strange a victory that is. If they insist on violence, the men holding the deeds are ordinary men with lawyers, and killing them passes the parcels to heirs who know nothing and will sell to the next offer, which is worse. Pair it with the Ledger if you want the table to understand that the money and the land are one problem.")}
  ...
  {creature(
    sb("The Ninth Child", "Tier VI &middot; the due, come to collect itself", 26, 150, "walks, and is never hurried", "+23", "+14", "+23",
       ...
       "DC 28, 1d10",
       "Pay the debt with something else the family is owed, or prove the ledger wrong. A Dread Mother&rsquo;s house keeps immaculate records and will honour a correction. Killing it costs the family three generations of protection and brings a second one by spring."),
    lore=[
      "A house of the Dread Mother keeps a woman alive through a bad birth, and her daughter through a worse one, and her granddaughter through the fever that took eleven others in the same county. Three generations. Then something knocks, and it is polite, and it has the dates. It wants the ninth child of the line and it has waited eighty years to want it.",
    ...
    keeper="Play it as the most reasonable thing your players have ever met, because that's what makes it horrible. It's right about the debt. It's kind to children. It will take an honest counter-offer and won't take a lie. The scene to aim for is the family arguing in the next room while it waits on the porch with its hat off, and the temptation to end this with a gun should be enormous and should be wrong. If they take the shot they've ruined the family they meant to save, the second one comes in spring, and by then they know it. Use this once. It doesn't survive repetition and it's the most upsetting page in the book.")}
  ...
  {creature(
    ...
    lore=[
      "A revival comes through and it is a good one. The drunks dry out. The fighting stops. Six months later the town is quieter than before the tent came (not worse, quieter) and the preacher is four counties away doing it again. The Red Sermon has learned to run a circuit, and a circuit is harder to kill than a church.",
    ...
    keeper="The Circuit is a faction that happens to be a monster, and it should be fought the way you fight a faction: for people, in public, slowly. Never let the players find a lair. What they find is a good man in a pulpit doing measurable good, and the arithmetic behind him, and the problem of proving arithmetic to a congregation. Give them one preacher who's decent all the way through and truly doesn't know, because the session where they have to decide what to do about him is the session this creature exists for.")}
  ...
  {creature(
    sb("The Gentleman on the Road", "Tier VII &middot; met, and never resolved", 29, 220, "as he pleases; he is never seen to arrive", "+27", "+27", "+27",
       ...
       "DC 30, 1d10, and only for those who work the Old Dark and know what they are looking at",
  ...
  {creature(
    ...
    found="In the land office on Delaware Street, held by a clerk who has never been west of Dodge and would be sick to hear what happened at Coffin Wells.",
    keeper="The clerk is the encounter. He isn't culpable and he isn't innocent, he can't be shot to any purpose, and if the players reach Kansas City and find him he's the most disquieting thing they've met: a polite, tired man who approved the note that funded the Vane Interest and eleven others this year and has no idea. Run the Ledger as a clock rather than an enemy, and give the players exactly one lever that works: a county that comes to hold its own paper. Make them earn it in meeting halls. A table that wins this one has done something no amount of shooting could have.")}
  ...
  {creature(
    sb("The Dread Mother", "Tier VIII &middot; a purpose, rather than an appetite", 32, "&mdash;", "she does not travel; her houses do", "+31", "+20", "+31",
       ...
       "<strong>She is no face of the Old Dark.</strong> Her people are adamant on the point, and correct: nothing is granted in her name, no Bargain is struck with her, and no Sign has ever answered a rite that called on her. What she has is authority, and authority is far harder to sit across a table from than an appetite.",
       "DC 30, 1d10 + Affliction",
       "Nothing ends her. What can be ended is a house, one at a time, by giving the county something that does what the house did: a doctor, a midwife, a fund, a road to the next town. Take the house without replacing it and the county buries the difference within two winters, and the next house is welcomed."),
    lore=[
      "From the bayou parishes to the Sierra there are covens that share no rite, no vocabulary and no enemy, and that all acknowledge the same woman. Among themselves they call the arrangement the Long Table, and nobody outside has ever had a straighter answer than that. A coven that has been recognised has been seated; one that has offended has been asked to stand, and what follows that is not discussed. The federation is loose, and meant to be: a coven keeps its own practice and answers to nobody about it, and what it owes the Table is a hearing when word comes, a tithe twice a year, and a truthful answer if it is asked a question. No two accounts agree on how many seats there are, though the number nine turns up in more of them than chance would allow. She governs, so far as anybody outside can establish, from old New Orleans, below Canal Street. Every account agrees on the city and no account comes from anyone who was received.",
    ...
    keeper="Never give the players a raid to conduct, and keep her at the far end of a long hallway: a Keeper who puts her on stage has spent her, and what's left is an old woman in a chair in a wet city. The Dread Mother is the hardest thing in this book to run and the most rewarding, because there's no monster and the harm is real and so is the good. Give them a woman who's alive because of one of these houses, and a debt coming due on her granddaughter, and let them work out what an answer even looks like. If a fight happens it should be against a frightened midwife holding a lamp, and the players should feel bad about it for a long time. The victory available here is building something: the win condition is a county that no longer needs her, and that's a season of work and the best ending this book has.")}

  {creature(
    sb("What the Old Dark Is Afraid Of", "Tier VIII &middot; unnamed, and left that way", 32, "&mdash;", "unknown", "+31", "+31", "+31",
       "unknown, and no account of it agrees with any other",
       "<strong>Read this before you use it.</strong> This entry is empty in the middle, and meant to be. Whether it exists at all depends on which of the four readings of the Rockies gatherings you chose in Keeper&rsquo;s Book Ch. VII. Under three of them there is nothing here, and the fear is all there is.",
       "DC 30, 1d10 + Affliction",
       "There is no answer printed here, because printing one would settle a question this game keeps open. Whatever ends it, your table finds it, and you will know it when they say it out loud."),
    lore=[
      "Beginning about four years ago, congregations that have never had a use for one another started going up into the Rockies. A Devourer congregation out of Montana wintered above the Boulder River in weather that should have killed half of it. A Red Sermon circuit leaves Denver every spring and comes home forty people short. Cold Deep men, who never gather for anything, camped nine weeks at a dry lake in the Sawatch. Nobody has caught one of these congregations speaking to another. There are four separate written accounts of a meeting nobody can place, and no two agree on who called it.",
      "One reading of that evidence is that something older has frightened the Old Dark, and that it is pulling its faithful in around it the way a hurt animal goes to ground. This entry is that reading, and it's written thin for a reason. Three other readings fit every fact just as well: the Old Dark sent for them, each by the face it knows; nobody called anything, and the pattern is in whoever draws the map; or the dark lies nearer the surface up there, and the faithful go to it the way stock goes to water."],
    found="In the gap between what your players have proved and what they have concluded.",
    keeper="Don't answer this early and don't answer it twice. A table will carry an unanswered question for years and will do most of your work for you while it carries it, and the moment you confirm a reading three quarters of the Rockies goes quiet. If you use this entry at all, use it in the last session of a campaign or the one before, and never in a way that requires a speech. The best version of this creature is the one your players assembled themselves out of four sessions of evidence, and your job is to be a little less certain than they are.")}
...
<section class="page" id="grounds">
  ...
  above the party, it arrives as sign and spoor, not in the flesh (the tracks, the kill, the survivor's account) and becomes a thread instead of a funeral.</p>
  ...
  on a tree at a height that ends the conversation. <strong>Sign</strong> is everything wider than that: a kill,
  a silence where there were birds an hour ago, stock that won't go back in the barn. A Keeper who says "you find
  sign of it" and stops has given the players a mood. Give them the reading instead: it's a whole scene, it costs
  Nerve, and it's how a campaign gets its shape.</p>
  ...
  <table>
    ...
    <tr><td>V</td><td>Survival DC 20</td><td>DC 20</td>
        <td>A place unmade: ground, weather, and the people in it, all wrong together</td></tr>
  </table>
  ...
  <ul>
    <li><strong>Critical success.</strong> What it is, how many, how long ago, which way it went, and whether it
  ...
  the same horror fills a segment: a second kill, a name in a rumor, a night the dogs won't go out. A full clock
  ...
  dangerous on its own, so that the first time something is truly wrong, they have nowhere to file it.</p>
  <table>
    <tbody>
      <tr><td>1</td><td>The Rustlers (I)</td><td>11</td><td>The Hornet Swarm (I), and the horses</td></tr>
      <tr><td>2</td><td>The Drunk with a Gun (I)</td><td>12</td><td>The Peccary Band (I)</td></tr>
      <tr><td>3</td><td>The Bad Water (I)</td><td>13</td><td>The Elk Bull (II): in the rut</td></tr>
      ...
      <tr><td>9</td><td>The Turkey Buzzard (I): go and look</td><td>19</td><td>The River Crossing (III)</td></tr>
      <tr><td>10</td><td>The Skunk (I)</td><td>20</td><td>The Stock-Killer Wolf (III): a whole season's work</td></tr>
    </tbody>
  </table>
  ...
  <table>
    <tbody>
      <tr><td>1</td><td>The Devil's Coyote (I)</td><td>11</td><td>The Mourner (II): an omen</td></tr>
      <tr><td>2</td><td>Road Agents (I&ndash;II)</td><td>12</td><td>The Skinned Stallion (II)</td></tr>
      <tr><td>3</td><td>The Hexed Beast (I&ndash;II)</td><td>13</td><td>The Black Dog (II): an omen, and it comes back</td></tr>
      <tr><td>4</td><td>The Bitten (I), and he knows it</td><td>14</td><td>The Field-Hand (II)</td></tr>
      ...
      <tr><td>7</td><td>The Ghost Cat (II)</td><td>17</td><td>The Fiddler at the Dance (III): a barn, a Saturday</td></tr>
      <tr><td>8</td><td>The Restless Herd (II)</td><td>18</td><td>The Midnight Line (III): the old grade</td></tr>
      <tr><td>9</td><td>The Glutton (II)</td><td>19</td><td>The Stitched Man (III)</td></tr>
      <tr><td>10</td><td>The Dust Devil (II)</td><td>20</td><td>The Faceless Rider (IV): ruin follows</td></tr>
    </tbody>
  </table>
  ...
  <table>
    <tbody>
      ...
      <tr><td>4</td><td>The Plat-Eye (II): the levee road</td><td>10</td><td>The Flood-Serpent (IV)</td></tr>
  ...
  <table>
    <tbody>
      ...
      <tr><td>2</td><td>The Chupacabra (I)</td><td>12</td><td>The Coffin-Rider (II): the freight shed</td></tr>
      <tr><td>3</td><td>The Bonepicker (I)</td><td>13</td><td>The Tintype (II): on the mantel</td></tr>
      <tr><td>4</td><td>The Blood-Thin (I): in the cellar</td><td>14</td><td>The Mirror-Dweller (III)</td></tr>
      ...
      <tr><td>8</td><td>The Weeping Walls (II)</td><td>18</td><td>The Wake (III): the house is lit</td></tr>
      <tr><td>9</td><td>The Possessed (II)</td><td>19</td><td>The House That Hungers (IV)</td></tr>
      <tr><td>10</td><td>The Answering Voice (II)</td><td>20</td><td>The Old Blood (IV): it holds the paper</td></tr>
    </tbody>
  </table>
  ...
  a manhunt, and in Kansas City it is a filing. Roll here for the terminus (the yards, the quarter, the works
  below) and see the Keeper's Book, Ch. XIV, for running a night there without losing the tone.</p>
  <table>
    <tbody>
      <tr><td>1</td><td>The Saloon Brawl (I), and a stove</td><td>7</td><td>The Possessed (II): with standing</td></tr>
      <tr><td>2</td><td>The Bonepicker (I)</td><td>8</td><td>The Mesmerist (III): a subscription hall</td></tr>
      <tr><td>3</td><td>The Hired Gun (II): an agency now</td><td>9</td><td>The Skin-Walker (III): a new face each month</td></tr>
      <tr><td>4</td><td>The Resurrectionist (II): with a price list</td><td>10</td><td>The Nightwalker (III)</td></tr>
      <tr><td>5</td><td>The Lynch Mob (II): a whole ward of it</td><td>11</td><td>The Tallyman (III): he holds the paper</td></tr>
      <tr><td>6</td><td>Dark Cultist &amp; the Hollow Prophet (II): chartered</td><td>12</td><td>The Thing in the Well (III): the waterworks</td></tr>
    </tbody>
  </table>
  ...
  <table>
    <tbody>
      ...
      <tr><td>2</td><td>The Gallows-Hung (II)</td><td>8</td><td>The Wasting Kin (II): the family plot</td></tr>
  ...
  <table>
    <tbody>
      ...
      <tr><td>2</td><td>The Tommyknocker (I): mind your manners</td><td>7</td><td>The Brood (III)</td></tr>
  ...
  arrive as evidence and dread long before it arrives in person: run it off <em>Sign &amp; Spoor</em>, above,
  ...
  <table>
    <tbody>
      <tr><td>1</td><td>The Hexer (II): hired, and in over his head</td><td>7</td><td>The Hanging Judge (III): the law itself, dead and wrong</td></tr>
      <tr><td>2</td><td>The Resurrectionist (II): a trade in the dead</td><td>8</td><td>The Bruja (III): the night roads are hers</td></tr>
      <tr><td>3</td><td>The Witch (II&ndash;III), an old slight, patiently repaid</td><td>9</td><td>The Deathless Gun (III): a bargain still being spent</td></tr>
      <tr><td>4</td><td>Dark Cultist &amp; the Hollow Prophet (II&ndash;III)</td><td>10</td><td>The Tallyman (III): a debt come due</td></tr>
      <tr><td>5</td><td>The Day-Man (II): he keeps the books</td><td>11</td><td>The Crossroads Man (IV): somebody dealt, and lost</td></tr>
      <tr><td>6</td><td>The Mesmerist (III): other people's hands</td><td>12</td><td>The Old Blood (IV): every note in the county</td></tr>
    </tbody>
  </table>
  <h2 id="grounds-basin">Perdition Basin, by Ground</h2>
  <p>The Keeper's Book gives you one county whole (Ch. XIII), and every place in it rolls on a table in this appendix.
  When the posse rides somewhere in the basin you didn't prepare, find the place, roll its table, and hang whatever turns
  up on the nearest well. The third column is what the county adds on top of the roll.</p>
  <table>
    <thead><tr><th>Where</th><th>Roll on</th><th>What the county adds</th></tr></thead>
    <tbody>
      <tr><td>Calvary Crossing</td><td>The Ordinary Country, most nights</td><td>The Hired Gun (II) on the survey's
      payroll, and the Cattle Baron's Men once the Vane Interest stops being polite</td></tr>
      <tr><td>Coffin Wells</td><td>Graveyards &amp; Battlefields</td><td>The Risen (I), and the Nightwalker under the
      mission ground (Keeper's Book Ch. IX)</td></tr>
      <tr><td>Saltlick Station and the Stage Road</td><td>The Trail &amp; the Open Range</td><td>The Skin-Walker (III)
      at the relay (Ch. X), and Road Agents on the lonely miles</td></tr>
      <tr><td>Mission San Clavo</td><td>The Old Places</td><td>The Thing in the Well (III) under any failing nail, and a
      Servant of the Deep Dark at the master nail if it goes</td></tr>
      <tr><td>the Homesteads</td><td>Towns, Homesteads &amp; Haunted Houses</td><td>The Plague-Dead (II) where the
      fever runs, and the Glutton on a family's stores</td></tr>
      <tr><td>the Calvary River</td><td>Rivers, Lakes &amp; Swamps</td><td>The Drowned (II) at the fords in a flood
      year</td></tr>
      <tr><td>the Badlands</td><td>Desert &amp; the Badlands</td><td>The Thirst (II) past the last water, and whatever
      came up the South well (roll the Old Dark, Ch. VII)</td></tr>
      <tr><td>the Painted Mesa</td><td>no table</td><td>People live there. Nothing in this book comes from it.</td></tr>
    </tbody>
  </table>
</section>
"""
...
<section class="page" id="build">
  ...
  <ul>
    <li><strong>1. The wrong at its root.</strong> Every horror here was made by something: a murder, a bargain,
    ...
    <li><strong>4. One Special.</strong> A single signature trick that makes it more than its row: the thing the
    ...
    pattern of its kills all point to it), it should ask more than damage (a place, a truth, a rite, a mercy) and the gun alone should never be the whole answer above Tier I.</li>
  </ul>
  ...
  hundred and ten. From <strong>Tier IV</strong> up, a creature isn't an encounter with a bigger number on it. It's a
  ...
  <p id="ix-tier-top"><strong>And the Blood column stops at VII.</strong> That isn't an omission. A Tier VIII
  thing has no Blood total because no table has ever emptied one and the number would only be a promise the
  arithmetic can't keep. Give it whatever total the scene needs it to survive, or none at all. What a Tier VIII
  creature has instead of hit points is a condition under which it stops, and that condition is printed under its
  <em>Putting It Down</em>, and it's the entire encounter. Everything at VI and VII is the same problem in a
  ...
  <ul>
    ...
    power: a bargain, a rite, a heeding. Never for a bad roll, never for merely being wounded.</li>
    ...
    for the same sight, so escalate: a new behavior, a new ground, a new face. Or reskin (Chapter I) and let
    them start over.</li>
    <li><strong>When the dead work the uncanny.</strong> A cultist, a hexer gone bad, or a thing that curses and
    conjures forces saves at a <strong>Sign or Miracle DC of 10 + half its level + its keyed ability</strong>: 
    read its level as twice its Tier, so a Tier III worker forces about DC 16, a Tier V about DC 18. Give it two or
    three workings and no more; a foe is its Special, and has no use for a caster's whole list.</li>
  </ul>
  ...
  Done, and if the table loves it, this book has a blank page at the back that isn't blank by accident.</div>
</section>
"""
...
LIVING_CREATURES = [
    # ---- Tier I ----
    ("The Coyote", "Tier I &middot; the thief at the edge of the firelight", 14, 10, "very fast", "+5", "+8", "+2",
     "bite +5 (1d6+1)",
     ...
     N, "It's a coyote. A shot, a shout, or a fire turns it; only hunger or madness makes one truly press a man."),
    ("The Rattlesnake", "Tier I &middot; the coil in the dust", 13, 8, "slow; strikes a blur", "+5", "+7", "+0",
     ...
     N, "Watch the ground and the warm rocks. A hoe, a heel, or a load of shot, and carry a remedy for the bitten."),
    ("The Badger", "Tier I &middot; a low temper in a hole", 14, 12, "slow; burrows", "+7", "+4", "+1",
     "claws &amp; bite +5 (1d6+2)",
     "<strong>Won't quit.</strong> Cornered or dug at, it fights with a fury far past its size and doesn't flee, yield, or learn fear.",
     N, "Leave it be and it leaves you. If it must die it will make you spend for it: many guns, or none."),
    ("The Bobcat", "Tier I &middot; the small cat that waits above", 15, 9, "fast; leaps; climbs", "+5", "+8", "+2",
     "claws +5 (1d6+1, rake)",
     "<strong>Ambush.</strong> Drops from a ledge or a limb onto the straggler; the first strike from hiding lands with a vengeance, and then it's simply gone.",
     N, "It rarely presses a fight it can't win; one hard answer and it quits the field."),
    ("The Stray Pack", "Tier I &middot; dogs gone back to the wild", 13, 12, "fast", "+6", "+6", "+2",
     "bite +4 (1d6+1, drag down)",
     "<strong>Pack.</strong> Surrounds a lone traveler and pulls him down by weight and number; bolder than wolves, for they've lost their fear of men.",
     N, "Drop the boldest and the rest remember they're only dogs; fire and a raised voice scatter them."),
    # ---- Tier II ----
    ...
    ("The Wild Boar", "Tier II &middot; the razorback out of the bottoms", 16, 26, "fast", "+9", "+5", "+2",
     "tusks +6 (1d8+3, gore)",
     "<strong>Charge.</strong> Comes head-down and doesn't feel the first wound; a hide like a plank turns light shot, and a temper that turns toward the gun, not from it.",
     N, "A tree, a high seat, or a heavy ball square in the shoulder. Don't let it close, and don't wound it by halves."),
    ("The Black Bear", "Tier II &middot; the raider of the camp", 15, 24, "fast; climbs", "+8", "+5", "+3",
     "claws +6 (1d8+3)",
     "<strong>Mostly wants your supper.</strong> Bluster and noise usually turn it, unless it's cornered, starving, or a sow with you between her and the cubs, and then it's all teeth.",
    ...
    ("The Range Bull", "Tier II &middot; a ton of bad temper", 14, 28, "fast in a charge", "+9", "+4", "+2",
     "horns +6 (1d8+4, toss)",
     "<strong>Charge and trample.</strong> A longhorn that has decided he hates you; gores, tosses, and comes around for another pass while you're still in the dirt.",
     N, "The fence, the gate, a fast horse, or a red rag thrown wide, or drop him where he stands, which is a great deal of dropping."),
    # ---- Tier III ----
    ("The Grizzly Bear", "Tier III &middot; the lord of the high country", 17, 44, "fast (briefly, faster than a horse)", "+11", "+5", "+4",
     ...
     "<strong>Takes the lead and keeps coming.</strong> Shrugs off the first solid wound, runs down a fleeing man over short ground, and doesn't stop for pain.",
     N, "It takes more lead than seems possible. Aim true behind the shoulder. A tree is no help; a grizzly will simply wait you out."),
    ("The Bison Bull", "Tier III &middot; a hill of muscle and horn", 16, 48, "very fast in a straight line", "+13", "+4", "+4",
     ...
     N, "A big-bore rifle behind the shoulder, or simply not be where it is going. Turning it is easier than killing it."),
    ("The Bull Gator", "Tier III &middot; the log that wasn't a log", 18, 42, "slow on land; fast in water", "+11", "+6", "+4",
     ...
     N, "Stay back from the cut bank and the still water. The eye and the soft of the throat, and never wade where one might wait."),
    ("The Wolf Pack", "Tier III &middot; the winter pack, of one mind", 16, 40, "very fast", "+10", "+9", "+4",
     ...
     N, "You can't kill a pack a wolf at a time. Fire, high ground, and breaking their nerve. Take the leader and the rest may scatter."),
    ("The Bull Moose", "Tier III &middot; a thousand pounds in a foul mood", 16, 46, "fast", "+12", "+5", "+3",
     ...
     N, "Give it the road and the right of way. It tires of you sooner than you tire of it, if you live the first charge."),
    # ---- Tier IV ----
    ...
    ("The Stampede", "Tier IV &middot; the herd, run as a wall", 18, 70, "very fast", "+15", "+6", "+6",
     ...
     "<strong>A flood with hooves.</strong> A moving wall of the herd that can't be reasoned with or fought, only outrun, turned, or survived; it fills the draw and takes all within it.",
     N, "You don't kill a stampede. Ride out of the lane, gain high ground, or turn the lead with fire, and pray the ground isn't a box canyon."),
    ("The Man-Eater", "Tier IV &middot; the cat that learned to hunt men", 20, 64, "very fast; leaps", "+13", "+13", "+7",
     ...
     N, "It must be hunted as it hunts: with bait, patience, and an iron nerve. Stand watch in pairs, and never sleep where it can come from above."),
    ("The Old Tusker", "Tier IV &middot; the boar that breaks the dogs", 19, 74, "fast", "+15", "+7", "+6",
     ...
     N, "Men hunt it for years and bury friends doing it. A tree, a wall, and a heavy enough ball, and never on foot in the open."),
    ("The Pale Stallion", "Tier IV &middot; the wild horse no man rides", 20, 66, "very fast", "+13", "+13", "+8",
     ...
     N, "It can't be broken, only outlasted or shot, and many a wrangler has died learning which. Cut it from the band first, if you can."),
    # ---- Tier V ----
    ("The Mountain That Walks", "Tier V &middot; the primeval bear of the old tales", 23, 112, "fast", "+19", "+11", "+11",
     ...
     N, "A thing out of the grandfather-tales. It will take everything you brought and everything you are, and may yet walk away."),
    ("The White Bison", "Tier V &middot; the great pale buffalo, omen and terror", 22, 108, "very fast", "+19", "+11", "+12",
     "horns &amp; trample +17 (3d8+8)",
     "<strong>Sacred and cursed both.</strong> Huge beyond reason; the people count it holy and the hunters count it doom, and the herd follows where it leads: a thousand head at its back.",
     N, "Many will tell you it must not be killed at all. If you must, it's a mountain of muscle and wrath, and the herd behind it is the rest of your trouble."),
    ("The Great Serpent", "Tier V &middot; the snake grown long as a wagon-train", 21, 100, "fast; burrows", "+18", "+13", "+9",
     ...
     N, "Keep to high rock and open ground where you can see it come. The head must be taken, and getting close enough is the dangerous part."),
    ("The Carcajou", "Tier V &middot; the devil-bear of the north woods", 22, 104, "fast; climbs; tireless", "+18", "+12", "+10",
     ...
     N, "It doesn't stop and it doesn't tire. You can't outlast it; you must end it all at once, or keep moving until one of you is dead."),
    ("The Old Man of the Swamp", "Tier V &middot; the gator that owns the bayou", 23, 110, "slow on land; fast in black water", "+19", "+10", "+10",
     ...
     N, "The black water is its kingdom and your grave. Draw it onto dry land or never face it at all; in the water you'll simply be gone."),
    ...
    ("The Mad Dog", "Tier I &middot; the hydrophobia, walking", 13, 10, "fast; crooked and tireless", "+6", "+5", "&mdash;",
     ...
     "<strong>The bite that kills late.</strong> Runs a straight line at whatever moves, jaws working on nothing, and can't be called off, bought off, or frightened. A man it opens walks away fine, and stays fine for a month, and then the water starts to frighten him.",
    ...
    ("The Skunk", "Tier I &middot; a small argument you've already lost", 14, 5, "slow", "+4", "+6", "+1",
    ...
    ("The Peccary Band", "Tier I &middot; javelinas out of the thicket", 14, 16, "fast", "+6", "+6", "+1",
     ...
     "<strong>Poor eyes, bad tempers, and a dozen of them.</strong> A band feeds shoulder to shoulder in heavy brush and can't tell a man from a bear at ten feet; startled, it scatters straight through whatever is standing there, cutting as it goes.",
     N, "Get behind something or get above something. They mean to be elsewhere; the wounds are what they leave on the way."),
    ("The Gila Monster", "Tier I &middot; the beaded lizard that won't let go", 15, 8, "very slow", "+6", "+2", "+2",
     ...
     N, "Prying the jaws takes a knife blade and patience. It never chased anybody in its life. Watch where you reach in rock country."),
    ("The Hornet Swarm", "Tier I &middot; the ground nest you just stepped on", 16, 9, "fast; flies", "+3", "+9", "&mdash;",
     ...
     "<strong>The horses go first.</strong> A nest in a stump or a bank empties in a heartbeat, and a stung horse doesn't care what the rider wants; more men are hurt by the bolting than by the stinging.",
    ...
    ("The Prairie Dog Town", "Tier I &middot; a half-mile of broken legs", "&mdash;", "&mdash;", "still; and it waits", "&mdash;", "&mdash;", "&mdash;",
     ...
     N, "You don't put down a prairie-dog town. Walk the horses through it, or ride around and lose the hour."),
    ...
    ("The Elk Bull", "Tier II &middot; seven hundred pounds in the rut", 15, 24, "fast", "+9", "+6", "+3",
     ...
     N, "Give him the meadow. He's defending a harem you can't see, and he will quit the moment you're plainly gone from it."),
    ...
    ("The Rutting Buck", "Tier II &middot; the deer that buries more men than the bear", 16, 18, "very fast", "+7", "+9", "+2",
     ...
     "<strong>The animal nobody respects.</strong> Two hundred pounds of muscle behind a rack of points, in the season when it has stopped being careful; men who would never walk up on a bear walk up on a downed buck every autumn, and some of them don't walk back.",
    ...
    ("The Sow and Cubs", "Tier II &middot; the one bear with no quit in it", 16, 26, "fast; climbs", "+9", "+6", "+4",
     ...
     "<strong>No bluff in her at all.</strong> An ordinary black bear will bluster and leave; a sow who believes you're between her and the cubs commits at once, presses past wounds that would turn any other bear, and follows you as far as it takes.",
     N, "Back out the way you came the second you hear a cub. Don't run, don't climb, and never put yourself uphill of the noise."),
    ...
    ("The Boar Sounder", "Tier III &middot; the whole family, in heavy brush", 17, 42, "fast", "+11", "+6", "+3",
     ...
     "<strong>Twenty of them, and they know the thicket.</strong> Sows, shoats, and a pair of old boars moving as one through cover a man can't see ten feet into; they cut, wheel, and come back, and there's no high ground in a bottom.",
    ...
    ("The Longhorn Herd", "Tier III &middot; three thousand head, and one bad noise", 16, 46, "fast, and all together", "+12", "+5", "+2",
     ...
     "<strong>Not yet a stampede, and one lightning-crack from it.</strong> A trail herd bedded down is a hill of nerves; it mills, drifts, and swallows a man on foot without ever meaning to, and everything the outfit does at night is done to keep it from becoming the other thing.",
     N, "Ride the circle and sing to them, which is what the singing was always for, and on most outfits the hand who taught the rest of them how is the segundo. Once it breaks, see The Stampede, and pray for room."),
    ("The Stock-Killer Wolf", "Tier III &middot; the wolf with a name and a price on it", 18, 36, "very fast; tireless", "+10", "+11", "+6",
     ...
     "<strong>Has beaten every man sent for it.</strong> One old wolf, usually running alone or with a single mate, that kills far past hunger: a dozen head in a night, left where they dropped. It springs traps with a stick, refuses poisoned bait, and knows the range better than the ranch does.",
     N, "It can't be trapped by anyone it has already outsmarted, which by now is everyone. Take the mate first; grief makes it careless, and that's the only opening it has ever given."),
]
...
<section class="page" id="living">
  ...
  <div class="divider"></div>
  {quote("Folk ask me which of the territory's animals are the dangerous ones. I tell them: the hungry ones, and the ones you've cornered. That's the list.", "from the field-books of N. Ashby")}
  <p class="dropcap lead">Not everything that kills a man on the frontier came back from a grave or down from the stars. The country is full of plain animals that will end you for plain reasons (hunger, fear, a calf to guard, a trail you had no business riding) and between them they bury more men than all the horrors in this book combined.</p>
  <p class="note"> <strong>Signs of the kind:</strong> tracks in the mud and scat on the trail, a kill cached under brush, the birds gone quiet at the treeline, stock that won't settle: the plain sign any frontiersman learns to read, or dies not reading.</p>
  <div class="keeper-note"><span class="kn-tag">No Nerve, no Mark</span>These beasts cost the party <em>no Nerve</em>. There's no Dread Check against an honest animal, and their <strong>Dread</strong> line is marked &ldquo;&mdash;&rdquo; to say so. Nor do they ever move the Mark. Run them straight off the numbers. Their place in this book is to make the country real, to bloody a party grown careless, and to set the moment a thing that looks like an ordinary wolf turns its head, and its eyes are wrong.</div>
  {blocks}
</section>
'''
...
LIVING_LORE = {
  ...
  "The Badger": (
    "A low temper in a hole, and pound for pound about the meanest thing the honest country has to offer. The badger asks only to be left alone in its diggings, and grants the same courtesy in return, but corner it, dig at it, press it where it can't flee, and it fights with a berserk fury far past its size, all claw and muscle and a refusal to quit that no wound seems to teach. It doesn't flee, doesn't yield, and doesn't learn fear.",
    "The open grasslands and dry country where it digs, riddling a hillside or a pasture with burrows. Encountered when something disturbs its den: a horse's leg in a hole, a dog gone to ground after it, a careless boot."),
  "The Bobcat": (
    "The small cat that waits above, patient and silent and gone before you've finished flinching. A bobcat hunts the straggler and the small; it drops from a ledge or a low limb onto whatever passes beneath, and its first strike from hiding lands with a startling vengeance for so modest a creature. But it has a cat's clear sense of a losing fight, and one hard answer usually convinces it the meal isn't worth the trouble.",
  ...
  "The Gray Wolf": (
    "The hunter of the long winter, and a creature of pure, patient calculation. A lone wolf weighs the odds coldly and slips away from a fair fight nearly every time; it's the pack in a hard winter, hungry and coordinated, that buries men. They harry, they hamstring, they wait, testing a quarry's strength and nerve before they ever commit, and they commit only when the arithmetic favors them.",
  ...
  "The Black Bear": (
    "The raider of the camp, and mostly a thief rather than a killer, which is no comfort if you're between it and what it wants. A black bear usually wants your supper, not your life, and bluster and noise will turn most of them. But corner one, starve one, or step between a sow and her cubs, and the genial robber becomes all teeth and terrible speed, and there's no quit in a frightened or furious bear.",
    "Timber and brush country near food: berry patches, salmon runs, and especially the careless camp or the unsecured larder. Bold around settlements that have taught it men mean easy meals."),
  "The Range Bull": (
    "A ton of bad temper on four legs, and a reminder that not every deadly animal is a predator. A longhorn that has decided he hates you'll gore, toss, and come around for another pass while you're still picking yourself out of the dirt, and there's a great deal of him to stop. He's slow to anger and unstoppable once roused, and a fence is worth more than a gun.",
  ...
  "The Grizzly Bear": (
    "The lord of the high country, and the animal that has ended more confident hunters than any other on this list. A grizzly takes the lead and keeps coming; it shrugs off the first solid wound, runs down a fleeing man over short ground faster than a horse, and doesn't stop for pain. It takes more lead than seems possible, and a tree is no help, for a grizzly will simply wait you out.",
  ...
  "The Bison Bull": (
    "A hill of muscle and horn, and unstoppable in a straight line. A ton and a half at a dead run neither swerves nor tires before you do; you don't fight a bison bull in a temper or a stampede; you get out of its way. Turning one is easier than killing it, and not being in its path is easier than either.",
  ...
  "The Bull Gator": (
    "The log that wasn't a log, and the undisputed master of its own black water. A bull gator explodes from the shallows, clamps on, and rolls to drown and dismember. On its own water, nothing the frontier owns can hold it. On land it is slow and beatable; in the water it is simply death with teeth, and the cut bank and the still pool are its kingdom.",
  ...
  "The Wolf Pack": (
    "The winter pack run as one mind: not several wolves but a single will with many mouths, a swarm of fang and patience. It surrounds, drags down, and thins as it bleeds rather than dropping man by man; you can't kill a pack a wolf at a time. Fire, high ground, and breaking their nerve are the only answers, and taking the leader may scatter the rest, or may not, in a hard enough winter.",
  ...
  "The Bull Moose": (
    ...
    "The northern timber, the willow bottoms, and the marshy lakeshores. Most dangerous in the autumn rut and when a cow defends her calf; a moose on the trail is a thing to wait out."),
  "The Great Bear": (
    "The man-killer of legend, a grizzly grown old and cunning and cruel on the failures of every hunter sent against it. It wears the scars of a dozen guns that didn't stop it, and a wound only makes it worse; it has killed enough men to have learned them, to be careful and patient and savage all at once. Men have spent their whole lives, and their lives, hunting one.",
    "The deep wild high country, far from any help, where a legendary bear has reigned long enough to earn a name and a body count. It knows men and their tricks, and it doesn't make the mistakes a younger bear would."),
  "The Stampede": (
    "The herd run as a moving wall, a thing that can't be reasoned with or fought, only outrun, turned, or survived. A stampede fills the draw and takes everything in the lane, a thousand head of blind panic and pounding hooves, and the only counsel is to ride out of its path, gain high ground, or turn the lead with fire and pray the ground ahead isn't a box canyon.",
  ...
  "The Pale Stallion": (
    "The wild horse no man rides, and kills to keep it so. A great wild stallion leads its band and suffers no rider and no rival; it strikes with hooves and teeth, runs men down, and is as cunning as any outlaw and twice as proud. It can't be broken, only outlasted or shot, and many a wrangler has died learning which.",
  ...
  "The Mountain That Walks": (
    "The primeval bear of the old tales, the high-country legend made flesh, bigger than a bear has any right to be, and older. It takes wounds the way a hillside takes rain and has outlived every hunter ever sent for it; a thing out of the grandfather-stories that will take everything you brought and everything you are, and may yet walk away unbothered.",
    "The deepest, highest, least-traveled country, where a thing can grow vast and ancient with no man left alive who's seen it twice. A legend with a territory; you don't find it so much as trespass on it."),
  "The White Bison": (
    "The great pale buffalo, omen and terror both, sacred to some and doom to others. Huge beyond reason, it leads a herd a thousand head strong wherever it goes; the people count it holy and the hunters count it cursed, and many will tell you it must not be killed at all. If you must, it's a mountain of muscle and wrath, and the herd at its back is the rest of your trouble.",
    "The great plains where the herds run, moving at the head of its following. As much a sign as a creature; where the white bison walks, men's beliefs and fears walk with it, and that's half its danger."),
  "The Great Serpent": (
    "The snake grown long as a wagon-train and thick as a barrel, a thing that strikes from the dust with the reach of a tall man and more. Its venom answers to no remedy the frontier carries, and getting close enough to take its head (which is the only way to end it) is where all the danger lies. Keep to high rock and open ground where you can see it come.",
  ...
  "The Carcajou": (
    "The devil-bear of the north woods, the wolverine of legend grown vast and tireless and full of grudge. It drives bears off their kills, fears nothing that lives, and pursues a wrong for days without rest or quit. It doesn't stop and it doesn't tire; you can't outlast it, and must end it all at once or keep moving until one of you is dead.",
    "The deep northern timber and the high cold country, ranging a vast territory with relentless appetite. It follows a trail or a grudge tirelessly; once it has fixed on a party or a trapline, it doesn't simply wander off."),
  "The Old Man of the Swamp": (
    "The gator that owns the bayou, older than the parish and longer than a flatboat, patient as the tide. It takes a man or a mount under without a ripple, and the black water is all its own; draw it onto dry land or never face it at all, for in the water you'll simply be gone. The swamp is its kingdom and your grave.",
    "The deepest, oldest black water of the great swamps and bayous, where a gator has reigned long enough to grow legendary. It knows every channel and cut bank of its domain; on its own water, it's undefeated and undefeatable."),
  # ---- the second rank: the small country, and what it actually does to people ----
  "The Mad Dog": (
    "The hydrophobia, walking, and the only honest animal in this chapter that kills a man weeks after it has finished with him. A dog with the madness in it runs a crooked line at whatever moves, jaws working on nothing, and it can't be whistled back, bought off, or scared away by any noise a man can make. The bite itself is a small thing: a torn sleeve, a bad afternoon, a wound that scabs over clean. Then the month turns, and the bitten man finds he can't drink, and every soul who has seen it before knows exactly how the rest of it goes.",
    "Anywhere dogs run loose and something wild has bitten one: ranch yards, mining camps, the edges of town in high summer. Coyotes, foxes, and skunks carry it too, and a fox that walks up to a man in daylight is telling him something."),
  "The Skunk": (
    "A small argument you've already lost. The skunk is a decent, unhurried animal that wants beetles and eggs and no conversation, and it announces itself twice before it does anything: a stiff-legged charge that stops short, then a stamp of the front feet, then the tail comes up. Men who ignore all three deserve the education. The range is longer than anyone expects, the aim is better, and a man who takes it square is unwelcome in any bunkhouse in the county for a fortnight.",
    "Everywhere there is garbage, grubs, or a hen house: camp middens, barns, hollow logs, and under the porch. Works the dusk and the dark, and is met most often by whoever went out to see what the dogs were carrying on about."),
  "The Peccary Band": (
    "Javelinas out of the thicket, and one of the few animals on the range that hurts people mostly by accident. A band feeds shoulder to shoulder in brush a man can't see into, with weak eyes, a strong nose, and a standing assumption that anything close is trouble. Startled, they don't scatter away; they scatter through, twelve or fifteen of them at a dead run in whatever direction they were already pointed, and the tusks are self-sharpening and take a horse's leg open to the bone.",
    "The thorn brush, the mesquite flats, and the dry washes of the hot country, usually near prickly pear. Met at close range by definition; you're in the band before you know the band is there."),
  "The Gila Monster": (
    "The beaded lizard that won't let go. It's a slow, heavy, black-and-orange thing that spends most of its life underground and has never in recorded history chased anybody, which means every bite it has ever given was to a hand that went somewhere careless. Once it has that hand it doesn't strike and release like a snake; it locks its jaws and works, chewing the venom in along grooved teeth while a man tries to get a knife blade between them.",
    "Rock crevices, pack-rat nests, and the shade under ledges in the desert country. Out and moving after the spring rains and on warm evenings; encountered by reaching where you didn't look."),
  "The Hornet Swarm": (
    "The ground nest you just stepped on, and the reason the trail boss rides slow through a stump field. A nest in a bank or a rotten log empties in a heartbeat and comes out angry at everything within a rod, and the stings themselves are the least of it. A horse taking a dozen of them doesn't consult its rider about what happens next, and most of the graves this chapter fills were dug for men who came off in rough country at a full gallop.",
  ...
  "The Prairie Dog Town": (
    "A half-mile of broken legs, and the only entry in this chapter that isn't an animal at all. The dogs themselves are harmless, sociable, and rather good company from a distance; what they build is thousands of burrows worked into the best grass on the flat, mouths hidden in the sod, invisible from the saddle at anything above a walk. Cavalry has lost horses here. Cattle outfits budget for it. A rider who takes a town at a gallop learns the arithmetic of a horse's cannon bone against a six-inch hole.",
    "The short-grass plains, always on good ground, which is precisely where a herd is being pushed and a rider is in a hurry. A town may cover a section or a county, and the far edge is never where you thought it was."),
  "The Turkey Buzzard": (
    "The bird that finds the dead first, and the most useful animal in this book to a party that pays attention. It has no fight in it and no interest in the living, and cornered it will do nothing worse than throw up on your boots. Its value is that it's always right. A wheel of them turning slow and low over a ridge two miles off is the plainest message the frontier ever sends, and every experienced hand reads it the same way: something out there is finished, and it's worth going to look at, or worth riding wide around.",
    "Aloft over everything, all day, in any open country. On the ground at a carcass, at a battlefield, at a horse that went down in the night, and at whatever the party hasn't found yet."),
  "The Porcupine": (
    "Slow trouble in the low branches, and the finest teacher of dogs the country has. It has no speed, no cunning, and no interest in anybody; it turns its back, raises the quills, and lets the world make its own mistake. The quills are barbed and work deeper with every hour, and an animal that takes a face full of them won't eat, can't be handled, and needs pliers, daylight, and two men sitting on it. A dog learns this once. A young dog sometimes learns it twice.",
  ...
  "The Elk Bull": (
    "Seven hundred pounds in the rut, and out of his right mind from September to the snow. Through the season he doesn't eat, doesn't sleep, and bugles all night for the pleasure of picking a fight; he's defending a harem of cows a man on the trail can't even see, and he takes any moving thing in that meadow as a rival who has come to take them. He has fought a wagon. He has fought a locomotive. He will certainly fight a horse, and the rack he carries is five feet across and comes at the chest.",
    "High meadows and timber edges through the autumn rut, and the winter range in the hard months. Heard long before he's seen; that whistling scream across a park at dusk is an address, directed at you."),
  "The Wolverine": (
    "The small devil of the deep snow, and forty pounds that has never once counted the odds. It will drive a bear off a kill by sheer sustained outrage, tear the roof off a trapper's cache and foul what it can't carry, and follow a trapline for a season out of what looks a great deal like spite. Threatened, it comes straight at the threat, snarling, and it doesn't have the sense or the inclination to break off. Everything about it is out of proportion except its size.",
  ...
  "The Water Moccasin": (
    "The snake that comes toward you. No other snake on the continent does that. A cottonmouth threatened holds its ground and gapes (that white throat is where the name comes from) and there are enough sober accounts of one swimming a deliberate line at a wading man that the country has stopped arguing about it. The venom is the ugly kind: it kills the flesh around the bite, and a hand that takes a bad one in swamp country a hundred miles from a doctor is often not a hand much longer.",
    "Still and slow water in the hot country: sloughs, backwaters, rice ditches, cypress swamps. On the bank, on the log, and in the water with you; met while wading, and while sitting down where a log looked convenient."),
  "The Golden Eagle": (
    ...
    "Open country with cliffs or high timber to nest in: canyon rims, buttes, and mountain fronts. Over lambing grounds in the spring, and there lies the trouble."),
  "The Feral Horse Band": (
    "The mustangs, and the stallion who runs them, and the reason a careful outfit hobbles everything and stands a watch besides. A band stallion is a working thief with two hundred years of practice: he cuts saddle stock out of a picket line in the dark, drives it off among his mares, and is four miles gone before the camp is properly awake. Argue with him over it and you aren't fighting one horse but standing in the middle of forty head turning at once, which the ground doesn't survive and neither does a man on it.",
  ...
  "The Rutting Buck": (
    "The deer that buries more men than the bear, for the plain reason that nobody is afraid of a deer. Two hundred pounds of muscle behind eight points of hard antler, in the one season of the year when it has stopped being careful about anything, will drive a man into the dirt and stand over him working. Worse is the buck that has been shot and gone down and been walked up on by a hunter who thought that settled it: every autumn produces a handful of those, and the coroner writes them up the same way every time.",
    "Brush, timber edges, and field margins through the autumn rut; anywhere a buck has cows and an opinion. Most dangerously, at the end of a blood trail, where something is lying still and isn't finished."),
  "The Sow and Cubs": (
    "The one bear with no quit in her. An ordinary black bear is a burglar and a bluffer: noise turns most of them and a thrown rock turns the rest. A sow who has decided that a man is between her and her cubs skips all of that. She commits on the first stride, presses through wounds that would send any other bear up a hill, and keeps coming as long as she believes the cubs are wrong-side of you. The cubs are the whole story, and they're usually the thing you didn't see.",
    "Timber, brush, and berry country in spring and early summer, when the cubs are small and the sow is thin and short-tempered. Met on a blind trail, at close range, and announced by a sound up in a tree that you'll wish you had understood sooner."),
  "The Boar Sounder": (
    "The whole family, in heavy brush: a very different animal from the lone razorback. A sounder runs to twenty head (sows, shoats, and a pair of old boars on the edges) through cover a man can't see ten feet into, and it moves like one thing. They cut across, wheel in the thicket, and come back through from a direction nobody was watching, and they do this in country where a rifle is worth less than a good knife and a stout tree.",
    "Bottomland thickets, cane brakes, and swamp margins, rooting at dawn and dusk. Found by the dogs. That's how most of these fights start, and how a good many dogs finish."),
  "The Snake Den": (
    "The winter den, opened, and the single worst place a man can put his foot in a cold spring. Rattlers pass the winter in company: scores of them, sometimes hundreds, coiled together deep in the same rock fault year after year for longer than the county has had a name. Break into that in March, when they're stiff with cold and slow and thoroughly disinclined to move, and the floor of the place is alive and the walls are too, and every step out is another chance.",
  ...
  "The Wild Cattle of the Brasada": (
    "Cattle that went wild and got clever. The ladinos of the thorn brush are longhorns bred out of a hundred years of strays, and the brush has made them nocturnal, solitary, and hostile in a way ordinary range stock never is. Six feet of horn tip to tip, a bull will lie up in a thicket all day and charge anything that comes in after him, and he has a settled hatred of horses and the men on top of them. The brush poppers who rope them out of the brasada for money are mostly vaqueros, working in leather from throat to boot, and they count broken bones as part of the wage.",
    "The thorn brush of the south country: mesquite, prickly pear, and catclaw so thick a rider works it in leather from throat to boot. Moving to water at night, lying up in the thickets by day."),
  "The Longhorn Herd": (
    "Three thousand head, bedded down, and one bad noise from being something else entirely. The outfit holding it is eleven or twelve hands, and on the great drives three of those are Black or Mexican as a matter of plain arithmetic: the night guard that keeps this from becoming a disaster is worked in shifts by whoever can sing and stay awake. A trail herd at rest is a hill of nerves that mills and drifts and swallows a man on foot without ever intending him any harm, and every single thing an outfit does at night (the night guard, the slow circle, the singing that the singing was always actually for) is done to keep it from turning into the entry four pages back.",
  ...
  "The Stock-Killer Wolf": (
    "The wolf with a name and a price on it, and the only honest animal in this book that a party can spend a whole campaign failing to kill. One old wolf, running alone or with a single mate, that kills far past any hunger: a dozen head in a night, throats opened and the carcasses left where they dropped. It springs traps with a stick and eats around the pan. It refuses poisoned bait it has never encountered before. It knows the range better than the ranch does, and it has already beaten every man the ranch has sent. Ranchers name these. That's how you know.",
    "One range, one river drainage, one outfit's grass: a stock-killer works a territory and stays in it for years. Found by its work at dawn: the dead cattle, and the one set of tracks that walks straight past the trap line."),
}
...
HARD_CREATURES = [
    # ---------------------------------------------------------------- Tier I
    ("The Drunk with a Gun", "Tier I &middot; a man who's going to regret this", 12, 11, "unsteady", "+4", "+1", "&mdash;",
     ...
     "A man who's going to regret this, assuming he lives to. Whiskey on the frontier is served by the water glass, and a payday, a grievance, and a Colt make a combination the country produces reliably every Saturday night. He isn't a gunman. He couldn't hit the far wall if he tried. That's the problem: he's waving a loaded revolver in a crowded room, his finger is inside the guard, and the man he actually wants is standing behind you.",
    ...
    ("The Rustlers", "Tier I &middot; men who do their work at night", 13, 13, "mounted", "+5", "+5", "+2",
     ...
     "<strong>Would much rather ride off.</strong> Three or four men altering brands by lantern light; they came for cattle, they'll run at the first real resistance, and they'll kill without hesitation if running stops being an option.",
     "&mdash;", "They break the moment the odds turn. Follow them and you're in their country; corner them and you've made this a killing that neither side wanted.",
     "Men who do their work at night, and the commonest crime in the cattle country by a distance. Rustling is a business: a running iron, a wet blanket, a hot fire, and a brand redrawn into a different brand by men who know exactly which alterations the county won't look at twice. They're cowhands, mostly, often the same men who worked the outfit last season, and they aren't killers by trade or by preference. But a man caught at it hangs, and every one of them knows it, which makes a cornered rustler a far worse proposition than a bold one.",
     ...
     "The rustler is the Keeper's best early antagonist because he's negotiable. He can be bought, warned off, deputized, or turned into an informant, and every one of those choices makes the country more complicated. Hang one, and the party has taught the range something about themselves."),
    ("The Claim-Jumpers", "Tier I &middot; men with your paper in their pocket", 13, 12, "afoot", "+5", "+4", "+3",
     ...
     "Men with your paper in their pocket, which is a worse thing to face than men with guns. A claim is a piece of ground and a piece of writing, and the writing is where the theft is done: a filing altered, a witness bought, an assessment work requirement missed and then noticed by the right man. By the time anyone rides out to argue, there are four men on the ground who need only sit there, do very little, and be extremely lawful about it until the paper catches up. And the law is a great deal easier to bend against some claimants than others: a Chinese company that worked a bar for six years and paid the foreign miners' tax on every ounce of it, or a New Mexican family whose grant is older than the territory, can find the whole apparatus of the recorder's office arranged against them without anybody raising his voice.",
     "Placer diggings, lode claims, homestead sections, and water rights, anywhere the ground has value and the record of who owns it lives sixty miles away in a wooden building.",
     "This is a fight the party mostly can't shoot its way out of, which is why it belongs early. Let them discover that the recorder is the real antagonist, and that riding to town is more use than riding to the claim. If the wronged claimant is one the county is already inclined to rule against, don't make that the lesson of the scene: make it the reason the paper matters, and let the claimant be the one who knows exactly which filing to pull and which date will hang them."),
    ("The Saloon Brawl", "Tier I &middot; thirty men and no plan at all", 12, 20, "the whole room", "+5", "+3", "&mdash;",
     ...
     "Thirty men and no plan at all. It starts between two of them over a card, a woman, a slur, or a debt, and stays a fistfight for about four seconds. Then somebody swings at somebody who wasn't involved, and the room discovers it has opinions. Tables go over, the lamps come down, and the stove (there is always a stove) goes over with a load of coals into a floor that has been soaked in whiskey since 1868.",
    ...
    ("The Tinhorn", "Tier I &middot; the cheat, and the friends he keeps", 13, 11, "seated, mostly", "+3", "+6", "+5",
     "derringer +4 (1d6+2, at the table, from a sleeve), and two men at the bar",
     ...
     "The cheat, and the friends he keeps, which are always the actual difficulty. A tinhorn doesn't beat a table with cards; he beats it with preparation: a deck stacked before he sat down, a shiner set in a ring or a cigar case, and a partner across the room who signals every hand the party holds. He's unfailingly pleasant, he loses just often enough, and he has bought drinks for four men who will swear he has been square all evening.",
     "Faro layouts, poker tables, and any game running in a boom camp with money moving through it. Thickest where the money is newest: end of a drive, a strike, a payroll.",
     "The interesting scene is the accusation. Make the table roll to spot the cheat, then make them decide what to do in a room that likes him. If they simply shoot him, the two friends at the bar are a Tier I fight, and the town has watched the party kill an unarmed man over cards."),
    # ---------------------------------------------------------------- Tier II
    ("The Hired Gun", "Tier II &middot; a man paid to be wherever you are", 16, 22, "unhurried", "+7", "+9", "+6",
     ...
     "<strong>Does this for wages.</strong> Practiced, unbothered, and entirely without grudge; he will give warning once because a warning is cheaper than a fight, and he won't give it twice.",
     "&mdash;", "Find out who's paying and pay them more, or make the job cost more than the fee. He has no personal stake and is the last man on this list who wants to die over one.",
     "A man paid to be wherever you are. He isn't an outlaw and he's careful about the distinction: he works for a cattle association, a mine, a railroad, or one large landowner, and there's usually a badge somewhere in the arrangement to keep the whole thing tidy. He practices, which almost nobody does. He's polite to women, good with horses, and will drink with the party the night before. The work is the work, and he has no more feeling about it than a farrier has about a shoe.",
     "Where big money has a small problem: a range in dispute, a strike being broken, a witness who hasn't yet testified. He arrives on the stage, takes a room, and is seen at breakfast.",
     "He's the frontier's cleanest lesson that money is the monster. Give him manners and a name and let the party like him. If they kill him, the association simply sends the next one, and that one has read the first one's notes."),
    ("The Lynch Mob", "Tier II &middot; the town, with a rope", 14, 30, "one mass, moving", "+8", "+3", "&mdash;",
     ...
     "The town, with a rope. Every man in it is somebody the party has already met (the liveryman, the storekeeper, two hands off the Bar T, the fellow who fixed their wagon) and not one of them would do this by himself, or is entirely sure how he came to be doing it now. It has no leader, exactly. It has three or four loud men near the front and a great many quiet ones behind who are waiting to see. That back half is the party's whole opportunity.",
     "Outside a jail, at the livery, on the courthouse steps, wherever a prisoner is being held and the crime was against someone the town loved. Forms in the evening; hardest to break after full dark.",
     "This is a talking encounter with a clock on it, and the clock is the only thing that makes it dangerous. Track it as a countdown the party can push back with each successful appeal. Let them win it, once, in front of everybody, and let the loud men at the front remember them for it. Know before you start whether the man in that cell is guilty, because the crowd doesn't know and won't ask; and know that in this country a mob assembles a great deal faster when the accused is Black, Mexican, or Chinese, which is a fact the party's Keeper should use to raise the stakes and never to stage a spectacle. The prisoner gets a name, a trade, a family in the crowd, and something to say."),
    ("The Deserters", "Tier II &middot; soldiers who quit the army and kept the guns", 15, 24, "mounted; disciplined", "+8", "+6", "+3",
     ...
     "<strong>Trained, and out of anything to lose.</strong> They move like a squad because they were one; they post pickets, they use the ground, and they can't surrender to anybody, ever.",
    ...
    ("The Comancheros", "Tier II &middot; traders in what shouldn't be traded", 15, 23, "mounted; wagons", "+7", "+7", "+5",
     "trade guns +6 (1d8+3), and whatever they sold last month, pointed back at you",
     "<strong>Everyone's friend and nobody's.</strong> They carry powder, lead, whiskey, and rifles out to the plains and bring back cattle, horses, and now and then people; they're neutral in every war they supply.",
     ...
     "Traders in what shouldn't be traded. Comancheros are New Mexican: families out of the Pecos and the Canadian who have worked the old routes onto the llano for four generations, speak Comanche and Kiowa as well as they speak Spanish, and are trusted on that plain in a way no Anglo trader has ever managed. They go out with mule trains of powder, lead, whiskey, iron, and repeating rifles, and they come back with cattle that had brands, horses that had riders, and sometimes with captives to be ransomed to whoever wants them most. They're scrupulously neutral. They'll guide the party, feed them, sell them exactly what they need, and sell the same to whoever the party is riding against, and see nothing at all inconsistent in it.",
     ...
     "Make them useful before making them a problem. A Comanchero the party has bought from twice is a far better complication than one they simply fight, and the ransom conversation (where the captive is real, and the price is real) is the best scene the entry has in it."),
    ("The Horse Thieves", "Tier II &middot; men who leave you afoot", 15, 20, "very fast; mounted", "+7", "+9", "+3",
     ...
     "&mdash;", "Getting the horses back matters more than getting the men. Hobble, sidehobble, and stand a watch, and know that the country hangs these faster than it hangs killers.",
     ...
     "Don't stage this as a fight. Stage it as a morning: the party wakes, and the horses are gone, and everything they intended to do that week is now a different problem. What they do next (track, buy, steal in turn, or walk) will tell you more about them than a battle would."),
    # ---------------------------------------------------------------- Tier III
    ("The Outlaw Gang", "Tier III &middot; road agents with a leader and a name", 17, 40, "mounted; well armed", "+10", "+9", "+7",
     ...
     "Road agents with a leader and a name: the whole difference between this entry and the one in Chapter IV. A gang is a business with a payroll and a plan: the ground is scouted a week ahead, the telegraph operator has been paid, there are fresh horses cached at twelve miles and again at thirty, and there's a valley somewhere full of people who will swear the whole gang was at a dance. They're locally popular. That isn't sentiment; they spend their money in that valley, and the bank they robbed foreclosed on it.",
     "The stage road, the bank town, the payroll car, and the county that shelters them afterward. Found in the papers long before they're found on the ground.",
    ...
    ("The Bounty Killer", "Tier III &middot; a patient man with your description", 18, 36, "unhurried; never far", "+9", "+11", "+8",
     ...
     "&mdash;", "He can be paid, but only by someone who can outbid the paper, and he doesn't take a job he can't finish. Break the warrant and you've broken him.",
     "A patient man with your description folded in a coat pocket, and the only entry in this chapter that hunts the party rather than being found by them. He doesn't brawl, doesn't drink much, and has no interest whatever in a fair fight; he takes a season if a season is what it takes, and he's content to ride the same stage as his man for two days without saying anything at all. The paper says dead or alive, and he has worked out that alive is a great deal more trouble to feed.",
     "Wherever the party has been and has been noticed: a stage station, a hotel register, a livery book, a telegraph office. He's usually behind them by four days, and once by about forty feet.",
    ...
    ("The Cattle Baron's Men", "Tier III &middot; the range war, in shirtsleeves", 17, 42, "mounted; many", "+10", "+8", "+6",
     ...
     "<strong>Backed by everything.</strong> Twenty riders, the association's money, the sheriff's tolerance, and a stack of eviction paper, and the standing instruction to make the small outfits sell.",
     "&mdash;", "You can't shoot an association. Newspapers, a territorial governor, and one honest judge have ended more of these than all the gunfights combined.",
     "The range war, in shirtsleeves. A big outfit decides the small ones are rustling (sometimes they are) and hires twenty men to go and settle it, and the county's law is either on the payroll or wisely absent. What follows isn't a battle. It's fence cutting, a dead dog on a porch, a barn burning at three in the morning, a homesteader's name on a list nailed up outside a store, and then one killing done in daylight to make the point that daylight is available.",
     "The open range wherever wire, sheep, or homesteaders have arrived, which by now is everywhere. Announced by a list, a notice, or a rider who says something polite on the way past.",
    ...
    ("The Regulators", "Tier IV &middot; a private army, with the law's blessing", 19, 66, "mounted column; supplied", "+14", "+9", "+8",
     ...
     "A private army with the law's blessing, and the point at which a range war stops pretending. Fifty hired men come in by train with horses, supply wagons, a surgeon, and a list of seventy names, and a list like that is never sorted by evidence. The small outfits on it are the ones with the least standing to object: homesteaders, Mexican families holding grant land the association would like reassigned, anyone the county courthouse has learned it can rule against without consequence. They carry warrants signed by a judge who has since gone east on business. They're competent, they're supplied, and they intend to work down the list in order. What actually stops them is never a gun; it's the county, three hundred neighbors, and a telegraph key.",
     ...
     "Don't run this as a fight the party can win. Run it as a siege and a scramble: get the names warned, get to the telegraph, hold a ranch house for two days until help comes. The ending is meant to be unjust (everyone is arrested, the case is moved, nobody hangs) and that injustice is worth more to a campaign than a victory. In Perdition Basin the Vane Interest sends for them in the second year, when pulling nails stops being something it can do without a fight (Keeper's Book Ch. XIII)."),
    # ---------------------------------------------------------------- hard country
    ("The Bad Water", "Tier I &middot; the alkali seep and the poisoned well", "&mdash;", "&mdash;", "still; and it waits", "&mdash;", "&mdash;", "&mdash;",
     ...
     "<strong>Looks exactly like water.</strong> Alkali flats, gypsum seeps, a spring gone foul, a well with something dead in it; it's wet, it's the only wet thing for a day's ride, and a thirsty outfit will argue itself into drinking it.",
     ...
     "The alkali seep and the poisoned well, and the reason experienced hands drink coffee. It looks like water. It is, in every way that matters to a man who has been dry since dawn, water. The white rim around a playa, the milky green of a gypsum spring, the well at an abandoned place with something at the bottom of it. Each of these will empty a man out for a week, and each of them has killed whole strings of horses that had less say in the matter than their riders did.",
    ...
    ("The Norther", "Tier II &middot; sixty degrees, in an afternoon", "&mdash;", "&mdash;", "faster than a horse", "&mdash;", "&mdash;", "&mdash;",
     ...
     "&mdash;", "Shelter, on the south side of anything, before it arrives. Once it's on you the only question is whether you're moving toward a wall or away from one.",
     "Sixty degrees in an afternoon. A blue norther announces itself as a hard dark line low across the northern sky in the middle of a warm day, and there's perhaps an hour between seeing it and being in it. Then the wind comes around, the rain turns to sleet and the sleet to ice, and the whole country is suddenly thirty below what it was at dinner. Cattle drift ahead of it for a hundred miles and pile against the first fence they meet, and men who were in shirtsleeves at noon are in serious difficulty by dark.",
     ...
     "Give the party the warning and let them decide whether to believe it. The drama is in the hour before the storm; whoever says we can make the next place is the one the table will remember."),
    ("The Prairie Fire", "Tier II &middot; the country, burning toward you", "&mdash;", "&mdash;", "faster than a horse, downwind", "&mdash;", "&mdash;", "&mdash;",
     ...
     "&mdash;", "Burn your own ground and stand on it, get to a river, or ride crosswind, never straight ahead of it. A wet blanket and a plowed furrow have saved more outfits than courage has.",
     "The country, burning toward you. Dry grass and a wind will carry a fire front faster than a horse can go over ground it can't see, and the smoke arrives well ahead of the flame to take the horses' nerve and the riders' bearings at the same time. It's started by lightning, by a campfire, by a locomotive's stack, and now and then by somebody who wanted a neighbor gone. What it leaves is forty miles of black ground, dead stock, and an outfit with nothing to feed anything on.",
     ...
     "The correct answer, set a backfire and stand in the burn, is a thing a frontier character would know and a player might not. Let a hand suggest it. Riding crosswind is the other answer; riding away is the one that kills them."),
    ("The River Crossing", "Tier III &middot; brown water, and a herd that won't swim", "&mdash;", "&mdash;", "moving; and it doesn't stop", "&mdash;", "&mdash;", "&mdash;",
     ...
     "Brown water and a herd that won't swim, which together have killed more trail hands than every outlaw in this book. A river in flood reads flat and slow from the bank and is neither. There's quicksand on the inside bar, a cut bank on the far side that a swimming horse can't climb, driftwood coming down that nobody sees until it arrives, and a bottom that changed last week. And there's the herd: a thousand head that will string across beautifully until the lead animal loses its nerve, turns, and starts the whole mass revolving in deep water with men in it.",
     "Every crossing of every drive, and worst in the spring rise: the Red, the Brazos, the Canadian, the Platte. Each has a reputation, and each earned it.",
     "Don't roll once. Roll for the scout, the point, the swing, and the drag, and let the party choose the order they go in. Drown a horse before you drown a person, and if somebody must go, make it the young hand everybody at the table liked."),
    ("The Flash Flood", "Tier III &middot; the dry wash, suddenly full", "&mdash;", "&mdash;", "very fast; arrives before the rain does", "&mdash;", "&mdash;", "&mdash;",
     ...
     "<strong>From a storm you can't see.</strong> Comes down a bone-dry arroyo under a clear sky, carrying trees and boulders, out of rain that fell twenty miles upcountry an hour ago.",
     "&mdash;", "Get up the bank: any bank, immediately, before deciding whether it's necessary. There's no swimming this. An hour later it is dry again, and that's what fools the next party through.",
    ...
    ("The Blizzard", "Tier IV &middot; three days of white", "&mdash;", "&mdash;", "settled in; it has nowhere to be", "&mdash;", "&mdash;", "&mdash;",
     ...
     "<strong>Takes the country away.</strong> Wind, and snow moving sideways, and no horizon and no direction. Men have died forty feet from a lit house because the world stopped having a shape.",
...
BEST_INDEX = [
    ...
    ("The Hand Behind It (villain picker)", "grounds"), ("Perdition Basin, by ground", "grounds-basin"),
...
assert_css_vars(new_html, "bestiary.html")
