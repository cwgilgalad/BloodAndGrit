...
_meta = [
 (f"<!-- Blood & Grit — The Player's Book · Version {_PV} -->", "<!-- Blood & Grit — The Bestiary · Version 2.26 -->"),
 (f"<title>Blood &amp; Grit — The Player's Book (Revised &amp; Expanded · v{_PV})</title>", "<title>Blood &amp; Grit — The Bestiary (v2.26)</title>"),
 ...
 (f'<div class="t-tiny">Revised &amp; Expanded · Compiled in the Territories · Edition of 1885 · Version {_PV}</div>', '<div class="t-tiny">Compiled in the Territories · Edition of 1885 · Version 2.26</div>'),
 ...
 (f'<p class="note" style="text-align:center; margin:0;">Blood &amp; Grit · The Player\'s Book · Version {_PV} · First Complete Edition</p>', '<p class="note" style="text-align:center; margin:0;">Blood &amp; Grit · The Bestiary · Version 2.26 · For the Keeper Alone</p>'),
]
for a, b in _meta:
...
<section class="page" id="olddark">
  ...
  {creature(
    ...
    lore=[
      "Beneath the deep water (the great lake, the drowned valley, the cold sea-mouth where the river meets something older) something vast and divine and drowned lies sleeping, and it has children. The Cold Deep's Child is one of the lesser spawn: barbed and pale and wrong, swimming fast and crawling onto land to hunt, dangerous enough alone. But it keens. And the keening calls its kin up out of the water, more and more of them, until a single child becomes a drowning tide of them, and if the keening goes on long enough, it may call something far worse than kin.",
