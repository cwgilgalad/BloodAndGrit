...
<section class="page" id="apex">
  ...
  {creature(
    ...
    lore=[
      "From the bayou parishes to the Sierra there are covens that share no rite, no vocabulary and no enemy, and that all acknowledge the same woman. The federation is loose on purpose: a coven keeps its own practice and answers to nobody about it, and what it owes is a hearing when word comes, a tithe twice a year, and a truthful answer if it is asked a question. She governs, so far as anybody outside can establish, from old New Orleans, below Canal Street. Every account agrees on the city and no account comes from anyone who was received.",
