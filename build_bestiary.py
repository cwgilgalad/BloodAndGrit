...
_meta = [
 (f"<!-- Blood & Grit — The Player's Book · Version {_PV} -->", "<!-- Blood & Grit — The Bestiary · Version 2.22 -->"),
 (f"<title>Blood &amp; Grit — The Player's Book (Revised &amp; Expanded · v{_PV})</title>", "<title>Blood &amp; Grit — The Bestiary (v2.22)</title>"),
 ...
 (f'<p class="note" style="text-align:center; margin:0;">Blood &amp; Grit · The Player\'s Book · Version {_PV} · First Complete Edition</p>', '<p class="note" style="text-align:center; margin:0;">Blood &amp; Grit · The Bestiary · Version 2.22 · For the Keeper Alone</p>'),
]
for a, b in _meta:
...
<section class="page" id="howto">
  ...
  meet these things, which is to say, it is a road, and the road runs downhill.</div>
...
<section class="page" id="dead">
  ...
  <p class="dropcap lead">Burial is a promise the frontier does not always keep. These are the dead that came back: 
  ...
  {creature(
    ...
    keeper="The Risen are the party's first lesson, and the lesson is simple: the dead out here do not play by living rules. Run a lone one to teach that: let them shoot it, watch it keep walking, and feel the cold of it. Then, the next time, give them six, and a closing door, and a window that won't latch. The dread of the Risen is never one corpse; it is the math of <em>more</em>. Never let a fight against them feel winnable by damage alone: make the players solve the room, the exits, the salt, the fire. A party that learns to think their way out of a Risen swarm is a party ready for worse. In Perdition Basin they're the first thing a broken well sends up, and Coffin Wells is burying its dead twice this summer (Keeper's Book Ch. IX).")}
  ...
  {creature(
    ...
    keeper="Do not run this as two dozen separate enemies; that way lies a four-hour slog and a bored table. Run the Host as <em>one</em> thing with one Blood pool, one area attack, and a relentless advance: a clock, not a brawl. The real fight is the question: <em>what woke them, and how do we make it stop?</em> Seed the answer before the Host ever rises: the cracked headstone, the missing reverend, the railroad cut through hallowed ground. Let the players feel the futility of fighting the tide for a round or two, then reward the one who thinks to ask <em>why</em>. The Host is a puzzle wearing a battle's face.")}
  ...
  {creature(
    ...
    lore=[
      ...
      "On its own water the Drowned is terribly strong, and tireless, and at home. Pulled onto dry land it is a floundering, helpless ruin, which is the whole secret of fighting one, and the whole danger, because it knows this too, and will not be pulled if it can help it."],
  ...
  {creature(
    ...
    keeper="The Cold Bride is a haunting you can negotiate with, and that is what makes her interesting. Her binding to one place means a smart party can simply leave, but she usually sits between them and something they need, so leaving costs them. Her offered hand is a trap dressed as courtesy; let a player take it and feel the January cold climb their arm. The resolution is a question of justice: what was she owed? The truth named, the wedding mimed, the bones of the faithless man laid where she can see them: any of these can lay her to rest. Reward the player who treats her as a wronged woman rather than a monster. She has been waiting a very long time to be heard.")}
...
<section class="page" id="beasts">
  ...
  {creature(
    ...
    keeper="The Hexed Beast is the party's introduction to the rule that runs half this book: <em>kill the body, and the binding brings it back</em>. Let them put it down the first night and feel the satisfaction, then have it come loping out of the dark the next night, whole and patient. The lesson is to follow the thread back to the hand that sent it. Use it as a clock and a breadcrumb: every night it returns, it points the party closer to its maker. The Tier band (I&ndash;II) lets you scale it to whatever the table can handle. Drop the brand or the hair-knot somewhere they'll find it; let a tracker or a wise NPC name it as a sending. Then the real adventure begins: not the beast, but the person who wanted blood badly enough to buy it.")}
  ...
  {creature(
    ...
    keeper="The Hidebehind is a puzzle dressed as terror, and the puzzle is its whole charm. Mechanically, it always has cover and you cannot harm what you cannot face, so a party that just tries to shoot it loses, every time. The solution is to <em>take away its hiding</em>: a ring of firelight with no shadow to hold, a mirror that shows what's behind, two people standing back-to-back watching each other's blind side, an open meadow with nowhere to slip to. Make the players figure out that the fight is really about geometry and light. The dread comes from the build-up: the missing straggler, the feeling of being watched, the thing always one turn behind your eyes. When they finally corner it in the open and it stands revealed, let the reveal land: it was solvable all along, if they could just make it stop hiding. A great creature for a party that's learned to think.")}
  ...
  {creature(
    ...
    keeper="The Horned Serpent is a terrain monster and a temptation. On its own water it is overwhelming (vast, patient, constricting, able to swallow the small whole) so the fight is really about denying it the water or striking its one weakness. The horn is the elegant solution and the bait: it's the source of its strength (break it and the serpent weakens) and a coveted treasure that drew the party in. Let the legend of the horn's powers pull greedy hands toward deep water; let the cost of reaching it be steep. Stage the fight so the party must lure it to the shallows, pin it, or get someone dangerously close to strike or break the horn. A good water-monster set-piece, and a reminder that the most valuable thing in the country is usually attached to the most dangerous thing in the country.")}
  ...
  {creature(
    ...
    keeper="The Pale Crawler inverts the usual rules: it hunts by sound and is helpless against silence and light. This makes encounters with it tense and tactical in a wonderful way: the party that blunders in loud and dark feeds it; the party that learns to move slow and silent, that brings bright light to stagger it, that sets up an ambush in the quiet, wins. Run the soundscape: make the players nervous about every dropped tool and loud word, reward whispered planning and careful movement. Bright light is the great equalizer: a lantern unhooded at the right moment staggers it and turns the tables. Use it in any underground scenario to make the dark itself the enemy, and to teach the party that sometimes survival is about discipline and quiet, not firepower. A lantern, a held breath, and a steady hand beat a fast gun down there.")}
  ...
  {creature(
    ...
    keeper="The Glutton is a creature of attrition and dread-by-erosion, best run over several nights rather than one fight. It's a logistics nightmare with claws: it doesn't beat the party in a battle, it beats them by ruining their supplies, spooking their horses, and wearing them down until they're weak enough to take. Run the slow grind: each morning, something's gone or fouled; each night, it's a little bolder. The players will come to <em>hate</em> it, which is exactly right. The resolution is to stop reacting and start hunting: deny it the stores it's after, set a trap, corner it, because cornered and denied, it fights stupid and dies easy. The lesson is that some threats are about discipline and supply, not heroics, and that a small relentless enemy can be deadlier than a big one if you let it dictate the terms. In Perdition Basin it follows the drives up from the south to the cattle pens at Calvary Crossing.")}
...
<section class="page" id="spirits">
  ...
  {creature(
    ...
    keeper="The Throwing Spirit teaches the chapter's lesson with more force than the Cold Spot: it's actively dangerous, it cannot be struck, and the only way to stop it is to solve the grief. Run the chaos (objects flying, doors slamming, the genuine danger of hurled iron) and let the party's first instinct (shoot it) fail completely so the rule lands. The investigation is the real work: is it tied to the place or to a person? What's the grief, the wrong, the unspoken truth? Often the most affecting version anchors it to a living person, frequently a child or a grieving soul, whose pain is doing the throwing without their knowing, which makes 'solving' it an act of compassion, not exorcism. Pair it with a family drama, a buried secret, a person who needs to be heard. The party wins by understanding, not by force, and the best resolutions feel like healing a wound rather than killing a monster.")}
  ...
  {creature(
    ...
    keeper="This is a superb creature for a mine scenario because it is a mechanic disguised as a ghost. Run it as information: the party is underground, the knocking starts ahead of them, and they have to decide in the moment whether it is a warning or a lie. Make it a warning the first two times. Then have somebody in the party be rude (whistle, scoff, kick the offering aside) and let the third knocking come from the wrong direction. That is the whole of the entry and it will have the table policing each other's manners for the rest of the session, which is exactly the play you want. Its numbers are small on purpose: what hurts a party here is the rock, not the thing. Use it as a gate on any Chapter VII horror that lives underground, because a party in good standing with the knockers gets warned about the deep dark and a party in bad standing does not.")}
...
<section class="page" id="olddark">
  ...
  {creature(
    ...
    lore=[
      ...
      "It is slow but it is tireless, and it grows with each person it takes. The hands reach and grab and draw you in toward the heaving center, and if they pull you in, you become another part of it. But the relic at its heart is the binding that holds the whole horror together (take it, break it, burn it) and the mass comes apart at last into what it always was underneath: a great many poor dead people, finally released, finally still."],
  ...
  {creature(
    ...
    keeper="The Long Trail's End is a psychopomp gone wrong, a death-guide that's started taking the living, and it's beaten by setting right the old wrong that broke it, not by force. It can't be fought to a stop (always ahead, ignores armor, relentless), so the encounter is a pursuit-and-investigation: trail it through the towns it's harvesting, work out the broken bargain or unpaid debt that twisted it (its own forgotten dead left unburied, a soul it failed to carry), and honor that debt to restore it to its proper road. The structure is a mystery with a ticking cost: one soul per town, marked by the cold hand, until the party uncovers and pays what's owed. Run the dread of the inexorable collector, the cold hand on the shoulder marking the next to die, the sense of a thing that will not stop until it's set right. It pairs with the Mourner and the Faceless Rider as the book's death-heralds, but this one is itself the taker, not just the warning. Use it for a somber, investigative scenario about an old kindness corrupted, where the party saves lives not by fighting death's shepherd but by healing the wound that made it cruel, and lets it go home.")}
...
<section class="page" id="index">
  ...
  <div class="divider"></div>
  {quote("I have arranged them by danger, as a man arranges his debts, smallest first, so as to keep his nerve.", "from the field-books of N. Ashby")}
...
<section class="page" id="apex">
  ...
  {creature(
    ...
    keeper="The clerk is the encounter. He is not culpable and he is not innocent, he cannot be shot to any purpose, and if the players reach Kansas City and find him he is the most disquieting thing they have met: a polite, tired man who approved the note that funded the Vane Interest and eleven others this year and has no idea. Run the Ledger as a clock rather than an enemy, and give the players exactly one lever that works: a county that comes to hold its own paper. Make them earn it in meeting halls. A table that wins this one has done something no amount of shooting could have.")}
...
<section class="page" id="build">
  ...
  Done, and if the table loves it, this book has a blank page at the back that is not blank by accident.</div>
</section>
"""
...
LIVING_CREATURES = [
    ...
    ("The Black Bear", "Tier II &middot; the raider of the camp", 15, 24, "fast; climbs", "+8", "+5", "+3",
     "claws +6 (1d8+3)",
     "<strong>Mostly wants your supper.</strong> Bluster and noise usually turn it, unless it is cornered, starving, or a sow with you between her and the cubs, and then it is all teeth.",
    ...
    ("The Wolf Pack", "Tier III &middot; the winter pack, of one mind", 16, 40, "very fast", "+10", "+9", "+4",
     ...
     N, "You cannot kill a pack a wolf at a time. Fire, high ground, and breaking their nerve. Take the leader and the rest may scatter."),
    ...
    ("The Stampede", "Tier IV &middot; the herd, run as a wall", 18, 70, "very fast", "+15", "+6", "+6",
     ...
     N, "You do not kill a stampede. Ride out of the lane, gain high ground, or turn the lead with fire, and pray the ground is not a box canyon."),
    ...
    ("The Great Serpent", "Tier V &middot; the snake grown long as a wagon-train", 21, 100, "fast; burrows", "+18", "+13", "+9",
     ...
     N, "Keep to high rock and open ground where you can see it come. The head must be taken, and getting close enough is the whole of the danger."),
...
<section class="page" id="living">
  ...
  <p class="note"> <strong>Signs of the kind:</strong> tracks in the mud and scat on the trail, a kill cached under brush, the birds gone quiet at the treeline, stock that will not settle: the plain sign any frontiersman learns to read, or dies not reading.</p>
  <div class="keeper-note"><span class="kn-tag">No Nerve, no Mark</span>These beasts cost the party <em>no Nerve</em>. There is no Dread Check against an honest animal, and their <strong>Dread</strong> line is marked &ldquo;&mdash;&rdquo; to say so. Nor do they ever move the Mark. Run them straight off the numbers. Their place in this book is to make the country real, to bloody a party grown careless, and to set the moment a thing that looks like an ordinary wolf turns its head, and its eyes are wrong.</div>
  {blocks}
</section>
'''
...
LIVING_LORE = {
  ...
  "The Grizzly Bear": (
    "The lord of the high country, and the animal that has ended more confident hunters than any other on this list. A grizzly takes the lead and keeps coming; it shrugs off the first solid wound, runs down a fleeing man over short ground faster than a horse, and does not stop for pain. It takes more lead than seems possible, and a tree is no help, for a grizzly will simply wait you out.",
  ...
  "The Bull Gator": (
    "The log that was not a log, and the undisputed master of its own black water. A bull gator explodes from the shallows, clamps on, and rolls to drown and dismember. On its own water, nothing the frontier owns can hold it. On land it is slow and beatable; in the water it is simply death with teeth, and the cut bank and the still pool are its kingdom.",
  ...
  "The Elk Bull": (
    ...
    "High meadows and timber edges through the autumn rut, and the winter range in the hard months. Heard long before he is seen; that whistling scream across a park at dusk is an address, directed at you."),
  "The Wolverine": (
  ...
  "The Boar Sounder": (
    "The whole family, in heavy brush: a very different animal from the lone razorback. A sounder runs to twenty head (sows, shoats, and a pair of old boars on the edges) through cover a man cannot see ten feet into, and it moves like one thing. They cut across, wheel in the thicket, and come back through from a direction nobody was watching, and they do this in country where a rifle is worth less than a good knife and a stout tree.",
  ...
  "The Stock-Killer Wolf": (
    "The wolf with a name and a price on it, and the only honest animal in this book that a party can spend a whole campaign failing to kill. One old wolf, running alone or with a single mate, that kills far past any hunger: a dozen head in a night, throats opened and the carcasses left where they dropped. It springs traps with a stick and eats around the pan. It refuses poisoned bait it has never encountered before. It knows the range better than the ranch does, and it has already beaten every man the ranch has sent. Ranchers name these. That is how you know.",
...
HARD_CREATURES = [
    ...
    ("The Tinhorn", "Tier I &middot; the cheat, and the friends he keeps", 13, 11, "seated, mostly", "+3", "+6", "+5",
     ...
     "The cheat, and the friends he keeps, which are always the actual difficulty. A tinhorn does not beat a table with cards; he beats it with preparation: a deck stacked before he sat down, a shiner set in a ring or a cigar case, and a partner across the room who signals every hand the party holds. He is unfailingly pleasant, he loses just often enough, and he has bought drinks for four men who will swear he has been square all evening.",
    ...
    ("The Hired Gun", "Tier II &middot; a man paid to be wherever you are", 16, 22, "unhurried", "+7", "+9", "+6",
     ...
     "Where big money has a small problem: a range in dispute, a strike being broken, a witness who has not yet testified. He arrives on the stage, takes a room, and is seen at breakfast.",
    ...
    ("The Horse Thieves", "Tier II &middot; men who leave you afoot", 15, 20, "very fast; mounted", "+7", "+9", "+3",
     ...
     "Do not stage this as a fight. Stage it as a morning: the party wakes, and the horses are gone, and everything they intended to do that week is now a different problem. What they do next (track, buy, steal in turn, or walk) will tell you more about them than a battle would."),
    # ---------------------------------------------------------------- Tier III
    ...
    ("The Bounty Killer", "Tier III &middot; a patient man with your description", 18, 36, "unhurried; never far", "+9", "+11", "+8",
     ...
     "Wherever the party has been and has been noticed: a stage station, a hotel register, a livery book, a telegraph office. He is usually behind them by four days, and once by about forty feet.",
    ...
    ("The Regulators", "Tier IV &middot; a private army, with the law's blessing", 19, 66, "mounted column; supplied", "+14", "+9", "+8",
     ...
     "Do not run this as a fight the party can win. Run it as a siege and a scramble: get the names warned, get to the telegraph, hold a ranch house for two days until help comes. The ending is deliberately unjust (everyone is arrested, the case is moved, nobody hangs) and that injustice is worth more to a campaign than a victory. In Perdition Basin the Vane Interest sends for them in the second year, when pulling nails stops being something it can do without a fight (Keeper's Book Ch. XIII)."),
    # ---------------------------------------------------------------- hard country
    ("The Bad Water", "Tier I &middot; the alkali seep and the poisoned well", "&mdash;", "&mdash;", "still; and it waits", "&mdash;", "&mdash;", "&mdash;",
     ...
     "<strong>Looks exactly like water.</strong> Alkali flats, gypsum seeps, a spring gone foul, a well with something dead in it; it is wet, it is the only wet thing for a day's ride, and a thirsty outfit will argue itself into drinking it.",
    ...
    ("The Flash Flood", "Tier III &middot; the dry wash, suddenly full", "&mdash;", "&mdash;", "very fast; arrives before the rain does", "&mdash;", "&mdash;", "&mdash;",
     ...
     "&mdash;", "Get up the bank: any bank, immediately, before deciding whether it is necessary. There is no swimming this. An hour later it is dry again, and that is what fools the next party through.",
