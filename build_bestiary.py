...
LIVING_CREATURES = [
    ...
    ("The Turkey Buzzard", "Tier I &middot; the bird that finds the dead first", 13, 6, "clumsy afoot; tireless aloft", "+4", "+6", "+1",
     ...
     "<strong>Reads the country for you.</strong> Has no interest in a fight and none in a living man; a wheel of them turning slow over a far ridge is the plainest message the frontier sends, and it is always about something already finished.",
    ...
    ("The Longhorn Herd", "Tier III &middot; three thousand head, and one bad noise", 16, 46, "fast, and all together", "+12", "+5", "+2",
     ...
     N, "Ride the circle and sing to them, which is what the singing was always for. Once it breaks, see The Stampede, and pray for room."),
...
LIVING_LORE = {
  ...
  "The Elk Bull": (
    ...
    "High meadows and timber edges through the autumn rut, and the winter range in the hard months. Heard long before he is seen &mdash; that whistling scream across a park at dusk is an address, and it is directed at you."),
  "The Wolverine": (
  ...
  "The Golden Eagle": (
    ...
    "Open country with cliffs or high timber to nest in &mdash; canyon rims, buttes, and mountain fronts. Over lambing grounds in the spring, which is the whole of the trouble."),
  ...
  "The Wild Cattle of the Brasada": (
    "Cattle that went wild and got clever. The ladinos of the thorn brush are longhorns bred out of a hundred years of strays, and the brush has made them nocturnal, solitary, and genuinely hostile in a way ordinary range stock never is. Six feet of horn tip to tip, a bull will lie up in a thicket all day and charge anything that comes in after him, and he has a settled hatred of horses and the men on top of them. Outfits rope them out of the brasada for money and count broken bones as part of the wage.",
...
HARD_CREATURES = [
    ...
    ("The Rustlers", "Tier I &middot; men who do their work at night", 13, 13, "mounted", "+5", "+5", "+2",
     ...
     "&mdash;", "They break the moment the odds turn. Follow them and you are in their country; corner them and you have made this a killing, which is what neither side wanted.",
    ...
    ("The Claim-Jumpers", "Tier I &middot; men with your paper in their pocket", 13, 12, "afoot", "+5", "+4", "+3",
     ...
     "This is a fight the party mostly cannot shoot its way out of, which is the point of putting it early. Let them discover that the recorder is the real antagonist, and that riding to town is more use than riding to the claim."),
    ...
    ("The Lynch Mob", "Tier II &middot; the town, with a rope", 14, 30, "one mass, moving", "+8", "+3", "&mdash;",
     ...
     "This is a talking encounter with a clock on it, and the clock is the only thing that makes it dangerous. Track it as a countdown the party can push back with each successful appeal. Let them win it, once, in front of everybody &mdash; and let the loud men at the front remember them for it."),
    ...
    ("The Outlaw Gang", "Tier III &middot; road agents with a leader and a name", 17, 40, "mounted; well armed", "+10", "+9", "+7",
     ...
     "The gang is the best long antagonist in this chapter because it is a mirror: it does what the party does, with the same skills, for reasons the party can understand. Give the leader one virtue the party has to respect, and the campaign writes itself."),
    ...
    ("The Regulators", "Tier IV &middot; a private army, with the law's blessing", 19, 66, "mounted column; supplied", "+14", "+9", "+8",
     ...
     "A private army with the law's blessing, and the point at which a range war stops pretending. Fifty hired men come in by train with horses, supply wagons, a surgeon, and a list of seventy names, and they carry warrants signed by a judge who has since gone east on business. They are competent, they are supplied, and they intend to work down the list in order. What actually stops them is never a gun &mdash; it is the county, three hundred neighbors, and a telegraph key.",
    ...
    ("The Flash Flood", "Tier III &middot; the dry wash, suddenly full", "&mdash;", "&mdash;", "very fast; arrives before the rain does", "&mdash;", "&mdash;", "&mdash;",
     ...
     "&mdash;", "Get up the bank &mdash; any bank, immediately, before deciding whether it is necessary. There is no swimming this, and it is down again in an hour, which is what fools the next party through.",
     "The dry wash, suddenly full, out of a sky directly overhead that is doing nothing at all. Rain that fell twenty miles up the country an hour ago gathers into a channel that has been bone dry for a season, and it arrives as a moving wall four feet high with trees and boulders rolling along inside it. The sound comes perhaps thirty seconds ahead of the water. An arroyo is the flattest, easiest, most sheltered ground in that whole country, which is exactly why people camp in it.",
